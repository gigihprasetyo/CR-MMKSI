...
// ===========================================================================
// AUTHOR        : PT Mitrais 
// PURPOSE       : StandardCodeCharProfile mapper class
...
{
    public class StandardCodeCharProfile : Profile
    {
        public StandardCodeCharProfile()
        {
            CreateMap<StandardCodeChar, StandardCodeCharDto>()
            ...
            CreateMap<StandardCodeCharParameterDto, StandardCodeChar>()
            .ForMember(dest => dest.Category, opt => opt.MapFrom(src => src.Category))
            .ForMember(dest => dest.ValueId, opt => opt.MapFrom(src => src.ValueId))
            .ForMember(dest => dest.ValueCode, opt => opt.MapFrom(src => src.ValueCode))
            .ForMember(dest => dest.ValueDesc, opt => opt.MapFrom(src => src.ValueDesc))
