...
// ===========================================================================
// AUTHOR        : PT Mitrais 
// PURPOSE       : SPKCustomerProfile mapper class
...
{
    public class SPKCustomerProfile : Profile
    {
        public SPKCustomerProfile()
        {
            CreateMap<SPKCustomer, SPKCustomerDto>()
                .ForMember(dest => dest.ID, opt => opt.MapFrom(src => src.ID))
                .ForAllOtherMembers(opt => opt.Ignore());

            CreateMap<SPKCustomer, SPKCustomerParameterDto>()
                .ForMember(dest => dest.ID, opt => opt.MapFrom(src => src.ID))
            ...
            CreateMap<SPKCustomerParameterDto, SPKCustomer>()
                .ForMember(dest => dest.ID, opt => opt.MapFrom(src => src.ID))
                .ForMember(dest => dest.ReffCode, opt => opt.MapFrom(src => src.ReffCode))
                .ForMember(dest => dest.TipeCustomer, opt => opt.MapFrom(src => src.TipeCustomer))
                .ForMember(dest => dest.TipePerusahaan, opt => opt.MapFrom(src => src.TipePerusahaan))
