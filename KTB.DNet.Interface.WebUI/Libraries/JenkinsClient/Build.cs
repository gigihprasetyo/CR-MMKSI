    ...
    public class Build : LazyJObject
    {
        ...
        public bool building
        {
            get
            {
                ...
                return (bool)data[CustomExtension.nameof(() => building)];
            }
        }
        public int estimatedDuration
        {
            get
            {
                ...
                return (int)data[CustomExtension.nameof(() => estimatedDuration)];
            }
        }
        public int duration
        {
            get
            {
                ...
                return (int)data[CustomExtension.nameof(() => duration)];
            }
        }
        public long timestamp
        {
            get
            {
                ...
                return Convert.ToInt64(data[CustomExtension.nameof(() => timestamp)]);
            }
        }
        public string result
        {
            get
            {
                ...
                return (string)data[CustomExtension.nameof(() => result)];
            }
        }
        ...
        public string fullDisplayName
        {
            get
            {
                ...
                return (string)data[CustomExtension.nameof(() => fullDisplayName)];
            }
        }
        ...
        public List<Artifact> artifacts
        {
            get
            {
                ...
                var artifactJArray = (JArray)data[CustomExtension.nameof(() => artifacts)];
