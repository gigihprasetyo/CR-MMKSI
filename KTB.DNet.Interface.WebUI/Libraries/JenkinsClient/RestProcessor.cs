...
namespace JenkinsClient
{
    internal class RestProcessor
    {
        private class Path
        {
            public static readonly string RestartJenkins = "/api/json/safeRestart";
            ...
            public static readonly string GetConsoleOutput = "/job/{0}/{1}/consoleText";

            public static readonly string PostBuild = "/job/{0}/build";
        ...
        public async Task<RestResponse> RestartJenkins()
        {
            return await Request(FormatUri(Path.RestartJenkins));
        }
        ...
        // additional method
        public async Task<RestResponse> GetConsoleOutput(string jobName, string buildNo)
        {
            return await Request(FormatUri(Path.GetConsoleOutput, jobName, buildNo));
        }
    }
}
