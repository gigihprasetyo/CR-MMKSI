...
Namespace KTB.DNet.Parser
    Public Class RevisionPaymentTransParser
        Inherits AbstractParser

#Region "Private Variables"
        Private _Stream As StreamReader
        Private Grammar As Regex
        Private _TransferPayments As ArrayList
                ...
                Else
                    If cols(2).Trim.Length > 0 Then
                        If IsNumeric(cols(2).Trim) Then
                            oTC.ActualPaymentAmount = CDec(cols(2).Trim)
                        Else
        ...
        Protected Overrides Function DoParse(ByVal KeyName As String, ByVal Content As String) As Object
            Try
                ...
                For i As Integer = 0 To lines.Length - 1
                    ...
                    Catch ex As Exception
                        SysLogParameter.LogErrorToSyslog(ex.Message.ToString, "ws-worker", "RevisionPaymentTransParser.vb", "Parsing", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.RevisionPaymentTransParser, BlockName)
            ...
            For i As Integer = 0 To _TPs.Count - 1
                ...
                Else
                    If Not IsNothing(_TP.RevisionPaymentHeader) AndAlso _TP.RevisionPaymentHeader.ErrorMessage() = "" Then
                        If _TP.RevisionPaymentHeader.PaymentType = enumPaymentTypeRevision.PaymentType.Transfer Then
