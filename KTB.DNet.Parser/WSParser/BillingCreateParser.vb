        ...
        Private Function ParseHeader(ByVal line As String) As MonthlyDocument
            ...
            Else
                If cols(1).Trim = String.Empty Then
                    writeError("cATEGORY Code can't be empty")
                ElseIf cols(2).Trim = String.Empty Then
                    writeError("dEALER can't be empty")
                ...
                Else
                    Try
                        ...
                        Select Case CInt(kind)
                            ...
                            Case 22
                                criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.MonthlyDocument), "Kind", MatchType.InSet, "(22)"))
                            Case 23
                                criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.MonthlyDocument), "Kind", MatchType.InSet, "(23, 24)"))
                        End Select
