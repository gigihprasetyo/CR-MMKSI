...
#Region "Protected Methods"
            ...
            Try
                ...
                For i As Integer = 0 To lines.Length - 1
                    ...
                    Catch ex As Exception
                        SysLogParameter.LogErrorToSyslog(ex.Message.ToString, "ws-worker", "KaroseriParser.vb", "Parsing", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.KaroseriParser, BlockName)
        ...
        Protected Overrides Function DoTransaction() As Integer
            ...
            Dim doFacade As KaroseriFacade
            Dim nError As Integer = 0
            Dim sMsg As String = ""

            For Each objKaroseri As Karoseri In _aMPIRs
                Try

                    If Not IsNothing(objKaroseri.ErrorMessage) AndAlso objKaroseri.ErrorMessage <> "" Then
                        nError += 1
                        sMsg = sMsg & objKaroseri.ErrorMessage.ToString() & ";"
                    Else
                        doFacade = New KaroseriFacade(New System.Security.Principal.GenericPrincipal(New GenericIdentity("WSM"), Nothing))
                        doFacade.InsertFromWebSevice(objKaroseri)
                    End If
                Catch ex As Exception
                    SysLogParameter.LogErrorToSyslog(ex.Message.ToString(), "ws-worker", "KaroseriParser.vb", "Transaction", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.KaroseriParser, BlockName)
                    Dim e As Exception = New Exception(_fileName & Chr(13) & Chr(10) & objKaroseri.Code & Chr(13) & Chr(10) & ex.Message)
                    Dim rethrow As Boolean = ExceptionPolicy.HandleException(e, "Parser Policy")
                End Try
            Next

            If nError > 0 Then
                SysLogParameter.LogErrorToSyslog("Failed " & nError.ToString() & " of " & _aMPIRs.Count.ToString(), "ws-worker", "KaroseriParser.vb", "Transaction", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.KaroseriParser, BlockName)
                SysLogParameter.LogErrorToSyslog("Error Message :" & sMsg, "ws-worker", "KaroseriParser.vb", "Transaction", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.KaroseriParser, BlockName)
...
#Region "Private Methods"
        ...
        Private Function ParseHeader(ByVal line As String) As Karoseri
            Dim cols As String() = line.Split(MyBase.ColSeparator)
            Dim user As GenericPrincipal = New System.Security.Principal.GenericPrincipal(New GenericIdentity("ws"), Nothing)
            Dim objKaroseri As New Karoseri
            Dim objKaroseriFac As New KaroseriFacade(user)
            ...
            Else
                ...
                Try '5 PostalCode
                    ...
                    objKaroseri.PostalCode = PostalCode
                ...
                Try '8 ContactPerson
                    ...
                    objKaroseri.ContactPerson = ContactPerson
                ...
                If Not IsNothing(errorMessage) AndAlso errorMessage.ToString().Trim() <> "" Then
                    ...
                    objKaroseri.ErrorMessage = errorMessage.ToString() & vbCrLf & line
                Else
                    objKaroseri.LastUpdateBy = "WS"
                    objKaroseri.Status = 1
                End If
            End If
