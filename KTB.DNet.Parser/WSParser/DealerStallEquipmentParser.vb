...
Namespace KTB.DNet.Parser
    ...
    Public Class DealerStallEquipmentParser
...
#Region "Private Variables"
        ...
        Private _arrStallEquipment As ArrayList
        Private _StallEquipment As DealerStallEquipment
#End Region
...
#Region "Protected Methods"
        ...
        Protected Overrides Function DoParse(ByVal KeyName As String, ByVal Content As String) As Object
            Try
                ...
                _arrStallEquipment = New ArrayList()
                _StallEquipment = Nothing
                ...
                For i As Integer = 0 To lines.Length - 1
                    Try
                        ...
                        If ind = MyBase.IndicatorHeader Then
                            If Not IsNothing(_StallEquipment) Then
                                _arrStallEquipment.Add(_StallEquipment)
                                _StallEquipment = Nothing
                            End If

                            errorMessage = New StringBuilder()
                            _StallEquipment = ParseHeader(line)
                ...
                If Not IsNothing(_StallEquipment) Then
                    If Not IsNothing(errorMessage) AndAlso errorMessage.ToString() <> String.Empty Then _StallEquipment.ErrorMessage = errorMessage.ToString()
                    _arrStallEquipment.Add(_StallEquipment)
                End If
        ...
        Protected Overrides Function DoTransaction() As Integer
            ...
            For Each objStallEquipment As DealerStallEquipment In _arrStallEquipment
                Try
            ...
            If nError > 0 Then
                SysLogParameter.LogErrorToSyslog("Failed " & nError.ToString() & " of " & _arrStallEquipment.Count.ToString(), "ws-worker", "LeasingParser.vb", "Transaction", KTB.DNET.[Lib].DNetLogFormatStatus.Direct, SourceName, WSMSyslogParameter.ParserType.LeasingParser, BlockName)
...
#Region "Private Methods"
        ...
        Private Function ParseHeader(ByVal line As String) As DealerStallEquipment
