                ...
                Try
                    ...
                    If arlMonthlyDocument.Count > 0 Then
                        For Each item As MonthlyDocument In arlMonthlyDocument
                            ...
                            objMonthlyDocument.TransferDate = New Date(CType(transferDate.Substring(0, 4), Integer), CType(transferDate.Substring(4, 2), Integer), CType(transferDate.Substring(5, 2), Integer))
