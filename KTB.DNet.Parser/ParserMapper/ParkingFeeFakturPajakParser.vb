...
Namespace KTB.DNet.Parser
    Public Class ParkingFeeFakturPajakParser
...
#End Region
        ...
        Private Sub ParsePenalty(ByVal ValParser As String)
            ...
            If Fields.Length = 4 Then
                'Update by anh 20120717 add field FakturPajakNo
                'DealerCode;DebitMemoNumber;FakturPajakNo
                'CAPITALIZED : UNUSED
                'DealerCode
                sTemp = Fields(0)
                Try
        ...
        Protected Overrides Function DoTransaction() As Integer
            If _ListParkingFee.Count > 0 Then
                ...
                For Each objPF As ParkingFee In _ListParkingFee
                    ...
                    'crtPF.opAnd(New Criteria(GetType(ParkingFee), "FakturPajakNo", MatchType.Exact, objPF.FakturPajakNo))
                    ...
                    Try
                        ...
                        Else
                            If objPFExisting.FakturPajakNo <> objPF.FakturPajakNo Then
                                objPFExisting.FakturPajakNo = objPF.FakturPajakNo
                                IsSameWithOld = False
                            End If
                        ...
                        End If
                    Catch ex As Exception
                        SysLogParameter.LogErrorToSyslog(ex.Message.ToString, "ParkingFeeFaktur", "ParkingFeeFaktur.vb", "Transaction", KTB.DNet.[Lib].DNetLogFormatStatus.Direct, SourceName, SysLogParameter.ParserType.CessieParser, BlockName)
