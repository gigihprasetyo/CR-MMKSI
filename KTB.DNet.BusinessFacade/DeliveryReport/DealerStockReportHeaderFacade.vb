...
#Region "Constructor"
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_Mapper = MapperFactory.GetInstance().GetMapper(GetType(DealerStockReportHeader).ToString)
        End Sub
#End Region

#Region "Retrieve"

        Public Function Retrieve(ByVal ID As Integer) As DealerStockReportHeader
            Return CType(m_Mapper.Retrieve(ID), DealerStockReportHeader)
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(DealerStockReportHeader), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(DealerStockReportHeader), columnName, matchOperator, columnValue))
            Dim DCColl As ArrayList = m_Mapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(DealerStockReportHeader), columnName, matchOperator, columnValue))
