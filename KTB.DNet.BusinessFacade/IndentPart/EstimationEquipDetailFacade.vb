...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal RequestNo As String) As EstimationEquipDetail
            ...
            criterias.opAnd(New Criteria(GetType(EstimationEquipDetail), "RequestNo", MatchType.Exact, RequestNo))
