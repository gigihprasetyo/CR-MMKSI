...
Namespace KTB.DNET.BusinessFacade
    ...
    Public Class SalesOrderInterestFacade
...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_SalesOrderInterestMapper = MapperFactory.GetInstance.GetMapper(GetType(SalesOrderInterest).ToString)
...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal ID As Integer) As SalesOrderInterest
            Return CType(m_SalesOrderInterestMapper.Retrieve(ID), SalesOrderInterest)
        End Function

        Public Function Retrieve(ByVal Code As String) As SalesOrderInterest
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(SalesOrderInterest), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(SalesOrderInterest), "SalesOrderInterestCode", MatchType.Exact, Code))
            ...
            If (SalesOrderInterestColl.Count > 0) Then
                Return CType(SalesOrderInterestColl(0), SalesOrderInterest)
            End If
            Return New SalesOrderInterest
        End Function
        ...
        Public Function RetrieveList(ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New Sort(GetType(SalesOrderInterest), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
        ...
        Public Function RetrieveActiveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal SortColumn As String, ByVal sortDirection As String, ByVal criterias As CriteriaComposite) As ArrayList
            Dim sortColl As SortCollection = New SortCollection
            sortColl.Add(New Search.Sort(GetType(SalesOrderInterest), SortColumn, sortDirection))
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(SalesOrderInterest), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim SalesOrderInterestColl As ArrayList = m_SalesOrderInterestMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
            criterias.opAnd(New Criteria(GetType(SalesOrderInterest), columnName, matchOperator, columnValue))
            Return SalesOrderInterestColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(SalesOrderInterest), columnName, matchOperator, columnValue))
