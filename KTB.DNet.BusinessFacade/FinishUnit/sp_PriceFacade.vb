...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_PriceMapper = MapperFactory.GetInstance().GetMapper(GetType(sp_Price).ToString)
...
#Region "Transaction/Other Public Method"
        ...
        Public Function Insert(ByVal objDomain As sp_Price) As Integer
        ...
        Public Sub InsertWithTransactionManager(ByVal price As sp_Price)
            Try
        ...
        Public Sub InsertWithTransactionManagerHandler(ByVal sender As Object, ByVal args As TransactionManager.OnInsertArgs)
            ...
            If (args.DomainObject.GetType = GetType(sp_Price)) Then
                CType(args.DomainObject, sp_Price).MarkLoaded()
            End If
...
#Region "Custom Method"
        ...
        '' by : ali Akbar
        '' 2014-09-24
        Public Function RetrieveByCriteria(ByVal VechileColorID As Integer, ByVal DealerID As Integer, ByVal ValidFrom As DateTime) As Price
            Dim ObjPrice As Price = New Price
            Dim objPriceArrayList As ArrayList = New ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(Price), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(Price), "Dealer.ID", MatchType.Exact, DealerID))
            criterias.opAnd(New Criteria(GetType(Price), "VechileColor.ID", MatchType.Exact, VechileColorID))
