...
Namespace KTB.DNet.BusinessFacade.PO
    ...
    Public Class VInvoiceFacade
        Inherits AbstractFacade

#Region "Private Variables"

        Private m_userPrincipal As IPrincipal = Nothing
        Private m_VInvoiceMapper As IMapper
...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_VInvoiceMapper = MapperFactory.GetInstance.GetMapper(GetType(VInvoice).ToString)
            Me.m_TransactionManager = New TransactionManager
            Me.DomainTypeCollection.Add(GetType(KTB.DNet.Domain.VInvoice))
...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal ID As Integer) As VInvoice
            Return CType(m_VInvoiceMapper.Retrieve(ID), VInvoice)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria) As ArrayList
            Return m_VInvoiceMapper.RetrieveByCriteria(criterias)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sorts As ICollection) As ArrayList
            Return m_VInvoiceMapper.RetrieveByCriteria(criterias, sorts)
        End Function

        Public Function Retrieve(ByVal Code As String) As VInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VInvoice), "ID", MatchType.Exact, Code))

            Dim VInvoiceColl As ArrayList = m_VInvoiceMapper.RetrieveByCriteria(criterias)
            If (VInvoiceColl.Count > 0) Then
                Return CType(VInvoiceColl(0), VInvoice)
            End If
            Return Nothing
        End Function
        ...
        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New KTB.DNet.Domain.Search.Sort(GetType(VInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Return m_VInvoiceMapper.RetrieveByCriteria(criterias, sortColl)
        End Function

        Public Function RetrieveList() As ArrayList
            Return m_VInvoiceMapper.RetrieveList
        End Function

        Public Function RetrieveList(ByVal ContractHeaderID As Integer) As ArrayList
            Dim criterias As New CriteriaComposite(New Criteria(GetType(VInvoice), "ContractHeaderID", _
                MatchType.Exact, ContractHeaderID))
            criterias.opAnd(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, _
        ...
        Public Function RetrieveList(ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VInvoiceMapper.RetrieveList(sortColl)
        End Function
        ...
        Public Function RetrieveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VInvoiceMapper.RetrieveList(sortColl, pageNumber, pageSize, totalRow)

        End Function

        Public Function RetrieveActiveList() As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim _VInvoice As ArrayList = m_VInvoiceMapper.RetrieveByCriteria(criterias)
            Return _VInvoice
        End Function

        Public Function RetrieveActiveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VInvoiceColl As ArrayList = m_VInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
        ...
        Public Function RetrieveActiveList(ByVal Criterias As CriteriaComposite, ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New Sort(GetType(VInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Dim VInvoiceColl As ArrayList = m_VInvoiceMapper.RetrieveByCriteria(Criterias, sortColl, pageNumber, pageSize, totalRow)
            Return VInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VInvoiceColl As ArrayList = m_VInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
            criterias.opAnd(New Criteria(GetType(VInvoice), columnName, matchOperator, columnValue))
            Return VInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), columnName, matchOperator, columnValue))

            Return m_VInvoiceMapper.RetrieveByCriteria(criterias, sortColl, pageNumber, pageSize, totalRow)
        End Function
...
#Region "Custom Method"
        ...
        Public Function RetrieveIDContract(ByVal id As Integer) As VInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VInvoice), "ContractHeader.ID", MatchType.Exact, id))
        ...
        Private Function GetPoDetailByVInvoiceAndLineNumber(ByVal poheaderID As Integer, ByVal lineItem As Integer) As PODetail
            Dim _PODetailFacade As PODetailFacade = New PODetailFacade(New System.Security.Principal.GenericPrincipal(New GenericIdentity("WSM"), Nothing))
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(PODetail), "VInvoice.ID", MatchType.Exact, poheaderID))
        ...
        Private Function IsSONumberExist(ByVal soNumber As String, ByVal poNumber As String) As Boolean
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VInvoice), "SONumber", MatchType.Exact, soNumber.Trim))
            criterias.opAnd(New Criteria(GetType(VInvoice), "PONumber", MatchType.Exact, poNumber.Trim))
            Dim aggregates As New Aggregate(GetType(VInvoice), "ID", AggregateType.Count)
            If CType(m_VInvoiceMapper.RetrieveScalar(aggregates, criterias), Integer) > 0 Then
                Return True
            End If
            Return False
        End Function
        ...
        Private Function GetDueDateUsingDailyPayment(ByVal objPO As VInvoice) As Date
            ...
            criterias.opAnd(New Criteria(GetType(DailyPayment), "VInvoice.ID", MatchType.Exact, objPO.ID))
        ...
        'Public Function CountACC(ByVal objContract As ContractHeader, ByVal objDealer As Dealer, ByVal objTOP As TermOfPayment, ByVal currentPO As VInvoice, ByVal ConStr As String) As Long
