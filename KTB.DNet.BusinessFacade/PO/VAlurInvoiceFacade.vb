...
Namespace KTB.DNet.BusinessFacade.PO
    ...
    Public Class VAlurInvoiceFacade
        Inherits AbstractFacade

#Region "Private Variables"

        Private m_userPrincipal As IPrincipal = Nothing
        Private m_VAlurInvoiceMapper As IMapper
...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_VAlurInvoiceMapper = MapperFactory.GetInstance.GetMapper(GetType(VAlurInvoice).ToString)
            Me.m_TransactionManager = New TransactionManager
            Me.DomainTypeCollection.Add(GetType(KTB.DNet.Domain.VAlurInvoice))
...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal ID As Integer) As VAlurInvoice
            Return CType(m_VAlurInvoiceMapper.Retrieve(ID), VAlurInvoice)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria) As ArrayList
            Return m_VAlurInvoiceMapper.RetrieveByCriteria(criterias)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sorts As ICollection) As ArrayList
            Return m_VAlurInvoiceMapper.RetrieveByCriteria(criterias, sorts)
        End Function

        Public Function Retrieve(ByVal Code As String) As VAlurInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), "ID", MatchType.Exact, Code))

            Dim VAlurInvoiceColl As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(criterias)
            If (VAlurInvoiceColl.Count > 0) Then
                Return CType(VAlurInvoiceColl(0), VAlurInvoice)
            End If
            Return Nothing
        End Function
        ...
        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New KTB.DNet.Domain.Search.Sort(GetType(VAlurInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Return m_VAlurInvoiceMapper.RetrieveByCriteria(criterias, sortColl)
        End Function

        Public Function RetrieveList() As ArrayList
            Return m_VAlurInvoiceMapper.RetrieveList
        End Function

        Public Function RetrieveList(ByVal ContractHeaderID As Integer) As ArrayList
            Dim criterias As New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "ContractHeaderID", _
                MatchType.Exact, ContractHeaderID))
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, _
        ...
        Public Function RetrieveList(ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VAlurInvoiceMapper.RetrieveList(sortColl)
        End Function
        ...
        Public Function RetrieveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VAlurInvoiceMapper.RetrieveList(sortColl, pageNumber, pageSize, totalRow)

        End Function

        Public Function RetrieveActiveList() As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim _VAlurInvoice As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(criterias)
            Return _VAlurInvoice
        End Function

        Public Function RetrieveActiveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VAlurInvoiceColl As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)

            Return VAlurInvoiceColl
        End Function

        Public Function RetrieveActiveList(ByVal Criterias As CriteriaComposite, ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            Dim sortColl As SortCollection = New SortCollection
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New Sort(GetType(VAlurInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Dim VAlurInvoiceColl As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(Criterias, sortColl, pageNumber, pageSize, totalRow)
            Return VAlurInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VAlurInvoiceColl As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), columnName, matchOperator, columnValue))
            Return VAlurInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.domain.Search.Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), columnName, matchOperator, columnValue))

            Return m_VAlurInvoiceMapper.RetrieveByCriteria(criterias, sortColl, pageNumber, pageSize, totalRow)
        End Function
...
#Region "Custom Method"
        ...
        Public Function RetrieveIDContract(ByVal id As Integer) As VAlurInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), "ContractHeader.ID", MatchType.Exact, id))

            Dim VAlurInvoiceColl As ArrayList = m_VAlurInvoiceMapper.RetrieveByCriteria(criterias)
            If (VAlurInvoiceColl.Count > 0) Then
                Return CType(VAlurInvoiceColl(0), VAlurInvoice)
            End If
            Return New VAlurInvoice
        End Function
        ...
        Private Function GetPoDetailByVAlurInvoiceAndLineNumber(ByVal poheaderID As Integer, ByVal lineItem As Integer) As PODetail
            Dim _PODetailFacade As PODetailFacade = New PODetailFacade(New System.Security.Principal.GenericPrincipal(New GenericIdentity("WSM"), Nothing))
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(PODetail), "VAlurInvoice.ID", MatchType.Exact, poheaderID))
        ...
        Private Function IsSONumberExist(ByVal soNumber As String, ByVal poNumber As String) As Boolean
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VAlurInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), "SONumber", MatchType.Exact, soNumber.Trim))
            criterias.opAnd(New Criteria(GetType(VAlurInvoice), "PONumber", MatchType.Exact, poNumber.Trim))
            Dim aggregates As New Aggregate(GetType(VAlurInvoice), "ID", AggregateType.Count)
            If CType(m_VAlurInvoiceMapper.RetrieveScalar(aggregates, criterias), Integer) > 0 Then
                Return True
            End If
            Return False
        End Function
        ...
        Private Function GetDueDateUsingDailyPayment(ByVal objPO As VAlurInvoice) As Date
            ...
            ' criterias.opAnd(New Criteria(GetType(DailyPayment), "VAlurInvoice.ID", MatchType.Exact, objPO.ID))
        ...
        'Public Function CountACC(ByVal objContract As ContractHeader, ByVal objDealer As Dealer, ByVal objTOP As TermOfPayment, ByVal currentPO As VAlurInvoice, ByVal ConStr As String) As Long
