...
Namespace KTB.DNet.BusinessFacade.PO
    ...
    Public Class VDetailInvoiceFacade
        Inherits AbstractFacade

#Region "Private Variables"

        Private m_userPrincipal As IPrincipal = Nothing
        Private m_VDetailInvoiceMapper As IMapper
...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_VDetailInvoiceMapper = MapperFactory.GetInstance.GetMapper(GetType(VDetailInvoice).ToString)
            Me.m_TransactionManager = New TransactionManager
            Me.DomainTypeCollection.Add(GetType(KTB.DNet.Domain.VDetailInvoice))
...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal ID As Integer) As VDetailInvoice
            Return CType(m_VDetailInvoiceMapper.Retrieve(ID), VDetailInvoice)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria) As ArrayList
            Return m_VDetailInvoiceMapper.RetrieveByCriteria(criterias)
        End Function

        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sorts As ICollection) As ArrayList
            Return m_VDetailInvoiceMapper.RetrieveByCriteria(criterias, sorts)
        End Function

        Public Function Retrieve(ByVal Code As String) As VDetailInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), "ID", MatchType.Exact, Code))

            Dim VDetailInvoiceColl As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(criterias)
            If (VDetailInvoiceColl.Count > 0) Then
                Return CType(VDetailInvoiceColl(0), VDetailInvoice)
            End If
            Return Nothing
        End Function
        ...
        Public Function Retrieve(ByVal criterias As ICriteria, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New KTB.DNet.Domain.Search.Sort(GetType(VDetailInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Return m_VDetailInvoiceMapper.RetrieveByCriteria(criterias, sortColl)
        End Function

        Public Function RetrieveList() As ArrayList
            Return m_VDetailInvoiceMapper.RetrieveList
        End Function

        Public Function RetrieveList(ByVal ContractHeaderID As Integer) As ArrayList
            Dim criterias As New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "ContractHeaderID", _
                MatchType.Exact, ContractHeaderID))
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, _
        ...
        Public Function RetrieveList(ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VDetailInvoiceMapper.RetrieveList(sortColl)
        End Function
        ...
        Public Function RetrieveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Return m_VDetailInvoiceMapper.RetrieveList(sortColl, pageNumber, pageSize, totalRow)

        End Function

        Public Function RetrieveActiveList() As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim _VDetailInvoice As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(criterias)
            Return _VDetailInvoice
        End Function

        Public Function RetrieveActiveList(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VDetailInvoiceColl As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)

            Return VDetailInvoiceColl
        End Function

        Public Function RetrieveActiveList(ByVal Criterias As CriteriaComposite, ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            Dim sortColl As SortCollection = New SortCollection
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New Sort(GetType(VDetailInvoice), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
            Dim VDetailInvoiceColl As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(Criterias, sortColl, pageNumber, pageSize, totalRow)
            Return VDetailInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            Dim VDetailInvoiceColl As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), columnName, matchOperator, columnValue))
            Return VDetailInvoiceColl
        End Function
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As KTB.DNet.Domain.Search.Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), columnName, matchOperator, columnValue))

            Return m_VDetailInvoiceMapper.RetrieveByCriteria(criterias, sortColl, pageNumber, pageSize, totalRow)
        End Function
...
#Region "Custom Method"
        ...
        Public Function RetrieveIDContract(ByVal id As Integer) As VDetailInvoice
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), "ContractHeader.ID", MatchType.Exact, id))

            Dim VDetailInvoiceColl As ArrayList = m_VDetailInvoiceMapper.RetrieveByCriteria(criterias)
            If (VDetailInvoiceColl.Count > 0) Then
                Return CType(VDetailInvoiceColl(0), VDetailInvoice)
            End If
            Return New VDetailInvoice
        End Function
        ...
        Private Function GetPoDetailByVDetailInvoiceAndLineNumber(ByVal poheaderID As Integer, ByVal lineItem As Integer) As PODetail
            Dim _PODetailFacade As PODetailFacade = New PODetailFacade(New System.Security.Principal.GenericPrincipal(New GenericIdentity("WSM"), Nothing))
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(PODetail), "VDetailInvoice.ID", MatchType.Exact, poheaderID))
        ...
        Private Function IsSONumberExist(ByVal soNumber As String, ByVal poNumber As String) As Boolean
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(VDetailInvoice), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), "SONumber", MatchType.Exact, soNumber.Trim))
            criterias.opAnd(New Criteria(GetType(VDetailInvoice), "PONumber", MatchType.Exact, poNumber.Trim))
            Dim aggregates As New Aggregate(GetType(VDetailInvoice), "ID", AggregateType.Count)
            If CType(m_VDetailInvoiceMapper.RetrieveScalar(aggregates, criterias), Integer) > 0 Then
                Return True
            End If
            Return False
        End Function
        ...
        Private Function GetDueDateUsingDailyPayment(ByVal objPO As VDetailInvoice) As Date
            ...
            criterias.opAnd(New Criteria(GetType(DailyPayment), "VDetailInvoice.ID", MatchType.Exact, objPO.ID))
        ...
        'Public Function CountACC(ByVal objContract As ContractHeader, ByVal objDealer As Dealer, ByVal objTOP As TermOfPayment, ByVal currentPO As VDetailInvoice, ByVal ConStr As String) As Long
