...
Namespace KTB.DNet.BusinessFacade.Transfer
    Public Class TransferPaymentFacade
...
#Region "Constructor"
        ...
        Public Sub New(ByVal userPrincipal As IPrincipal)
            ...
            Me.m_TransferPaymentMapper = MapperFactory.GetInstance().GetMapper(GetType(TransferPayment).ToString)
...
#Region "Retrieve"
        ...
        Public Function Retrieve(ByVal TransferPaymentCode As String) As TransferPayment
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(TransferPayment), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(TransferPayment), "RegNumber", MatchType.Exact, TransferPaymentCode))
        ...
        Public Function RetrieveList(ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            If (Not IsNothing(sortColumn)) And (Not IsNothing(sortColumn)) Then
                sortColl.Add(New Sort(GetType(TransferPayment), sortColumn, sortDirection))
            Else
                sortColl = Nothing
            End If
        ...
        Public Function RetrieveActiveList() As ArrayList
            ...
            If (Not IsNothing("TransferPaymentCode")) Then
                sortColl.Add(New Sort(GetType(TransferPayment), "TransferPaymentCode", Sort.SortDirection.ASC))
            Else
                sortColl = Nothing
            End If
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As String, ByVal matchOperator As MatchType, ByVal columnValue As String) As ArrayList
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(TransferPayment), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))
            criterias.opAnd(New Criteria(GetType(TransferPayment), columnName, matchOperator, columnValue))
            Dim TransferPaymentColl As ArrayList = m_TransferPaymentMapper.RetrieveByCriteria(criterias, Nothing, pageNumber, pageSize, totalRow)
        ...
        Public Function RetrieveWithOneCriteria(ByVal pageNumber As Integer, ByVal pageSize As Integer, ByRef totalRow As Integer, ByVal columnName As Integer, ByVal matchOperator As MatchType, ByVal columnValue As String, ByVal sortColumn As String, ByVal sortDirection As Sort.SortDirection) As ArrayList
            ...
            Dim criterias As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(TransferPayment), columnName, matchOperator, columnValue))
...
#Region "Transaction/Other Public Method"
 ...
 Public Function UpdateTransferActual(ByVal tp As TransferPayment, ByVal RefTransferbank As String) As Boolean

            Try
                Dim arr As New ArrayList
                Dim strSP As String = "up_UpdateTransferPayment_TransferActual"
                ...
                par1.Value = tp.ID
                par1.ParameterName = "@TransferPaymentID"
                arrParam.Add(par1)
                ...
                Dim b As Boolean = m_TransferPaymentMapper.ExecuteSP(strSP, arrParam)
        ...
        Public Function ValidateCode(ByVal Code As String) As Integer
            Dim crit As CriteriaComposite = New CriteriaComposite(New Criteria(GetType(TransferPayment), "TransferPaymentCode", MatchType.Exact, Code))
            Dim agg As Aggregate = New Aggregate(GetType(TransferPayment), "TransferPaymentCode", AggregateType.Count)
