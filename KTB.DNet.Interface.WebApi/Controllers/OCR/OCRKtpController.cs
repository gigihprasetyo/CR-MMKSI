...
namespace KTB.DNet.Interface.WebApi.Controllers
{
    ...
    /// OCR Web API
    /// </summary>  
    [RoutePrefix("OCR/KTP"), ApiGroup("OCR Identity")]
    public class OCRKtpController : BaseController
    {
        ...
        public OCRKtpController(IOCRIdentityBL ocrBL)
        {
            _ocrBL = ocrBL;
        ...
        /// <returns></returns>
        [Route("Upload")]
        [ResponseType(typeof(ResponseBase<List<OCRIdentityKTPDto>>)), HttpPost]
        [PermissionAuthorize(PermissionName = PermissionConstants.WebAPI_OCR_UploadKTP)]
        [SwaggerParameter("KTPFile", "A KTP image file", Required = true, Type = "file")]
        ...
        public IHttpActionResult Upload()
        {
            try
            {
                ...
                {
                    var result = _ocrBL.UploadKTP(postedFile);
        ...
        /// <summary>
        /// Check KTP OCR progress status from Server
        /// </summary>
        ...
        [PermissionAuthorize(PermissionName = PermissionConstants.WebAPI_OCR_ProgressKTP)]
        [EnableCors(origins: "*", headers: Constants.HttpRequestConstants.CORS_Headers, methods: "*")]
        public IHttpActionResult Progress(string uploadID)
        {
            try
            {
                ...
                var runtimeLog = new TransactionRuntime { StartedTime = DateTime.Now };
                var result = _ocrBL.ProgressKTP(uploadID);
        ...
        /// <summary>
        /// Get KTP OCR result from Server
        /// </summary>
        /// <param name="uploadID"></param>
        /// <remarks>Search by Criteria</remarks>
        /// <response code="200">OK</response> 
        ...
        /// <returns></returns>
        [Route("Data")]
        [ResponseType(typeof(ResponseBase<OCRKTPDataDto>)), HttpGet]
        [PermissionAuthorize(PermissionName = PermissionConstants.WebAPI_OCR_DataKTP)]
        [EnableCors(origins: "*", headers: Constants.HttpRequestConstants.CORS_Headers, methods: "*")]
        public IHttpActionResult Data(string uploadID)
        {
            try
            {
                ...
                var runtimeLog = new TransactionRuntime { StartedTime = DateTime.Now };
                var result = _ocrBL.DataKTP(uploadID);
