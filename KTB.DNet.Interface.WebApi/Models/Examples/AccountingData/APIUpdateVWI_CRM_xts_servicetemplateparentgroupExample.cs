...
{
    public class APIUpdateVWI_CRM_xts_servicetemplateparentgroupExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_servicetemplateparentgroup = "xts_servicetemplateparentgroup Value"
