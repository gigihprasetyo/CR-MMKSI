...
{
    public class APICreateVWI_CRM_xts_servicetemplateExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_servicetemplatevehiclepricepatternidname = "xts_servicetemplatevehiclepricepatternidname Value"
				...
				,xts_servicetemplate = "xts_servicetemplate Value"
				...
				,ktb_claimtoatpm = "ktb_claimtoatpm Value"
				...
				,xts_servicetemplatevehiclepricepatternid = "xts_servicetemplatevehiclepricepatternid Value"
