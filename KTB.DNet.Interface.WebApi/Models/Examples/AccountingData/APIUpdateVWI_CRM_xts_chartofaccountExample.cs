...
{
    public class APIUpdateVWI_CRM_xts_chartofaccountExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_accounttypename = "xts_accounttypename Value"
				...
				,xts_allowmanualentry = "xts_allowmanualentry Value"
				,xts_chartofaccountid = "xts_chartofaccountid Value"
				...
				,xts_accounttype = "xts_accounttype Value"
				...
				,xts_chartofaccount = "xts_chartofaccount Value"
				...
				,xts_allowmanualentryname = "xts_allowmanualentryname Value"
