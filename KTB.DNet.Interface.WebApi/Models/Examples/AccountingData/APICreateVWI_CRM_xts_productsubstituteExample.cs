...
{
    public class APICreateVWI_CRM_xts_productsubstituteExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_methodforprocurement = "xts_methodforprocurement Value"
				,statecode = "statecode Value"
				,xts_productsubstitutedescription = "xts_productsubstitutedescription Value"
				,xts_methodforsalesorder = "xts_methodforsalesorder Value"
				,owneridname = "owneridname Value"
				,statecodename = "statecodename Value"
				,xts_productsubstituteproductidname = "xts_productsubstituteproductidname Value"
				...
				,xts_useforsalesordername = "xts_useforsalesordername Value"
				,importsequencenumber = "importsequencenumber Value"
				,xts_productsubstitutenumber = "xts_productsubstitutenumber Value"
				...
				,xts_useforworkordername = "xts_useforworkordername Value"
				,xts_methodforprocurementname = "xts_methodforprocurementname Value"
				...
				,xts_useforprocurementname = "xts_useforprocurementname Value"
				,owningbusinessunit = "owningbusinessunit Value"
				,modifiedbyname = "modifiedbyname Value"
				,owningteam = "owningteam Value"
				,xts_useforprocurement = "xts_useforprocurement Value"
				...
				,xts_useforsalesorder = "xts_useforsalesorder Value"
				...
				,xts_useforworkorder = "xts_useforworkorder Value"
				...
				,xts_productsubstituteproductid = "xts_productsubstituteproductid Value"
