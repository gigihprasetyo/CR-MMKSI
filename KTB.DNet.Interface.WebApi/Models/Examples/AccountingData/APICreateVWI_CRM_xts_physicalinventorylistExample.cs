...
{
    public class APICreateVWI_CRM_xts_physicalinventorylistExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_physicalinventorylistid = "xts_physicalinventorylistid Value"
				...
				,xts_inventorylistnumber = "xts_inventorylistnumber Value"
				...
				,xts_generateinventorylistidname = "xts_generateinventorylistidname Value"
				...
				,xts_lasttagnumber = "xts_lasttagnumber Value"
