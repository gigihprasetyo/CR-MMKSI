...
{
    public class APIUpdateVWI_CRM_xts_apvmiscellaneouschargeExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_apvmiscellaneouscharge = "xts_apvmiscellaneouscharge Value"
				...
				,xts_apvmiscellaneouschargeid = "xts_apvmiscellaneouschargeid Value"
