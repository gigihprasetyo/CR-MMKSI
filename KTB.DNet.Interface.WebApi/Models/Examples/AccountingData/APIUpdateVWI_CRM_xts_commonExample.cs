...
{
    public class APIUpdateVWI_CRM_xts_commonExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_isshow = "ktb_isshow Value"
				,xts_locking = "xts_locking Value"
				,statecode = "statecode Value"
				,xts_pkcombinationkey = "xts_pkcombinationkey Value"
				,statecodename = "statecodename Value"
				,ktb_isinstallment = "ktb_isinstallment Value"
				,ktb_isshowname = "ktb_isshowname Value"
				,createdonbehalfby = "createdonbehalfby Value"
				,ktb_numberofinstallment = "ktb_numberofinstallment Value"
				,xts_commonid = "xts_commonid Value"
				,ktb_isdefault = "ktb_isdefault Value"
				,ktb_isdefaultname = "ktb_isdefaultname Value"
				,xts_sortorder = "xts_sortorder Value"
				...
				,ktb_isinstallmentname = "ktb_isinstallmentname Value"
				,xts_value = "xts_value Value"
				...
				,ktb_isdisplayinwoname = "ktb_isdisplayinwoname Value"
				,modifiedon = "modifiedon Value"
				,xts_common = "xts_common Value"
				...
				,ktb_isdisplayinwo = "ktb_isdisplayinwo Value"
