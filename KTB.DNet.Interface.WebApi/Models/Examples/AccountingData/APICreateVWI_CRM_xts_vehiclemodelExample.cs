...
{
    public class APICreateVWI_CRM_xts_vehiclemodelExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_vehiclemodel = "xts_vehiclemodel Value"
