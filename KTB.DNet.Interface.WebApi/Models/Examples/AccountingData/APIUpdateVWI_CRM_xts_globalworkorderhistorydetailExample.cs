...
{
    public class APIUpdateVWI_CRM_xts_globalworkorderhistorydetailExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_globalworkorderhistorydetail = "xts_globalworkorderhistorydetail Value"
				...
				,xts_globalworkorderhistoryidname = "xts_globalworkorderhistoryidname Value"
				,xts_pkcombinationkey = "xts_pkcombinationkey Value"
				,xts_parentbusinessunitid = "xts_parentbusinessunitid Value"
				,xts_quantitymanhouractual = "xts_quantitymanhouractual Value"
				...
				,xts_globalworkorderhistorydetailid = "xts_globalworkorderhistorydetailid Value"
