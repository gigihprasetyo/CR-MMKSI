...
{
    public class APIUpdateVWI_CRM_xts_aptransactiondocumentExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_transactiondocnumber = "xts_transactiondocnumber Value"
				,exchangerate = "exchangerate Value"
				,xts_aptransactiondocumentnumber = "xts_aptransactiondocumentnumber Value"
