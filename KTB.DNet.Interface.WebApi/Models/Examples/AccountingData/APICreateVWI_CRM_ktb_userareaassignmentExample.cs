...
{
    public class APICreateVWI_CRM_ktb_userareaassignmentExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_accessservicename = "ktb_accessservicename Value"
				,statecodename = "statecodename Value"
				,ktb_defaulttrans = "ktb_defaulttrans Value"
				,createdonbehalfby = "createdonbehalfby Value"
				,ktb_defaulttransname = "ktb_defaulttransname Value"
				,ktb_accesspart = "ktb_accesspart Value"
				,ktb_accessvhcpurc = "ktb_accessvhcpurc Value"
				,ktb_useridyominame = "ktb_useridyominame Value"
				,importsequencenumber = "importsequencenumber Value"
				,ktb_useridname = "ktb_useridname Value"
				,modifiedbyyominame = "modifiedbyyominame Value"
				,ktb_teamidname = "ktb_teamidname Value"
				,ktb_accesspartname = "ktb_accesspartname Value"
				,ktb_accessvhcslsname = "ktb_accessvhcslsname Value"
				,ktb_userareaassignment = "ktb_userareaassignment Value"
				...
				,ktb_teamidyominame = "ktb_teamidyominame Value"
				,modifiedby = "modifiedby Value"
				,createdby = "createdby Value"
				,timezoneruleversionnumber = "timezoneruleversionnumber Value"
				,ktb_teamid = "ktb_teamid Value"
				,owneridtype = "owneridtype Value"
				,statuscodename = "statuscodename Value"
				,ktb_userid = "ktb_userid Value"
				,ktb_accessvhcsls = "ktb_accessvhcsls Value"
				,ktb_accessvhcpurcname = "ktb_accessvhcpurcname Value"
				,ktb_businessunitid = "ktb_businessunitid Value"
				,owneridyominame = "owneridyominame Value"
				,modifiedon = "modifiedon Value"
				,ktb_accessservice = "ktb_accessservice Value"
				,ktb_userareaassignmentid = "ktb_userareaassignmentid Value"
