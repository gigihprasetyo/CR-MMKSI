...
{
    public class APIUpdateVWI_CRM_xts_artransactiondocumentExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_transactiondocumentnumber = "xts_transactiondocumentnumber Value"
				...
				,xts_artransactionnumber = "xts_artransactionnumber Value"
