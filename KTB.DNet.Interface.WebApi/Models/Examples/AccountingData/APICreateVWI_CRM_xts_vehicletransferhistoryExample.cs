...
{
    public class APICreateVWI_CRM_xts_vehicletransferhistoryExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_transfersourcesiteidname = "xts_transfersourcesiteidname Value"
				,xts_locking = "xts_locking Value"
				,statecode = "statecode Value"
				,xts_businessunitidname = "xts_businessunitidname Value"
				,xts_stocknumberinventorynewvehiclename = "xts_stocknumberinventorynewvehiclename Value"
				,owneridname = "owneridname Value"
				,statecodename = "statecodename Value"
				,xts_vehicleindentificationnumber = "xts_vehicleindentificationnumber Value"
				,createdonbehalfby = "createdonbehalfby Value"
				,xts_transferdestinationsiteid = "xts_transferdestinationsiteid Value"
				...
				,xts_transfernumber = "xts_transfernumber Value"
				...
				,xts_vehicletransferhistoryid = "xts_vehicletransferhistoryid Value"
				,xts_transfersourcesiteid = "xts_transfersourcesiteid Value"
				...
				,xts_stocknumberinventorynewvehicle = "xts_stocknumberinventorynewvehicle Value"
				,modifiedonbehalfbyname = "modifiedonbehalfbyname Value"
				,xts_transferdestinationsiteidname = "xts_transferdestinationsiteidname Value"
