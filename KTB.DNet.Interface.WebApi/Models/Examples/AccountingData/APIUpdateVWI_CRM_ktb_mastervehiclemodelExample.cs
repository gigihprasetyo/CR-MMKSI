...
{
    public class APIUpdateVWI_CRM_ktb_mastervehiclemodelExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_vehiclemodelcode = "ktb_vehiclemodelcode Value"
				...
				,ktb_mastervehiclemodelid = "ktb_mastervehiclemodelid Value"
