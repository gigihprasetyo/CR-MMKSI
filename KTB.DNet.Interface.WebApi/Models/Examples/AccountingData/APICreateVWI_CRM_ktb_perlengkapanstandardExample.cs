...
{
    public class APICreateVWI_CRM_ktb_perlengkapanstandardExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_newvehiclemodelid = "ktb_newvehiclemodelid Value"
				,owneridname = "owneridname Value"
				,statecodename = "statecodename Value"
				,createdonbehalfby = "createdonbehalfby Value"
				,ktb_perlengkapanstandard = "ktb_perlengkapanstandard Value"
				,ktb_perlengkapanstandardid = "ktb_perlengkapanstandardid Value"
				...
				,ktb_newvehiclemodelidname = "ktb_newvehiclemodelidname Value"
