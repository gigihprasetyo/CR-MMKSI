...
{
    public class APICreateVWI_CRM_ktb_productsapconversionExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_productsapdesc = "ktb_productsapdesc Value"
				...
				,ktb_uomname = "ktb_uomname Value"
				,importsequencenumber = "importsequencenumber Value"
				,ktb_uom = "ktb_uom Value"
				,ktb_productsapconversionid = "ktb_productsapconversionid Value"
				...
				,ktb_productreferenceidname = "ktb_productreferenceidname Value"
				...
				,ktb_productreferenceid = "ktb_productreferenceid Value"
				...
				,ktb_productsapconversion = "ktb_productsapconversion Value"
