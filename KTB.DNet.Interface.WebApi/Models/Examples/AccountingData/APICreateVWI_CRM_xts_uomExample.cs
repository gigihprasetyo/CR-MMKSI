...
{
    public class APICreateVWI_CRM_xts_uomExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_decimalprecision = "xts_decimalprecision Value"
				...
				,xts_unitclass = "xts_unitclass Value"
				...
				,xts_unitclassname = "xts_unitclassname Value"
