...
{
    public class APIUpdateVWI_CRM_xts_servicereservationclassExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_reservationclass = "xts_reservationclass Value"
				...
				,xts_servicereservationclassid = "xts_servicereservationclassid Value"
