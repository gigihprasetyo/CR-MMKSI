...
{
    public class APICreateVWI_CRM_xts_workordertimeregisterExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_serviceactivityidname = "xts_serviceactivityidname Value"
				...
				,xts_laborcost_base = "xts_laborcost_base Value"
				,importsequencenumber = "importsequencenumber Value"
				,xts_completed = "xts_completed Value"
				,xts_workordertimeregisterid = "xts_workordertimeregisterid Value"
				...
				,xts_stopreasonname = "xts_stopreasonname Value"
