...
{
    public class APICreateVWI_CRM_xts_commonbusinessunitExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_commonbusinessunitid = "xts_commonbusinessunitid Value"
				...
				,xts_commonbusinessunit = "xts_commonbusinessunit Value"
