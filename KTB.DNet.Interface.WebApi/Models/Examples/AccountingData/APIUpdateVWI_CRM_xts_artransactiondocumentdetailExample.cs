...
{
    public class APIUpdateVWI_CRM_xts_artransactiondocumentdetailExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_artransactiondocumentidname = "xts_artransactiondocumentidname Value"
				...
				,xts_artransactiondocumentdetailid = "xts_artransactiondocumentdetailid Value"
				,xts_debitamount_base = "xts_debitamount_base Value"
				,xts_artransactiondocumentid = "xts_artransactiondocumentid Value"
				...
				,xts_artransactiondocumentdetailnumber = "xts_artransactiondocumentdetailnumber Value"
