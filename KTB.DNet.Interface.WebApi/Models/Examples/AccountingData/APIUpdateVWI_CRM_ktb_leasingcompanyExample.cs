...
{
    public class APIUpdateVWI_CRM_ktb_leasingcompanyExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,ktb_leasingname = "ktb_leasingname Value"
