...
{
    public class APIUpdateVWI_CRM_xts_servicemiscellaneouschargeExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_servicemiscellaneouschargeid = "xts_servicemiscellaneouschargeid Value"
				...
				,xts_servicemiscellaneouscharge = "xts_servicemiscellaneouscharge Value"
				...
				,ktb_billtocustomeridyominame = "ktb_billtocustomeridyominame Value"
