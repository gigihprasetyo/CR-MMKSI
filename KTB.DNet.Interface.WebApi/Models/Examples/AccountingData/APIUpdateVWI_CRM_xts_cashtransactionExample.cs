...
{
    public class APIUpdateVWI_CRM_xts_cashtransactionExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_totalcontrolamount_base = "xts_totalcontrolamount_base Value"
				...
				,xts_cashtransactiondate = "xts_cashtransactiondate Value"
				...
				,xts_totalcontrolamount = "xts_totalcontrolamount Value"
				,xts_hascancelledname = "xts_hascancelledname Value"
				,xts_cashtransactiontype = "xts_cashtransactiontype Value"
				,xts_cashtransactiontypename = "xts_cashtransactiontypename Value"
				,owneridyominame = "owneridyominame Value"
				,xts_cashtransactionreferenceid = "xts_cashtransactionreferenceid Value"
				,modifiedon = "modifiedon Value"
				,xts_hascancelled = "xts_hascancelled Value"
				...
				,xts_cashtransaction = "xts_cashtransaction Value"
				...
				,xts_cashtransactionreferenceidname = "xts_cashtransactionreferenceidname Value"
