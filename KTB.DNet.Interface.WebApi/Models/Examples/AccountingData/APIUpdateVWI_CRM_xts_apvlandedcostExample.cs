...
{
    public class APIUpdateVWI_CRM_xts_apvlandedcostExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_apvlandedcost = "xts_apvlandedcost Value"
				,xts_purchasereceiptlandedcostidname = "xts_purchasereceiptlandedcostidname Value"
				...
				,xts_apvlandedcostid = "xts_apvlandedcostid Value"
				...
				,xts_purchasereceiptlandedcostid = "xts_purchasereceiptlandedcostid Value"
