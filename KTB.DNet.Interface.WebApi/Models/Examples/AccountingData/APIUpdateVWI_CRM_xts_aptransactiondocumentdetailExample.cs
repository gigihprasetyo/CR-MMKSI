...
{
    public class APIUpdateVWI_CRM_xts_aptransactiondocumentdetailExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_aptransactiondocumentdetailid = "xts_aptransactiondocumentdetailid Value"
				...
				,xts_customertransactionnumber = "xts_customertransactionnumber Value"
				,xts_gljournaldetailreference = "xts_gljournaldetailreference Value"
				,xts_transactiontypename = "xts_transactiontypename Value"
				,importsequencenumber = "importsequencenumber Value"
				,xts_creditamount = "xts_creditamount Value"
				,modifiedbyyominame = "modifiedbyyominame Value"
				,xts_debitamount = "xts_debitamount Value"
				...
				,xts_creditamount_base = "xts_creditamount_base Value"
				,owneridyominame = "owneridyominame Value"
				,xts_aptransactiondocumentid = "xts_aptransactiondocumentid Value"
				,modifiedon = "modifiedon Value"
				,exchangerate = "exchangerate Value"
				,xts_aptransactiondocumentdetailnumber = "xts_aptransactiondocumentdetailnumber Value"
				,xts_gljournalnumber = "xts_gljournalnumber Value"
				,modifiedonbehalfbyyominame = "modifiedonbehalfbyyominame Value"
				,statuscode = "statuscode Value"
				,createdbyname = "createdbyname Value"
				,createdon = "createdon Value"
				,xts_debitamount_base = "xts_debitamount_base Value"
				...
				,xts_aptransactiondocumentidname = "xts_aptransactiondocumentidname Value"
