...
{
    public class APIUpdateVWI_CRM_xts_miscellaneouschargetemplateExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_lightcar = "xts_lightcar Value"
				...
				,xts_miscellaneouschargetemplate = "xts_miscellaneouschargetemplate Value"
				...
				,xts_lightcarname = "xts_lightcarname Value"
