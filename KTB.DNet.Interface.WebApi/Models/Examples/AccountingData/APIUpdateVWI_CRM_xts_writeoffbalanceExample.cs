...
{
    public class APIUpdateVWI_CRM_xts_writeoffbalanceExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_parrentbusinessunitid = "xts_parrentbusinessunitid Value"
				...
				,xts_writeofflimit_base = "xts_writeofflimit_base Value"
				...
				,xts_writeofftypename = "xts_writeofftypename Value"
				...
				,xts_parrentbusinessunitidname = "xts_parrentbusinessunitidname Value"
