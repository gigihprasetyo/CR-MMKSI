...
{
    public class APIUpdateVWI_CRM_xts_nvsoreferralExample : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_referraltaxamount = "xts_referraltaxamount Value"
				,xts_methodofpaymentidname = "xts_methodofpaymentidname Value"
				,xts_referralvendoridname = "xts_referralvendoridname Value"
				...
				,xts_nvsqreferralidname = "xts_nvsqreferralidname Value"
				...
				,xts_referraltaxid = "xts_referraltaxid Value"
				,xts_relationshipcategory = "xts_relationshipcategory Value"
				,xts_bank = "xts_bank Value"
				,overriddencreatedon = "overriddencreatedon Value"
				,xts_relationshipcategoryname = "xts_relationshipcategoryname Value"
				...
				,xts_referraltaxamount_base = "xts_referraltaxamount_base Value"
				,xts_locking = "xts_locking Value"
				,xts_bankaccounttypename = "xts_bankaccounttypename Value"
				,xts_totalamount_base = "xts_totalamount_base Value"
				,xts_apvouchername = "xts_apvouchername Value"
				...
				,xts_nvsqreferralid = "xts_nvsqreferralid Value"
				,xts_bankaccounttype = "xts_bankaccounttype Value"
				,xts_apvoucher = "xts_apvoucher Value"
				,xts_nvsoreferralid = "xts_nvsoreferralid Value"
				...
				,xts_referraltaxidname = "xts_referraltaxidname Value"
				...
				,xts_referralvendorid = "xts_referralvendorid Value"
				,createdbyyominame = "createdbyyominame Value"
				,owninguser = "owninguser Value"
				,xts_nvsoreferralnumber = "xts_nvsoreferralnumber Value"
				...
				,xts_referraldescription = "xts_referraldescription Value"
