...
{
    public class APICreateVWI_CRM_xts_productsegment2Example : IExamplesProvider
    {
        public object GetExamples()
        {
            var obj = new
            {
				...
				,xts_productsegment2typename = "xts_productsegment2typename Value"
				...
				,xts_productsegment2type = "xts_productsegment2type Value"
