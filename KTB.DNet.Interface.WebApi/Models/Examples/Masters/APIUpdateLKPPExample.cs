...
{
    public class APIUpdateLKPPExample : IExamplesProvider
    {
        public object GetExamples()
        {
            ...
            {
				ID = "ID value",
				ReferenceNumber = "KDR-P1234-5678",
				LetterDate = "17102021",
				GovInstName = "DINAS PERIKANAN",
				Description = "PENGEMBANGAN TEKNOLOGI PERIKANAN",
				Classification = 0,
				Notes = "LKPP Notes",
				Status = 0,
				DealerCode = "100170",
				...
				LKPPDetails = new List<object>
				{
					new
					{
						ID = 0,
						Unit = 4,
						VehicleTypeCode = "XT01",
