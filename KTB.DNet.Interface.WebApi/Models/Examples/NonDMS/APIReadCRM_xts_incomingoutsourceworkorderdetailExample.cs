...
{
    public class APIReadCRM_xts_incomingoutsourceworkorderdetailExample : IExamplesProvider
    {
            ...
            var obj = new FilterDtoBase
            {
                ...
                find = new List<MatchTypeFilter>
                {
                    new MatchTypeFilter
                    {
                        ...
                        PropertyName = "xts_incomingoutsourceworkorderdetailid",
                ...
                sort = new List<SortFilter>
                {
                    new SortFilter
                    {
                        SortColumn = "xts_incomingoutsourceworkorderdetailid",
