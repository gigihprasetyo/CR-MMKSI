...
{
    public class APIReadCRM_xts_newvehicleaccessoriesExample : IExamplesProvider
    {
            ...
            var obj = new FilterDtoBase
            {
                ...
                find = new List<MatchTypeFilter>
                {
                    new MatchTypeFilter
                    {
                        ...
                        PropertyName = "xts_newvehicleaccessoriesid",
                ...
                sort = new List<SortFilter>
                {
                    new SortFilter
                    {
                        SortColumn = "xts_newvehicleaccessoriesid",
