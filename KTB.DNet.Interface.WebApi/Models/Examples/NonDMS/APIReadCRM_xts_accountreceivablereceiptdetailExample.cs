...
{
    public class APIReadCRM_xts_accountreceivablereceiptdetailExample : IExamplesProvider
    {
            ...
            var obj = new FilterDtoBase
            {
                ...
                find = new List<MatchTypeFilter>
                {
                    new MatchTypeFilter
                    {
                        ...
                        PropertyName = "xts_accountreceivablereceiptdetailid",
                ...
                sort = new List<SortFilter>
                {
                    new SortFilter
                    {
                        SortColumn = "xts_accountreceivablereceiptdetailid",
