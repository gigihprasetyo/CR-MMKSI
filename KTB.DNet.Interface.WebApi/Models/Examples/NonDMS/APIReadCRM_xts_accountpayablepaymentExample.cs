...
{
    public class APIReadCRM_xts_accountpayablepaymentExample : IExamplesProvider
    {
            ...
            var obj = new FilterDtoBase
            {
                ...
                find = new List<MatchTypeFilter>
                {
                    new MatchTypeFilter
                    {
                        ...
                        PropertyName = "xts_accountpayablepaymentid",
                ...
                sort = new List<SortFilter>
                {
                    new SortFilter
                    {
                        SortColumn = "xts_accountpayablepaymentid",
