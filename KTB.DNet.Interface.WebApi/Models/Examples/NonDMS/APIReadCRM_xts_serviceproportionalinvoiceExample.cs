...
{
    public class APIReadCRM_xts_serviceproportionalinvoiceExample : IExamplesProvider
    {
            ...
            var obj = new FilterDtoBase
            {
                ...
                find = new List<MatchTypeFilter>
                {
                    new MatchTypeFilter
                    {
                        ...
                        PropertyName = "xts_serviceproportionalinvoiceid",
                ...
                sort = new List<SortFilter>
                {
                    new SortFilter
                    {
                        SortColumn = "xts_serviceproportionalinvoiceid",
