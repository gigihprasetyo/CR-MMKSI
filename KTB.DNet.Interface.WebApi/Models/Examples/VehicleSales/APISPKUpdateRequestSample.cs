...
// ===========================================================================
// AUTHOR        : PT Mitrais 
// PURPOSE       : APISPKUpdateRequestSample class
...
{
    public class APISPKUpdateRequestSample : IExamplesProvider
    {
        public object GetExamples()
        {
            return new
            {
                ID = 867501,
                DealerCode = "100109",
                DealerSPKNumber = "YUKI",
                SalesmanCode = "S-100002",
