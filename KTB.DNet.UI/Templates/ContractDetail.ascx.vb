...
Public Class ContractDetailxxx
...
#End Region
    ...
    Private Sub ContractDetail_DataBind(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.DataBinding
        ...
        dgContractDetail.DataSource = ds
        dgContractDetail.DataMember = "ContractDetail"
    ...
    Private Sub dgContractDetail_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgContractDetail.ItemDataBound
        ...
        If Not e.Item.DataItem Is Nothing Then
            ...
            If ItemType = ListItemType.Item Or ItemType = ListItemType.AlternatingItem Then
                ...
                Dim vc As Ktb.DNet.Domain.VechileColor = New VechileColorFacade(System.Threading.Thread.CurrentPrincipal).Retrieve(RowValue("VechileColor.ID"))
