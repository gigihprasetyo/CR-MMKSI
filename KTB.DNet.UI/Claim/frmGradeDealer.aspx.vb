...
#Region "Custom Method"
    ...
    Private Sub CreateCriteria()
        ...
        If txtETA.Text <> String.Empty Then
            criterias.opAnd(New Criteria(GetType(DealerAdditional), "SparePartGrade", MatchType.Partial, txtETA.Text.Trim))
        End If
    ...
    Private Sub UpdateClaimReason()
        ...
        Try
            ...
            objCDealerETA.SparePartGrade = txtETA.Text
    ...
    Private Sub ViewDealerETA(ByVal nID As Integer, ByVal EditStatus As Boolean)
        ...
        If Not IsNothing(objCDealerETA) Then
            ...
            txtETA.Text = objCDealerETA.SparePartGrade
        Else
            If EditStatus Then
                MessageBox.Show(SR.UpdateFail)
            Else
    ...
    Private Sub DeleteDealerETA(ByVal nID As Integer)
        ...
        Try
            ...
            objCDealerETA.RowStatus = DBRowStatus.Deleted
...
#End Region
    ...
    Private Sub InitiateAuthorization()
        If Not SecurityProvider.Authorize(context.User, SR.PerkiaraanKedatanganView_Privilege) Then
            Server.Transfer("../FrmAccessDenied.aspx?modulName=CLAIM - SParePartGrade")
        End If
    End Sub
...
#Region "Event Hendlers"
    ...
    Private Sub btnSimpan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        If Not Page.IsValid Then
            Return
        End If
        If txtETA.Text.Trim = "" Then
            MessageBox.Show("Nilai Grade tidak boleh Kosong")
            Return
        End If
