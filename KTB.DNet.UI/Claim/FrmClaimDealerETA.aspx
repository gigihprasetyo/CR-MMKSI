<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmClaimDealerETA.aspx.vb" Inherits="FrmClaimDealerETA" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<TR>
					<TD class="titlePage" colSpan="3">
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage">CLAIM - Parameter Perkiraan Kedatangan </td>
							</tr>
							<tr>
				...
				<TR>
					<TD class="titleField" noWrap>Estimasi Pengiriman (Hari)</TD>
					<td>:</td>
					<TD><asp:textbox onkeypress="return NumericOnlyWith(event,'');" id="txtETA" onblur="omitSomeCharacter('txtETA','-')"
							onkeyup="pic(this,this.value,'9999999999','N')" runat="server" Width="64px" MaxLength="4"></asp:textbox></TD>
				</TR>
				<TR>
					<TD></TD>
					<td></td>
					...
					<TD colSpan="3">
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 360px" DESIGNTIMEDRAGDROP="245"><asp:datagrid id="dtgClaimDealerETA" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="ClaimETA" SortExpression="ClaimETA" HeaderText="Estimasi Pengiriman (Hari)">
										<HeaderStyle Width="30%" CssClass="titleTableParts"></HeaderStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn>
