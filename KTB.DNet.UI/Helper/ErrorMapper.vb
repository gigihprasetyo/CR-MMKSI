...
#Region "Private Variables"
    ...
    Private m_XmlMapPath As String = "\ErrorConfig.xml"
    Private m_XmlMenuIDAttribute As String = "Exception"
    Private m_XmlMenuPageAttribute As String = "Code"
...
#Region "Public Methods"
    Public Function GetErrorCode(ByVal _Exception As String) As String
        Try
            Return Me.m_MapTable(_Exception).ToString()
