...
Public Class PopUpDealerSelectionOneBenefit
...
#Region " Event Hendler "
    ...
    Public Sub BindSearch()
        ...
        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "Title", MatchType.Exact, "0"))
        'criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "ID", MatchType., "0"))
        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "ID", MatchType.No, "1"))


        Dim strSql As String = ""
        strSql += " select id from Dealer  where Title = 0 And ID <> 1 And RowStatus = 0"
        strSql += " and DealerCode not like '190%' and DealerCode <> '180002' "
