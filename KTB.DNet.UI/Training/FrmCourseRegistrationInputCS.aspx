<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmCourseRegistrationInputCS.aspx.vb" Inherits=".FrmCourseRegistrationInputCS" MaintainScrollPositionOnPostback="true" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function popUpDataSiswa(trTraineeID) {
            ...
            var url = '../PopUp/PopUpTrTraineeDetail.aspx?trtraineeid=' + trTraineeID;
            showPopUp(url, '', 600, 800, null);
        }
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
                ...
                <td valign="top">
                    <div id="div1" style="overflow: auto; height: 200px">
                        <asp:DataGrid ID="dtgHeader" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            AllowSorting="True" ForeColor="GhostWhite" CellSpacing="1" Font-Names="MS Reference Sans Serif" AllowPaging="false">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="No KTP" SortExpression="ID">
                                    <HeaderStyle Width="7%" CssClass="titleTableService"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblNoKtp" Text='<%# DataBinder.Eval(Container, "DataItem.NoKTP") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateColumn>
            ...
            <tr id="trBtnTambah" runat="server">
                <td align="center">
                    <%--<input type="button" width="100px" value="Tambahkan" onclick="GetSelectedTrainee()" />--%>
                    <asp:Button ID="BtnTambah" runat="server" Width="100px" CausesValidation="false" OnClientClick="GetSelectedTrainee()" Text="Tambahkan" TabIndex="15"></asp:Button>
                    &nbsp;
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="background-color: Cyan; width: 50px">&nbsp;&nbsp;</td>
                            <td>Terdaftar</td>
                            <td style="width: 30px"></td>
                            <td style="background-color: orangered; width: 50px">&nbsp;&nbsp;</td>
                            <td>Ditolak oleh dealer</td>
                            <td style="width: 30px"></td>
                            <td style="background-color: gray; width: 50px">&nbsp;&nbsp;</td>
                            <td>Resign</td>
                            <td style="width: 30px"></td>
                            <td style="background-color: mediumpurple; width: 50px">&nbsp;&nbsp;</td>
                            <td>Pindah Posisi</td>
                        </tr>
                    ...
                    <td>
                        ...
                        <div id="dvBooking" runat="server" style="overflow: auto; height: 150px">
                            <asp:DataGrid ID="dtgBooking" runat="server" Width="100%" AutoGenerateColumns="False"
                                GridLines="Horizontal" CellPadding="3" BackColor="Gainsboro" BorderWidth="0px" BorderStyle="None" BorderColor="#CDCDCD"
                                AllowPaging="false" AllowSorting="True" PageSize="25" ForeColor="GhostWhite" CellSpacing="1" Font-Names="MS Reference Sans Serif">
                                <SelectedItemStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#738A9C"></SelectedItemStyle>
                                <AlternatingItemStyle BackColor="#F6F6F6"></AlternatingItemStyle>
                                <ItemStyle BackColor="White"></ItemStyle>
                                <FooterStyle ForeColor="#4A3C8C" BackColor="#B5C7DE"></FooterStyle>
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnConfirmSingle" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID")%>' runat="server" Width="16px" Visible="false" Text="Konfirmasi" CausesValidation="False" CommandName="Confirm">
												<img src="../images/aktif.gif" border="0" alt="Konfirmasi"></asp:LinkButton>

                                            <asp:LinkButton ID="btnReject" runat="server" Width="16px" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID")%>' Text="Tolak" Visible="false" CausesValidation="False" CommandName="Reject">
            ...
            <tr>
                <td align="center">
                    ...
                    &nbsp;
                     <asp:Button ID="btnDownload" runat="server" Width="60px" Text="Download" TabIndex="15"></asp:Button>
                    &nbsp;
