<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPendaftaranSales.aspx.vb" Inherits="FrmPendaftaranSales" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmPendaftaranSales</title>
		...
		<script language="javascript">
			...
			*/
			...
			{
				showPopUp('../PopUp/PopUpCourse.aspx?category=sales','',550,760,courseSelection);
			}
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">TRAINING SALES - Pendaftaran</td>
				</tr>
				<tr>
						...
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 450px" DESIGNTIMEDRAGDROP="169"><asp:datagrid id="dtgClassAllocation" runat="server" Width="100%" PageSize="25" AllowPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="TrClass.TrCourse.CourseCode" HeaderText="Kode Kategori">
										...
										<ItemTemplate>
											<asp:Label id="lblCategoryCode" runat="server" Width="68px" Text='<%# DataBinder.Eval(Container, "DataItem.TrClass.TrCourse.CourseCode") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:TemplateColumn>
										...
										<ItemTemplate>
											<asp:LinkButton id="lbtnDetail" runat="server" CommandName="Detail" ToolTip="Pilih Siswa">
												<img src="../images/add.gif" border="0" alt="Daftar"></asp:LinkButton>
                                            <asp:LinkButton id="lbtnView" runat="server" CommandName="lihat" ToolTip="Detail">
