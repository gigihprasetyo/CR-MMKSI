<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmTrClassDetailAss.aspx.vb" Inherits=".FrmTrClassDetailAss" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function courseSelection(selectedCourse) {
            ...
            document.getElementById("btnTriggerPrice").click();
        }
        ...
        function mrtcSelection(selectedMrtc) {
            ...
            var txtMRTCID = document.getElementById("txtMRTCID");
            txtMRTCID.value = data[0];

            var clickButton = document.getElementById("btnTriggerMRTC");
            clickButton.click();
            document.getElementById("btnTriggerPrice").click();
...
<body ms_positioning="GridLayout">
    <form id="Form1" enctype="multipart/form-data" method="post" runat="server">
        ...
        <table id="Table99" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td style="width: 825px; height: 20px" class="titlePage" colspan="2">Training After Sales&nbsp;- 
						Detail Kelas</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 100%">
                    <table id="Table1" style="width: 100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td valign="top">
                                <table style="width: 100%; height: 300px" id="Table2" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                        ...
                                        <td height="1" width="1%">:</td>
                                        <td width="80%" nowrap="nowrap" id="tdtipekelas" runat="server">
                                            <asp:DropDownList ID="ddlTipeKelas" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td width="150" class="titleField">MRTC</td>
                                        <td style="height: 10px">:</td>
                                        <td width="80%" nowrap="nowrap">
                                            <asp:TextBox ID="txtMRTCID" runat="server" MaxLength="20"
                                                Width="120px" AutoPostBack="true" CausesValidation="false"></asp:TextBox>
                                            <asp:Label ID="lbtnMRTC" runat="server" Width="16px" onclick="ShowPopupMRTC();">
													<img style="cursor:hand" alt="Klik Popup" src="../images/popup.gif" border="0"></asp:Label></td>
                                        <asp:Button ID="btnTriggerMRTC" runat="server" CssClass="hidden" CausesValidation="false" />
                                          <asp:Button ID="btnTriggerPrice" runat="server" CssClass="hidden" CausesValidation="false" />
                                        <asp:CustomValidator CssClass="style-warning" ID="cvMRTC" runat="server" ControlToValidate="" OnServerValidate="cvMRTC_ServerValidate" ErrorMessage=""></asp:CustomValidator>
                            </td>
                        </tr>

                        <div id="divPayment" runat="server" visible="false">
                            <tr>
                                <td width="150" class="titleField">Harga per Hari</td>
                                <td style="height: 15px">:</td>
                                <td width="80%" nowrap="nowrap">
                                    <asp:Label ID="lblPricePerDay" runat="server"></asp:Label></td>
                            </tr>

                            <tr>
                                <td width="150" class="titleField">Jumlah Hari Berbayar</td>
                                <td style="height: 15px">:</td>
                                <td width="80%" nowrap="nowrap">
                                    <asp:TextBox ID="txtPaidDay" onkeypress="return numericOnlyUniv(event)" runat="server" MaxLength="2"
                                        Width="120px" TabIndex="7" CausesValidation="false" AutoPostBack="true"></asp:TextBox>
                                    * Dalam hari</td>
                            </tr>

                            <tr>
                                <td width="150" class="titleField">Total Harga</td>
                                <td style="height: 15px">:</td>
                                <td width="80%" nowrap="nowrap">
                        ...
                        <tr>
                            ...
                            <td width="80%" nowrap="nowrap">
                                <asp:TextBox ID="txtLocationName" onkeypress="return HtmlCharUniv(event)" runat="server" MaxLength="100"
                                    Width="320px" TabIndex="3"></asp:TextBox><asp:RequiredFieldValidator ID="Requiredfieldvalidator5" runat="server" ErrorMessage="*" ControlToValidate="txtLocationName"></asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="150" class="titleField" height="21">Penginapan</td>
                            <td style="height: 21px" height="21" width="1%">:</td>
                            <td width="80%" nowrap="nowrap">
                                <asp:TextBox ID="txtPenginapan" onkeypress="return HtmlCharUniv(event)" runat="server" MaxLength="100"
                                    Width="320px" TabIndex="3"></asp:TextBox></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="height: 10px">:</td>
                            <td width="80%" nowrap="nowrap" id="tdddlTahunFiscal" runat="server">
                                <asp:DropDownList ID="ddlTahunFiscal" CausesValidation="false" AutoPostBack="true" Width="120px" runat="server" TabIndex="9"></asp:DropDownList><asp:Label ID="Label1" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td width="150" class="titleField">Status</td>
                            <td style="height: 10px">:</td>
                            <td width="80%" nowrap="nowrap" runat="server">
                        ...
                        <tr id="trUploadCer" runat="server">
                            <td width="150" class="titleField">Upload Certificate</td>
                            <td style="height: 12px">:</td>
                            <td width="80%" nowrap="nowrap">
                                <input onkeypress="return false;" id="docSrc" tabindex="19" type="file" size="29" name="File1"
                                    runat="server">
                                &nbsp;
                                            <asp:Button ID="btnUploadDoc" runat="server" Text="Upload" CausesValidation="false"></asp:Button>
                                <asp:HiddenField ID="hdnFilePath2" runat="server" />
                                &nbsp;

                            </td>
                        </tr>
                        <tr id="trDownloadCer" runat="server" visible="false">
                            <td width="150" class="titleField">Download Certificate</td>
                            <td style="height: 12px">:</td>
                            <td width="80%">
                                <asp:LinkButton ID="lbtnDownloadCer" runat="server" Text="Download Certificate" CausesValidation="false"></asp:LinkButton>
                                &nbsp;
                                              <asp:LinkButton ID="lbnDeleteCer" runat="server" Text="Hapus" CausesValidation="false"></asp:LinkButton>
