<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmDataSiswa.aspx.vb" Inherits="FrmDataSiswa" smartNavigation="False"%>
	...
	<HEAD>
		...
		<script type="text/javascript">
		    function txtOnBlur(obj) {
		        ...
		        hdnDealerCode.value = txtDealerCode.value;
		    }
		    ...
		    function DealerSelection(selectedDealer)
		    {
		        ...
		        hdnDealerCode.value = selectedDealer;
		    }
		
		    function ShowJobPosSelection()
		    {
			    //alert('bisa');
			    showPopUp('../PopUp/PopUpJobPosition.aspx?Category=2&amp;Menu=5','',600,600,JobPosSelection);
		    }
		...
		<FORM id="Form1" method="post" encType="multipart/form-data" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TD vAlign="top">
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 428px" noWrap width="428"><asp:textbox onblur="TxtBlurName('txtName');" id="txtName" runat="server" Width="400px"
							...
							<TR>
								...
								<TD style="WIDTH: 428px" width="428">
									<P><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtDealerCode" runat="server" Width="128px" ClientIDMode="Static"
											onblur=txtOnBlur(); MaxLength="10" ToolTip="Dealer Search"></asp:textbox><asp:label id="lblPopUpDealer" runat="server" width="16px">
							...
							<TR>
								...
								<TD style="WIDTH: 550px; HEIGHT: 18px" valign="middle">
									<table  cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td><cc1:inticalendar id="ICStartWork" runat="server" CanPostBack="False" Friday="True" Monday="True" Saturday="True" ScriptOnFocusOut="" Sunday="True" TargetForm="" TargetTemporaryFocus="" TargetTextBox="" Thursday="True" Tuesday="True" Value="11/04/2019 09:08:02" Wednesday="True"></cc1:inticalendar></td>
											<td>&nbsp; Format dd/mm/yyyy </td>
										</tr>
									</table>
								</TD>
				...
				<TR id="trGrid" runat="server">
					<TD vAlign="top">
						<DIV id="div1" runat="server" style="OVERFLOW: auto; HEIGHT: 180px"><asp:datagrid id="dtgTrainee" runat="server" Width="100%" Font-Names="MS Reference Sans Serif"
								...
								<Columns>
									...
									<asp:BoundColumn Visible="false" DataField="ID" SortExpression="ID" HeaderText="No Reg">
                                    ...
                                    <asp:TemplateColumn SortExpression="JobPosition" HeaderText="Posisi Pekerjaan">
										<HeaderStyle Width="6%" CssClass="titleTableService"></HeaderStyle>
										<ItemTemplate>
                                    ...
                                    <asp:BoundColumn DataField="NoKTP" SortExpression="NoKTP" HeaderText="No KTP">
										<HeaderStyle Width="6%" CssClass="titleTableService"></HeaderStyle>
										<ItemStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
									</asp:BoundColumn>
                ...
                <tr>
                    <td align="center"><asp:Button ID="btnDownload" runat="server" Text="Download" CausesValidation="false" /></td>
                </tr>
			</TABLE>
		</FORM>
