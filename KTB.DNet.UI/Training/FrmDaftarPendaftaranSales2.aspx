...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmDaftarPendaftaranSales2.aspx.vb" Inherits="FrmDaftarPendaftaranSales2" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="740" border="0">
				<tr>
					<td class="titlePage">TRAINING&nbsp;SALES- Pendaftaran - Detail</td>
				</tr>
				<tr>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<TD>
									<asp:TextBox id="txtTglPendaftaran" runat="server" ></asp:TextBox></TD>
							</TR>
							<tr>
							...
							<TR>
								...
								<TD>
									<asp:textbox id="txtTraineeName" runat="server"  onkeypress="return HtmlCharUniv(event)"
										Width="250px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="titleField">Nama Dealer</TD>
								<TD>
									<asp:textbox id="txtDealerName" runat="server"  onkeypress="return HtmlCharUniv(event)"
										Width="250px"></asp:textbox></TD>
							</TR>
							<tr>
							...
							<TR>
								...
								<TD>
									<asp:textbox id="txtClassCode" runat="server"  onkeypress="return HtmlCharUniv(event)"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="titleField">Nama Kelas</TD>
								<TD>
									<asp:textbox id="txtClassName" runat="server"  onkeypress="return HtmlCharUniv(event)"
										Width="250px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="titleField">Lokasi</TD>
								<TD>
									<asp:textbox id="txtLocation" runat="server"  onkeypress="return HtmlCharUniv(event)"
										Width="250px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="titleField">Mulai</TD>
								<TD>
									<asp:textbox id="txtStartDate" runat="server"  onkeypress="return HtmlCharUniv(event)"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="titleField">Selesai</TD>
								<TD>
									<asp:textbox id="txtFinishDate" runat="server"  onkeypress="return HtmlCharUniv(event)"></asp:textbox></TD>
							</TR>
							<TR>
