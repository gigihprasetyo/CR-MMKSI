...
Public Class FrmTrClassRegistration1
...
#Region "Private Method"
    ...
    Private Function CreateDefaultCriteria(ByRef nResult As Integer) As CriteriaComposite
        ...
        'Dim dtStartDate As DateTime = GenerateDateForSearch()
        'If dtStartDate <> "1/1/1900" Then
        '    criterias.opAnd(New Criteria(GetType(TrClassAllocation), _
        '        "TrClass.StartDate", MatchType.GreaterOrEqual, dtStartDate))
        'End If

        'Modifikasi untuk bug fix sbb.
        ' 1. data kelas yang mulai tanggal 02/01/2006 s/d 04/01/2006 muncul pd saat pencarian untuk bulan Desember 2005 
        ' 2. data kelas untuk bulan Desember juga keluar pada saat pencarian untuk bulan yg lain 
    ...
    Private Sub InitInfoAllocation()
        ...
        'crits.opAnd(New Criteria(GetType(v_trClass), "NumOfTrainee", MatchType.LesserOrEqual, 0))
        ...
        'Dim objtrClassFac As New TrClassFacade(User)
        'arltrClass = objtrClassFac.RetrieveClassAllocated(crits)
        ...
        If arltrClass.Count > 0 Then
            For Each objv_trclass As v_trClass In arltrClass
                ...
                If objTrClass.Status = EnumTrDataStatus.DataStatusType.Active Then
                    Dim strUrlReg As String = "../Training/FrmTrClassRegistration2.aspx?" & _
                    ...
                    'Dim strUrlDetail As String = "FrmTrClassDetail.aspx"
                    Dim strUrlCancel As String = "FrmTrClassAllocationCancel.aspx?ID=" & objv_trclass.ID & "&Opener=FrmTrClassRegistration1.aspx"
...
#Region "Event Handler"
    ...
    Private Sub dtgClassAllocation_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dtgClassAllocation.ItemCommand
        If e.CommandName = "Detail" Then
            ...
            'Request dari peggy
            'If CInt(AlocRemaining.Text) <= 0 Then
