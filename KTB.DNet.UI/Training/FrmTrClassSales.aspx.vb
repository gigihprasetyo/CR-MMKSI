...
#Region " subs & function "
    ...
    Private Function SetFormatEmail(ByVal ObjTrClass As TrClass, ByVal ObjDealer As Dealer) As String
        ...
        sb.Append("<tr><td>PT MMKSI</td></tr>")
    ...
    Private Function SendEmail(ByVal IDClass As Integer) As Integer
        ...
        Dim strSubject As String = "[MMKSI-DNet] Sales - Proses Alokasi Tambahan Training"
        Dim strTo As String = KTB.DNet.Lib.WebConfig.GetValue("EmailToClassSales")
        Dim strCC As String = KTB.DNet.Lib.WebConfig.GetValue("EmailCcClassSales")
...
#Region " control event handler "
    ...
    Private Sub dtgCourse_ItemCommand(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dtgTrClass.ItemCommand
        If (e.CommandName = "View") Then
            ...
            Response.Redirect("FrmTrClassDetailSales.aspx")
    ...
    Private Sub dtgTrClass_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgTrClass.ItemDataBound
        ...
        If Not e.Item.DataItem Is Nothing Then
            ...
            If helpers.IsView Then
                If Me.IsDealer() Then
                    If Not e.Item.FindControl("lbtnAddAllocation") Is Nothing Then
                        If Selisih > 0 AndAlso RowValue.FinishDate > Me.DateNow Then
            ...
            Else
                If Not e.Item.FindControl("lbtnAddAllocation") Is Nothing Then
                    CType(e.Item.FindControl("lbtnAddAllocation"), LinkButton).Visible = helpers.IsView
                End If
            End If
...
#End Region
        ...
        Using excelPkg As New ExcelPackage(fileInfo)
            Using ws As ExcelWorksheet = excelPkg.Workbook.Worksheets.Item(1)
                ...
                For idx As Integer = 4 To RowCount
                    ...
                    Dim TanggalMasuk As ExcelField = validasi.Create("Tanggal Masuk", idx, 15, "required,date")
                    Dim TanggalKeluar As ExcelField = validasi.Create("Tanggal Keluar", idx, 16, "required,date")
                    ...
                    If Not DataTipeClass.ContainsValue(TipeKelas.Value.ToUpper()) Then
                        listErrorfield.Add(validasi.CreateCustomError(TipeKelas, "harus berisi INHOUSE TRAINING, E-LEARNING"))
                    End If
    ...
    Private Sub GenerateReport()
        ...
        Using excelPackage As New ExcelPackage()
            ...
            rowIdx += 1
            wsData.Cells("A" & rowIdx.ToString()).ValueBold("Kategori Sales")
            rowIdx += 1
            rowIdx += 1
            ...
            For Each itemBulan As KeyValuePair(Of Integer, String) In listBulan
                ...
                For Each itemKelas As TrClass In dataBulanan
                    ...
                    clmidx += 1
                    wsData.Cells(clmidx.ExcelColumnName & rowIdx.ToString).SetValue(itemKelas.Location, Style.ExcelHorizontalAlignment.Left)
                    clmidx += 1
                    rowIdx += 1
                    noUrut += 1
