<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmTrClassDetailSales.aspx.vb" Inherits="FrmTrClassDetailSales" SmartNavigation="False" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" enctype="multipart/form-data" method="post" runat="server">
        ...
        <table id="Table99" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td style="width: 825px; height: 20px" class="titlePage" colspan="2">Training Sales&nbsp;- 
						Detail Kelas</td>
            </tr>
            <tr>
