<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmTrClassCs.aspx.vb" Inherits=".FrmTrClassCs" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" defaultbutton="btnCari" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage" style="height: 18px">Training Customer Satisfaction - Kelas</td>
            </tr>
            <tr>
