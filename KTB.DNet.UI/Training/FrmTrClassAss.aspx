<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmTrClassAss.aspx.vb" Inherits=".FrmTrClassAss" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" defaultbutton="btnCari" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage" style="height: 18px">Training After Sales - Kelas</td>
            </tr>
            <tr>
                ...
                <td valign="top" align="left">
                    ...
                    <asp:Panel ID="pnl1" runat="server">
                        <table id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0" designtimedragdrop="100">
                             <tr>
                                <td class="titleField" width="14%">Kategori Posisi</td>
                                <td width="1%">:</td>
                                <td width="39%">
                                       <asp:DropDownList ID="ddlJobPosition" runat="server"></asp:DropDownList></td>
                            ...
                            <tr>
                                ...
                                <td width="1%"></td>
                                <td width="29%">
                                    <asp:TextBox ID="txtPeriod" runat="server" Width="60px" Visible="false"></asp:TextBox></td>
                            </tr>
                            <tr>
                    ...
                    <div id="div1" style="overflow: auto; height: 360px">
                        <asp:DataGrid ID="dtgTrClass" runat="server" Width="100%" CellSpacing="1" ForeColor="Gray" PageSize="50"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Status">
                                 ...
                                 <asp:TemplateColumn HeaderText="Materi" SortExpression="FilePath">
                                    ...
                                    <ItemStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
                                    <ItemTemplate>
                                       <asp:LinkButton ID="lnkMateri" runat="server" Text="Download" CommandName="DownloadMateri" Visible="false">
                                ...
                                <asp:TemplateColumn>
                                    ...
                                    <ItemStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnAdd" runat="server" CommandName="addsiswa" CausesValidation="False" ToolTip="Pilih Siswa">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Penginapan">
                                    <HeaderStyle Width="10%" CssClass="titleTableService"></HeaderStyle>
                                    <ItemStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblUPenginapan" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
