...
Public Class FrmPendaftaranSales3
    ...
    Private Sub InitiatePage()
        ...
        If coll.Count > 0 Then
            ...
            Else
                ...
                TraineeIDColl = Request.QueryString("tcoll")
            End If
...
#Region "Event Handler"
    Private Sub dtgClassRegSuccess_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgClassRegSuccess.ItemDataBound
        If e.IsRowItems Then
            ...
            CType(e.Item.FindControl("lblSalesmanCode"), Label).Text = rowValue.TrTrainee.ListTrTraineeSalesmanHeader.FirstOrDefault(Function(x) _
    ...
    Private Sub btnSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If objRegistrationFacade.Insert(arlClassRegSuccess, arlClassRegCancel) > 0 Then
            ...
            Else
                Page.RegisterStartupScript("", "<script language=JavaScript> RedirectAfterSwitch(); </script>")
            End If
        Else
    ...
    Private Sub btnUbahAction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUbahAction.Click
        ...
        If Mode.IsNullorEmpty Then
            ...
            strUrl = "../Training/FrmPendaftaranSales2.aspx?" & _
                            "year=" & strYear & "&month=" & strMonth & "&cat=" & strCat & _
                            "&allocid=" & allocid
        Else

            strUrl = String.Format("../Training/FrmPendaftaranSales2.aspx?mode=mks&salesmanCode={0}&allocid={1}", _
                                   Request.QueryString("salesmanCode"), Request.QueryString("allocid"))
        End If
