<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmTrClassRegistration3.aspx.vb" Inherits="FrmTrClassRegistration3" smartNavigation="False"%>
	...
	<HEAD>
		...
		<script language="javascript">
			function RedirectPage()
			{
				...
				var urlDefault="../Training/FrmTrClassRegistration1.aspx";
	...
	<body MS_POSITIONING="GridLayout" onload="RedirectPage();" >
		<form id="Form2" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="740" border="0">
				<tr>
					<td class="titlePage">TRAINING - Konfirmasi Pendaftaran</td>
				</tr>
				<tr>
					...
					<TD><asp:datagrid id="dtgClassRegCancel" runat="server" Width="740px" CellSpacing="1" GridLines="Vertical"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="TrTrainee.ID" HeaderText="No. Reg Siswa">
									...
									<ItemTemplate>
										<asp:Label id="Label12" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TrTrainee.ID") %>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
				...
				<TR>
					<TD class="titleField"><asp:label id="lblRegSuccessNote" runat="server" Visible="False">Nama siswa di bawah ini akan diikutsertakan pada kelas diatas : </asp:label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD align="center"><input id="btnBack" style="FONT-WEIGHT: bold" type="button" value="Ubah" name="btnBack"
							runat="server">
