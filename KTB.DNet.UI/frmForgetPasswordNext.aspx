...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmForgetPasswordNext.aspx.vb" Inherits="frmForgetPasswordNext" smartNavigation="False" %>
...
<HTML>
	<HEAD>
        ...
        <script language="javascript">
            ...
            function func_txtTimer_visible() {
                ...
                var btnReset = document.getElementById("btnReSendOTP");
	...
	<body leftMargin="0" topMargin="0" onload="document.FormLogin.DealerTextBox.focus();f1();"">
											...
											<td align="center" background="images/login_bg.gif" colSpan="2" height="81">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td align="left" width="75%" style="padding-left:14px;"><h2><strong>Verifikasi Kata Kunci</strong></h2>
														</td>
                                                                                ...
                                                                                <td colspan="3" align="center">
                                                                                    <%--<div id="otpdiv" runat="server" visible="false">--%>
                                                                                        <table>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    <OTPPage:OTPPAGE id="OTPPage" runat="server" ActivityType="ResetPassword"></OTPPage:OTPPAGE>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    <asp:Button ID="btnReSendOTP" runat="server" Width="200px" Text="Kirim Ulang Kode OTP" CausesValidation="false"></asp:Button></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    <%--</div>--%>
                                                                                </td>
												...
												<table cellSpacing="1" width="80%" border="0">
													<tr>
														<td align="center">
															...
															<%--<asp:LinkButton id="lnkBack" runat="server" CausesValidation="False">Kembali ke Halaman Login</asp:LinkButton>--%>
														</td>
													</tr>
												</table>
											</td>
