...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents ltrBabitRegNumber As System.Web.UI.WebControls.Literal
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not IsPostBack Then
            ...
            If strIdAwal <> "" Then
                objBabitReportReceipt = New BabitReportReceiptFacade(User).Retrieve(CType(strIdAwal, Integer))
            End If
            ...
            ' set data
            MapToScreen(objBabitReportReceipt)
        End If
    End Sub

    Private Sub MapToScreen(ByVal objDomain As BabitReportReceipt)
        ...
        Dim strTujuanPembayaran As String = "Untuk Pembayaran BABIT " + objDomain.BabitReportHeader.BabitHeader.BabitRegNumber + " / " + objDomain.BabitReportHeader.BabitHeader.BabitDealerNumber

        ltrBabitRegNumber.Text = objDomain.BabitReportHeader.BabitHeader.BabitRegNumber
        ...
        ltrlDealerName.Text = objDomain.BabitReportHeader.Dealer.DealerName
        ...
        ltrlDealerPlace.Text = objDomain.BabitReportHeader.Dealer.City.CityName
        lblDealerCode.Text = objDomain.BabitReportHeader.Dealer.DealerCode & " - MMC"
        lblDealerName.Text = objDomain.BabitReportHeader.Dealer.DealerName
        'Req by Desy 17022020
        'lblTgl.Text = Date.Now.ToString("d MMMM yyyy", cultureInfo)
        lblTgl.Text = objDomain.ReceiptDate.ToString("d MMMM yyyy", cultureInfo)
        ...
        lblDateCetak.Text = "( " & objDomain.ReceiptDate.ToString("d MMMM yyyy", cultureInfo) & " )"

    End Sub

    Private Sub btnKembali_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnKembali.Click
        Dim strIdAwal As String = String.Empty
        Dim strFromScreen As String = String.Empty
        Dim objBabitReportReceipt As BabitReportReceipt
        If Not IsNothing(Request.QueryString("id")) Then
            strIdAwal = Request.QueryString("id")
        End If
        If Not IsNothing(Request.QueryString("From")) Then
            Server.Transfer("../Babit/FrmInputBabitReportReceipt.aspx?BabitReportReceiptID=" & strIdAwal & "&Mode=" & Mode & "&From=" & Request.QueryString("From").ToString())
        Else
            Server.Transfer("../Babit/FrmInputBabitReportReceipt.aspx?BabitReportReceiptID=" & strIdAwal & "&Mode=" & Mode)
        End If
    End Sub
