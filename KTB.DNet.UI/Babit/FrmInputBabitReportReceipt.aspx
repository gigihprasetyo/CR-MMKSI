<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmInputBabitReportReceipt.aspx.vb" Inherits="FrmInputBabitReportReceipt" SmartNavigation="False" MaintainScrollPositionOnPostback="true" %>

<%@ Register TagPrefix="cc1" Namespace="KTB.DNet.WebCC" Assembly="KTB.DNet.WebCC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>FrmInputBabitReportReceipt</title>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <input id="hdnBabitReportReceiptID" type="hidden" value="0" runat="server">
        <input id="hdnBabitReportHeaderID" type="hidden" value="0" runat="server">
        
        <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage" colspan="2">BABIT - INPUT KUITANSI</td>
            </tr>
            <tr>
                ...
                <td valign="top">
                    <table id="Table1" cellspacing="1" cellpadding="2" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td style="width: 2px">:</td>
                            <td>
                                <asp:Label ID="lblNoRegBabit" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table border="0">
                                    <tr>
                                        <td>
                                            <cc1:IntiCalendar ID="icFakturPajakDate" runat="server" TextBoxWidth="70"></cc1:IntiCalendar>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td style="width: 2px">:</td>
                            <td>
                               <asp:Label ID="lblTujuanPembayaran" runat="server" >Untuk Pembayaran BABIT</asp:Label></td>
                        </tr>
                        <tr>
