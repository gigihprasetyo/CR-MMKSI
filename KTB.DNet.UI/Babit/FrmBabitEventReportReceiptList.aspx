<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmBabitEventReportReceiptList.aspx.vb" Inherits=".FrmBabitEventReportReceiptList" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>FrmBabitEventReportReceiptList</title>
...
<body>
    <form id="form1" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">EVENT -&nbsp; DAFTAR KUITANSI EVENT</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left">
                    <table id="Table5" cellspacing="1" cellpadding="2" width="100%" border="0">
                        <tr>
                            <td class="titleField" width="4%">Kode Dealer</td>
                            <td width="1%">:</td>
                            <td width="34%">
                        ...
                        <tr>
                            <td class="titleField" width="4%">No. Kuitansi</td>
                            <td width="1%">:</td>
                            <td width="34%">
                        ...
                        <tr>
                            <td class="titleField" width="4%">Nama Event</td>
                            <td width="1%">:</td>
                            <td width="34%">
                        ...
                        <tr>
                            <td class="titleField" width="4%">No. Reg Event</td>
                            <td width="1%">:</td>
                            <td width="34%">
                                <asp:TextBox ID="txtNoRegEvent" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="titleField" width="4%">Status</td>
                            <td width="1%">:</td>
                            <td width="34%">
        ...
        <div id="div1" style="overflow: auto; height: 300px">
            <asp:DataGrid ID="dgListKuitansi" runat="server" Width="100%" CellSpacing="1" ForeColor="Gray" GridLines="Horizontal"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Kode Dealer" SortExpression="BabitEventReportHeader.BabitEventProposalHeader.Dealer.DealerCode">
                        <HeaderStyle ForeColor="White" Width="5%" CssClass="titleTablePromo"></HeaderStyle>
                        <ItemTemplate>
                            <asp:Label ID="lblDealerCode" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Nama Dealer" SortExpression="BabitEventReportHeader.BabitEventProposalHeader.Dealer.DealerName">
                    ...
                    <asp:TemplateColumn HeaderText="No. Reg Event" SortExpression="BabitEventReportHeader.BabitEventProposalHeader.EventRegNumber">
                        <HeaderStyle ForeColor="White" Width="6%" CssClass="titleTablePromo"></HeaderStyle>
                        <ItemTemplate>
                            <asp:Label ID="lblRegEvent" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Nama Event" SortExpression="BabitEventReportHeader.BabitEventProposalHeader.EventProposalName">
                        <HeaderStyle ForeColor="White" Width="15%" CssClass="titleTablePromo"></HeaderStyle>
                    ...
                    <asp:TemplateColumn HeaderText="No. Acc" SortExpression="MasterAccrued.AccKey">
                        <HeaderStyle ForeColor="White" Width="9%" CssClass="titleTablePromo"></HeaderStyle>
                        <ItemTemplate>
