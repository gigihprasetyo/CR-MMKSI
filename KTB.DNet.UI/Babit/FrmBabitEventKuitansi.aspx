<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmBabitEventKuitansi.aspx.vb" Inherits="FrmBabitEventKuitansi" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmBabitEventKuitansi</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 640px; POSITION: absolute; TOP: 8px; HEIGHT: 400px"
				...
				<TR>
					<TD align="left" colSpan="3"><STRONG><asp:literal id="ltrEventRegNumber" runat="server"></asp:literal></STRONG></TD>
                </TR>
				<TR>
