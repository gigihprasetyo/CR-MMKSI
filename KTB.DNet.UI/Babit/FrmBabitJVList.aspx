<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmBabitJVList.aspx.vb" Inherits=".FrmBabitJVList" %>
...
<body>
    <form id="form1" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">BABIT -&nbsp; DAFTAR PENCAIRAN BABIT</td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left">
                    <table id="Table5" cellspacing="1" cellpadding="2" width="100%" border="0">
                        ...
                        <tr>
                            <td class="titleField" width="3%">No. Dokumen</td>
                            <td width="1%">:</td>
                            <td width="34%">
