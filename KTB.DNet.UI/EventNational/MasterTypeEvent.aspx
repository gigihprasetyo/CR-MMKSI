<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MasterTypeEvent.aspx.vb" Inherits=".MasterTypeEvent" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">MASTER -&nbsp; TIPE EVENT NASIONAL</td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td align="left" style="width: 100%">
                                <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                                    <tr valign="top">
                                        <td valign="top" class="titleField" style="width: 146px">Nama Event</td>
                                        <td style="width: 2px">:</td>
                                        <td valign="top" class="titleField">
                                            <asp:TextBox ID="txtNamaEvent" runat="server" Width="178px" /></td>
                                    </tr>
                                    <tr valign="top">
                                        <td valign="top" class="titleField" style="width: 146px">Deskripsi</td>
                                        <td style="width: 2px">:</td>
                                        <td valign="top" class="titleField">
                                            <asp:TextBox ID="txtDeskripsi" runat="server" Width="178px" /></td>
                                    </tr>
                                    <tr valign="top">
        ...
        <div id="div1" style="overflow: auto; height: 300px">
            <asp:DataGrid ID="dgEventType" runat="server" Width="100%" CellSpacing="1" ForeColor="Gray" GridLines="Horizontal"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Nama Event" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                    ...
                    <asp:TemplateColumn HeaderText="Deskripsi" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
