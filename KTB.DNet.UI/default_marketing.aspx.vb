...
Public Class default_marketing
...
#Region "Private Declaration"
    Private containerPage As default_marketing
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=marketing"
#End Region
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootMarketing", 9980)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootMarketingDealer", 9980)

                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootMarketingLeasing", 9980)
...
#Region "Page Event"
    ...
    Private Sub dologout()
        LogTosyslog("user logout successfully", "logout-marketing", "success")
        Session.RemoveAll()
