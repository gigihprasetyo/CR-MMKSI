<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSAPCustomer.aspx.vb" Inherits="FrmSAPCustomer" smartNavigation="False" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			...
			{	
				showPopUp('../PopUp/PopUpVechileType.aspx','',500,760,VechileTypeSelection);				
			}
			...
			function VechileTypeSelection(SelectedVechileType)
			{
				...
				// input berupa teks box, urutan dikolom
				var VechileTypeCode = dgSAPCustomer.rows[indek].getElementsByTagName("INPUT")[5];
				// span berupa label
				///var DescArea = dgSAPCustomer.rows[indek].getElementsByTagName("SPAN")[1];
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 17px">SAP - Konsumen Prospek</td>
				</tr>
				<tr>
					...
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								...
								<TD style="HEIGHT: 21px" width="29%"><INPUT id="txtSalesmanCode" type="hidden" runat="server"></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD style="HEIGHT: 20px" noWrap><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtSalesmanID" tabIndex="14" runat="server"
										ReadOnly="True" MaxLength="50" Width="70px"></asp:textbox><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtSalesmanName" tabIndex="14" runat="server"
										ReadOnly="True" MaxLength="50" Width="130px"></asp:textbox><asp:label id="lblSearchSalesman" Runat="server">
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 11px">Periode Prospect</TD>
								<TD style="HEIGHT: 11px"><asp:label id="Label3" runat="server">:</asp:label></TD>
								<TD style="HEIGHT: 11px"><asp:label id="lblDateFrom" runat="server"></asp:label>&nbsp;s/d
									<asp:label id="lblDateUntil" runat="server"></asp:label></TD>
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 11px"></TD>
								<TD style="HEIGHT: 11px"></TD>
								<TD style="HEIGHT: 11px"><asp:button id="btnSearch" runat="server" Width="60px" Visible="False" Text="Cari"></asp:button><asp:button id="btnBatal" runat="server" Width="60px" Text="Batal" CausesValidation="False"></asp:button></TD>
								<TD class="titleField" style="HEIGHT: 11px"></TD>
								<TD style="HEIGHT: 11px"></TD>
								<TD style="HEIGHT: 11px"></TD>
							</TR>
									...
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 300px"><asp:datagrid id="dgSAPCustomer" runat="server" Width="100%" CellPadding="3" BorderWidth="0px"
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="CustomerName" HeaderText="Nama Customer">
													<HeaderStyle CssClass="titleTableRsd" Width="150px"></HeaderStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn SortExpression="CustomerAddress" HeaderText="Alamat">
												...
												<asp:TemplateColumn SortExpression="Qty" HeaderText="Qty">
													...
													<EditItemTemplate>
														<asp:TextBox ID="txtEditQty" Runat="server" MaxLength="5" onkeypress="return NumericOnlyWith(event,'')" onblur="omitCharsOnCompsTxt(this,'<>?*%$;')" text='<%# Format(DataBinder.Eval(Container, "DataItem.Qty"),"#,##0") %>'>
														</asp:TextBox>
													</EditItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn SortExpression="ProspectDate" HeaderText="Tanggal Prospect">
													...
													<FooterTemplate>
														<cc1:inticalendar id="icAddProspectDate" runat="server" TextBoxWidth="60"></cc1:inticalendar>
													</FooterTemplate>
													<EditItemTemplate>
														<cc1:inticalendar id="icEditProspectDate" runat="server" TextBoxWidth="60"></cc1:inticalendar>
													</EditItemTemplate>
												</asp:TemplateColumn>
