...
Public Class default_promotion
...
#Region "Private Declaration"
    Private containerPage As default_promotion
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=promotion"
#End Region
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootPROMO", 380)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootPROMODealer", 380)
                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootPROMOLeasing", 380)
                End If
            End If
...
#Region "Page Event"
    ...
    Private Sub dologout()
        LogTosyslog("user logout successfully", "logout-promotion", "success")
        Session.RemoveAll()
