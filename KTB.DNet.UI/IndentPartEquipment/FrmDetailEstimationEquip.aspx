				...
				<TR>
					<TD>
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								<TD colSpan="6">
									<div id="divGrid" style="WIDTH: 100%; HEIGHT: 280px; OVERFLOW: auto" DESIGNTIMEDRAGDROP="245">
										<table width="100%">
											<tr>
												<td><asp:datagrid id="dtgIPDetail" runat="server" BackColor="#CDCDCD" Width="100%" AutoGenerateColumns="False"
														...
														<Columns>
															...
															<asp:BoundColumn HeaderText="Harga Eceran" HeaderStyle-CssClass="titleTableParts" SortExpression="Harga"
																DataField="Harga" DataFormatString="{0:#,##}" ItemStyle-HorizontalAlign="Right"></asp:BoundColumn>
															<asp:TemplateColumn SortExpression="SparePartMaster.AltPartNumber" HeaderText="No Barang Alt">
																<HeaderStyle Width="25%" CssClass="titleTableParts"></HeaderStyle>
																<ItemTemplate>
																	<asp:Label id="lblAltPartNumber" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SparePartMaster.AltPartNumber") %>'>
																	</asp:Label>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:BoundColumn HeaderText="Diskon" HeaderStyle-CssClass="titleTableParts" SortExpression="Discount"
																DataField="Discount" ItemStyle-HorizontalAlign="Right"></asp:BoundColumn>
									...
									<div style="OVERFLOW: auto"><asp:button class="hideButtonOnPrint" id="btnConfirm" runat="server" Text="Konfirmasi" Visible="false"></asp:button><asp:button class="hideButtonOnPrint" id="btnUpdatePrice" runat="server" Text="Update Harga"
