			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="0">
				...
				<TR>
					...
					<TD style="WIDTH: 300px"><IMG alt="Merah" src="../images/red.gif" border="0">&nbsp;: 
						KTB belum mengalokasikan pesanan
					</TD>
				</TR>
				<TR>
					...
					<TD style="WIDTH: 300px"><IMG alt="Kuning" src="../images/yellow.gif" border="0">&nbsp;: 
						KTB baru memenuhi sebagian alokasi pesanan
					</TD>
				</TR>
				<TR>
					...
					<TD style="WIDTH: 300px" vAlign="top"><IMG alt="Hijau" src="../images/green.gif" border="0">&nbsp;: 
						KTB sudah mengalokasikan semua pesanan
					</TD>
				</TR>
				<TR>
				...
				<asp:datagrid id="dtgEquipPO" runat="server" Width="100%" AllowSorting="True" CellSpacing="1"
					...
					<Columns>
						...
						<asp:TemplateColumn>
							...
							<ItemTemplate>
								<asp:Label id="lblLastUpdated" runat="server" height="10px">
									<img style="cursor:hand" alt="History Estimasi" src="../images/popup.gif" border="0"></asp:Label>
								<asp:Label id="lblLastUpdated2" runat="server" height="10px">
									<img style="cursor:hand" alt="History Pengajuan Order" src="../images/popup.gif" border="0"></asp:Label>
								...
								<asp:LinkButton id="lbtnEdit" CausesValidation="False" CommandName="edit" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID") %>' text="Edit" Runat="server">
									<img src="../images/edit.gif" border="0" alt="Edit"></asp:LinkButton>
								<asp:LinkButton id="lbtnDetail" CausesValidation="False" CommandName="detail" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID") %>' text="Lihat" Runat="server">
									<img src="../images/detail.gif" border="0" alt="Detail"></asp:LinkButton>
								<asp:LinkButton id="lbtnPrint" CausesValidation="False" CommandName="Print" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.ID") %>' text="Print" Runat="server">
