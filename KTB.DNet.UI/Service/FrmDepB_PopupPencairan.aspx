<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDepB_PopupPencairan.aspx.vb" Inherits=".FrmDepB_PopupPencairan" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Pengajuan Deposit B</title>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">Service - Deposit B - Pengajuan Pencairan Deposit B (Detail)</td>
            </tr>
            <tr>
            ...
            <asp:DataGrid ID="dgEntryPencairanDepositA" runat="server" BorderWidth="0px" BorderColor="Gainsboro"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Jumlah Pengajuan">
                        <HeaderStyle Width="28%" CssClass="titleTableService"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                        <ItemTemplate>
                            <%--<asp:Label ID="lblJumlahPencairan" Text='<%# DataBinder.Eval(Container.DataItem, "DealerAmount","{0:#,###}") %>' runat="server">--%>
                            <asp:Label ID="lblJumlahPencairan" runat="server">
                            </asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <%--<asp:TextBox ID="txtJumlahPencairanEdit" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DealerAmount","{0:#,###}" ) %>' BackColor="White" Width="95px" MaxLength="18" onkeypress="return NumberOnly()">--%>
                            <asp:TextBox ID="txtJumlahPencairanEdit" runat="server" BackColor="White" Width="95px" MaxLength="18" onkeypress="return NumberOnly()">
                            </asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Penjelasan" Visible="true">
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="lblErrMessage" runat="server" style="color:red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="btnYes" runat="server" text="Ya" Visible="false"/>
                        <asp:Button ID="btnNo" runat="server" text="Tidak" Visible="false"/>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
