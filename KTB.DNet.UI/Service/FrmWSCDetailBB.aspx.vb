...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents dgWSCDetailBB As System.Web.UI.WebControls.DataGrid
...
#Region "Custom Variable Declaration"
    ...
    Dim WSCHead As WSCHeaderBB  '-- WSC header and its details
#End Region
...
#Region "Custom Method"
    ...
    Private Sub BindData()
        ...
        With WSCHead
            ...
            If Not IsNothing(.ChassisMasterBB) AndAlso Not IsNothing(.ChassisMasterBB.Dealer) Then
                lblSoldDealer.Text = .ChassisMasterBB.Dealer.DealerCode & " / " & .ChassisMasterBB.Dealer.DealerName
            End If
            If Not IsNothing(.ChassisMasterBB) AndAlso Not IsNothing(.ChassisMasterBB.VechileColor) Then
                lblVehicleType.Text = .ChassisMasterBB.VechileColor.MaterialNumber & " / " & .ChassisMasterBB.VechileColor.MaterialDescription
            End If
            If Not IsNothing(.ChassisMasterBB) Then
                lblChassisNumber.Text = .ChassisMasterBB.ChassisNumber
                lblEngineNumber.Text = .ChassisMasterBB.EngineNumber
                lblSerialNumber.Text = .ChassisMasterBB.SerialNumber
                If .ChassisMasterBB.DODate > _date Then
                    lblDeliveryDate.Text = IIf(Format(.ChassisMasterBB.DODate, "dd/MM/yyyy") <> "01/01/1753", Format(.ChassisMasterBB.DODate, "dd/MM/yyyy"), "")
                Else
            ...
            '-- Bind details
            dgWSCDetailBB.DataSource = WSCHead.wSCDetailBBs
            dgWSCDetailBB.DataBind()
        End With
...
#Region "EventHandler"
    ...
    Private Sub BindEvidance(ByVal _wscHead As WSCHeaderBB)
        If Not _wscHead Is Nothing Then
            Dim evidanceFacade As WSCEvidenceBBFacade = New WSCEvidenceBBFacade(User)
            ...
            criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidenceBB), "WSCHeaderBB.ID", MatchType.Exact, WSCHead.ID))
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not IsPostBack Then
            ...
            If Not IsNothing(sessHelp.GetSession("WSCHead")) Then
                ...
                WSCHead = CType(sessHelp.GetSession("WSCHead"), WSCHeaderBB)
        ...
        If Not WSCHead Is Nothing Then
            If Not WSCHead.CreatedBy.ToUpper = "WSM" Then
                btnSendEmail.Attributes("onclick") = GeneralScript.GetPopUpEventReference("../Service/FrmWSCSendEmailBB.aspx", "", 600, 600, "DummyFunction")
            Else
    ...
    Private Sub btnClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClose.Click
        Response.Redirect("FrmWSCStatusListBB.aspx")
    End Sub
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        '-- Update WSC header's change

        WSCHead = CType(sessHelp.GetSession("WSCHead"), WSCHeaderBB)  '-- Retrieve WSC header and its details
        ...
        Dim objHeader As WSCHeaderBBFacade = New WSCHeaderBBFacade(User)
    ...
    Private Sub dgWSCDetailBB_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgWSCDetailBB.ItemDataBound
        If e.Item.ItemIndex <> -1 Then
            e.Item.Cells(0).Text = e.Item.ItemIndex + 1 + (dgWSCDetailBB.CurrentPageIndex * dgWSCDetailBB.PageSize)
            Dim row As WSCDetailBB = CType(e.Item.DataItem, WSCDetailBB)
...
#End Region
    ...
    Private Sub lblPQR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblPQR.Click
        Dim objPQR As PQRHeaderBB = New PQRHeaderBBFacade(User).Retrieve(lblPQR.Text)
        If Not objPQR Is Nothing Then
            If objPQR.ID < 1 Then
                MessageBox.Show("PQR tidak ditemukan.")
            Else
                sessHelp.SetSession("PQR", objPQR)
                Server.Transfer("~/PQR/FrmPQRHeaderBB.aspx?Mode=View&Src=WSCDetailBB")
            End If
        Else
            MessageBox.Show("PQR tidak ditemukan.")
        End If
