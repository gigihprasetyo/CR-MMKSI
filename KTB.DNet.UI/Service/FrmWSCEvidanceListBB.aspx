...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmWSCEvidanceListBB.aspx.vb" Inherits="FrmWSCEvidanceListBB" smartNavigation="False" %>
	...
	<body onfocus="return checkModal()" onclick="checkModal()" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">WSC - Daftar Bukti WSC (Special)
						<BR>
					</td>
				</tr>
				<tr>
				...
				<TR>
					<TD vAlign="top">
						<div id="div1" style="Z-INDEX: 0; WIDTH: 1018px; HEIGHT: 304px; OVERFLOW: auto">
							<asp:datagrid id="dtgEvidence" runat="server" Width="100%" AllowSorting="True" AllowCustomPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn SortExpression="WSCHeaderBB.Dealer.DealerCode" HeaderText="Dealer">
										<HeaderStyle Width="20%" CssClass="titleTableService"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn Visible="False" SortExpression="WSCHeaderBB.Dealer.DealerName" HeaderText="Nama Dealer">
										<HeaderStyle Width="15%" CssClass="titleTableService"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn SortExpression="WSCHeaderBB.ClaimNumber" HeaderText="Nomor WSC">
										<HeaderStyle Width="10%" CssClass="titleTableService"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn SortExpression="WSCHeaderBB.ChassisMasterBB.ChassisNumber" HeaderText="Nomor Rangka">
										<HeaderStyle Width="10%" CssClass="titleTableService"></HeaderStyle>
									</asp:BoundColumn>
