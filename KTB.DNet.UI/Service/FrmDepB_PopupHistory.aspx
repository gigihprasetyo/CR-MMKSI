<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDepB_PopupHistory.aspx.vb" Inherits=".FrmDepB_PopupHistory" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Histori Pengajuan Deposit B</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7">Histori Pengajuan Pencairan Deposit B</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="7">
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 150px">
							<asp:datagrid id="dgHistoryPencairan" runat="server" Width="100%" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="CreatedTime" HeaderText="Diproses tanggal" SortExpression="CreatedTime" ItemStyle-HorizontalAlign="Center">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
									</asp:BoundColumn>
