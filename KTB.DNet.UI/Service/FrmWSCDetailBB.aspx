<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmWSCDetailBB.aspx.vb" Inherits="FrmWSCDetailBB" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">WSC - Rincian Status WSC (Special)</td>
				</tr>
				<tr>
						...
						<TABLE id="Table3" cellSpacing="1" cellPadding="4" width="100%" border="0">
							<TR vAlign="top">
								<TD width="40%">
									...
									<div id="div1" style="WIDTH: 300px; HEIGHT: 200px; OVERFLOW: auto"><asp:datagrid id="dgWSCDetailBB" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="#CDCDCD"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Kode">
													...
													<EditItemTemplate>
														<asp:TextBox id=TextBox2 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Code") %>'>
														</asp:TextBox>
													</EditItemTemplate>
												</asp:TemplateColumn>
												...
												<asp:TemplateColumn HeaderText="Kerja">
													<HeaderStyle Width="20%" CssClass="titleTableService"></HeaderStyle>
													<ItemTemplate>
														<asp:Label id=lblKerja runat="server" >
														</asp:Label>
													</ItemTemplate>
													<EditItemTemplate>
												...
												<asp:TemplateColumn HeaderText="Amount" >
													...
													<EditItemTemplate>
														<asp:TextBox id="lblLaborAmountEdit" runat="server" Text='<%# Format(DataBinder.Eval(Container, "DataItem.PartPrice"),"#,##0") %>'>
														</asp:TextBox>
													</EditItemTemplate>
												</asp:TemplateColumn>
											</Columns>
										...
										<tr valign="top">
											...
											<td colspan="2" valign="top">
												<table width="100%" border="0" cellpadding="2">
													...
													<TR>
														<TD class="titleField" nowrap><asp:label id="lbl24" runat="server">Barang Diterima Oleh</asp:label></TD>
														<TD><asp:label id="Label6" runat="server">:</asp:label></TD>
														<TD><asp:label id="lblPartReceiveBy" runat="server"></asp:label></TD>
													</TR>
													<TR>
														<TD class="titleField" nowrap><asp:label id="lbl25" runat="server">Tgl Terima Barang</asp:label></TD>
														<TD><asp:label id="Label7" runat="server">:</asp:label></TD>
														<TD><asp:label id="lblPartReceiveDate" runat="server"></asp:label></TD>
													</TR>
												</table>
											</td>
										</tr>
