<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmGetFreeServiceDataStatusBB.aspx.vb" Inherits="FrmGetFreeServiceDataStatusBB" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">FREE SERVICE - Daftar Status Free Service Special</td>
				</tr>
				<tr>
				...
				<TR>
					<TD vAlign="top" align="left">
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
                            ...
                            <TR>
								<TD class="titleField" style="HEIGHT: 14px" width="24%"><asp:label id="lblDealerBranch" runat="server">Kode Cabang </asp:label></TD>
								<TD style="HEIGHT: 14px" width="1%">:</TD>
								<TD style="HEIGHT: 14px" width="25%">
							...
							<TR>
                                ...
                                <td class="titleField">Tipe Visit</td>
                                <td>:</td>
                                <td>
							...
							<TR>
                                ...
                                <TD class="titleField" style="HEIGHT: 18px" vAlign="top">Nomor WO</TD>
                                <TD style="HEIGHT: 18px" vAlign="top">:</TD>
                                <TD style="HEIGHT: 18px" vAlign="top">
                                    <asp:textbox id="txtWONumber" onkeypress="return alphaNumericExcept(event,'<>?*%$;')" runat="server"
										onblur="omitSomeCharacter('txtWONumber','<>?*%$;')"></asp:textbox>
                                </TD>
							</TR>
							<TR>
								<td></td>
				...
				<TR>
					<TD vAlign="top">
						<DIV id="div1" style="HEIGHT: 280px; OVERFLOW: auto"><asp:datagrid id="dgFreeServiceBB" runat="server" Width="100%" CellSpacing="1" AllowSorting="True"
								...
								<Columns>
                                    ...
                                    <asp:TemplateColumn SortExpression="DealerBranchCode" HeaderText="Kode Cabang">
										...
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblKodeDealerBranch" runat="server" ToolTip='<%# DataBinder.Eval(Container, "DataItem.DealerBranch.DealerBranchCode")%>' Text='<%# DataBinder.Eval(Container, "DataItem.DealerBranch.DealerBranchCode")%>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="ChassisMasterBB.ChassisNumber" HeaderText="No Rangka">
										...
										<ItemStyle VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:Label id=lblNoChassis runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ChassisMasterBB.ChassisNumber") %>'>
											</asp:Label>
										</ItemTemplate>
										<FooterStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Top"></FooterStyle>
										<FooterTemplate>
									...
									<asp:TemplateColumn SortExpression="FSKind.KindCode" HeaderText="Jenis FS">
										<HeaderStyle Width="3%" CssClass="titleTableService"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblJenis" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FSKind.KindCode") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:TemplateColumn HeaderText="Kode Penolakan">
										<HeaderStyle Width="8%" CssClass="titleTableService"></HeaderStyle>
										<ItemStyle VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblAlasan" runat="server" Tooltip='<%# DataBinder.Eval(Container, "DataItem.Reason.Description") %>' Text='<%# DataBinder.Eval(Container, "DataItem.Reason.ReasonCode") %>'>
											</asp:Label>
										</ItemTemplate>
									...
									<asp:TemplateColumn Visible="False" SortExpression="Reason.Description" HeaderText="Deskripsi Alasan">
										<HeaderStyle Width="8%" CssClass="titleTableService"></HeaderStyle>
										<ItemStyle VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:Label id=lblDeskripsi runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Reason.Description") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn SortExpression="WorkOrderNumber" HeaderText="Nomor WO">
										<HeaderStyle Width="8%" CssClass="titleTableService"></HeaderStyle>
										<ItemStyle VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
