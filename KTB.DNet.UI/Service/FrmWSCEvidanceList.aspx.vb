...
Public Class FrmWSCEvidanceList
...
#Region "Custom Variable Declaration"
    ...
    Private ObjWSCEvidance As WSCEvidence
    Private ObjWSCEvidanceFacade As New WSCEvidenceFacade(User)
...
#Region "Custom Method"
    ...
    Private Sub BindToDataGrid(ByVal currentPageIndex As Integer)
        ...
        If ddlkategori.SelectedValue <> -1 Then criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "WSCHeader.ChassisMaster.Category.ID", MatchType.Exact, ddlkategori.SelectedValue))
        If ddlstatus.SelectedValue <> -1 Then criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "Status", MatchType.Exact, ddlstatus.SelectedValue))

        '--Select Criterias From TextBox
        If txtnomorwsc.Text <> "" Then criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "WSCHeader.ClaimNumber", MatchType.Exact, txtnomorwsc.Text))

        objDealer = Session("DEALER")
        If objDealer.Title = EnumDealerTittle.DealerTittle.DEALER Then
            criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "WSCHeader.Dealer.DealerCode", MatchType.InSet, DealerFacade.GenerateDealerCodeSelection(objDealer, User)))
        End If

        If txtKodeDealer.Text <> "" Then criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "WSCHeader.Dealer.DealerCode", MatchType.InSet, "('" & txtKodeDealer.Text.Replace(";", "','") & "')"))
        ...
        'criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "CreatedTime", MatchType.GreaterOrEqual, tglAwal))
        'criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "CreatedTime", MatchType.LesserOrEqual, tglAkhir))
        ...
        If ddlEvidenceType.SelectedValue <> "Pilih" Then
            criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.WSCEvidence), "EvidenceType", MatchType.Exact, ddlEvidenceType.SelectedValue))
        End If

        arlListWsc = New WSCEvidenceFacade(User).RetrieveActiveList(criterias, currentPageIndex + 1, dtgEvidence.PageSize, _
    ...
    Private Sub delete(ByVal nId As Integer)
        ...
        End If
        Dim objwschapus As WSCEvidence = New WSCEvidenceFacade(User).Retrieve(CInt(dtgEvidence.Items(nId).Cells(0).Text))
        Dim nResult = New WSCEvidenceFacade(User).DeleteFromDB(objwschapus)
    ...
    Private Sub RetriveDownload()
        ...
        arlListWscDownload = New WSCEvidenceFacade(User).Retrieve(criterias)
...
#Region "EventHandler"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            'lblKategori.Visible = isKTB
            'ddlkategori.Visible = isKTB



            'For IC As Integer = 0 To dtgEvidence.Columns.Count - 1
            '    If dtgEvidence.Columns(IC).HeaderText.ToLower() = "kategori" Then
            '        dtgEvidence.Columns(IC).Visible = isKTB
            '    End If
    ...
    Sub dtgEvidence_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles dtgEvidence.ItemDataBound
        If Not (arlListWsc Is Nothing) Then
            If Not (arlListWsc.Count = 0 Or e.Item.ItemIndex = -1) Then
                ObjWSCEvidance = CType(arlListWsc(e.Item.ItemIndex), WSCEvidence)
                ...
                e.Item.Cells(3).Text = ObjWSCEvidance.WSCHeader.Dealer.DealerCode & " / " & ObjWSCEvidance.WSCHeader.Dealer.SearchTerm1
                e.Item.Cells(4).Text = ObjWSCEvidance.WSCHeader.Dealer.DealerName
                e.Item.Cells(5).Text = ObjWSCEvidance.WSCHeader.ClaimNumber
                e.Item.Cells(6).Text = ObjWSCEvidance.WSCHeader.ChassisMaster.ChassisNumber
                e.Item.Cells(7).Text = ObjWSCEvidance.WSCHeader.ChassisMaster.Category.CategoryCode
                e.Item.Cells(8).Text = Format(ObjWSCEvidance.CreatedTime, "dd/MM/yyyy")

                If ObjWSCEvidance.CreatedBy <> String.Empty Then
                    If ObjWSCEvidance.CreatedBy.Length >= 6 Then
                        e.Item.Cells(9).Text = ObjWSCEvidance.CreatedBy.Substring(6)
                    End If
                End If
                ...
                Dim lbRepairWo As LinkButton = CType(e.Item.FindControl("lnkRepairWo"), LinkButton)
                Dim lbPartBekas As LinkButton = CType(e.Item.FindControl("lnkPartBekas"), LinkButton)
                Dim lbPhoto As LinkButton = CType(e.Item.FindControl("lnkPhoto"), LinkButton)
                lbKwitansi.Visible = False
                lbSurat.Visible = False
                lbTeknikal.Visible = False
                lbRepairWo.Visible = False
                ...
                If fileExist Then
                    Select Case ObjWSCEvidance.EvidenceType
                        ...
                        Case EnumWSCEvidenceType.WSCEvidenceType.REPAIR_WO
                            If dataFile.Substring(dataFile.Length - 4, 4).ToLower = ".jpg" Then
                                lbRepairWo.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" lowsrc='" & dataFile & "' border=""0""   onmouseout=""HideEvidenceImage(this);"" onmouseover=""ShowEvidenceImage(this);"" >  <br>"
                            Else
                                lbRepairWo.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" border=""0"" lowsrc='" & dataFile & "' onmouseover=""SetPath(this);"">  <br>"
                            End If
                            lbRepairWo.Visible = True
                        Case EnumWSCEvidenceType.WSCEvidenceType.PART_BEKAS
                            If dataFile.Substring(dataFile.Length - 4, 4).ToLower = ".jpg" Then
                                lbPartBekas.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" lowsrc='" & dataFile & "' border=""0""   onmouseout=""HideEvidenceImage(this);"" onmouseover=""ShowEvidenceImage(this);"" >  <br>"
                            Else
                                lbPartBekas.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" border=""0"" lowsrc='" & dataFile & "' onmouseover=""SetPath(this);"">  <br>"
                            End If
                            lbPartBekas.Visible = True
                        Case EnumWSCEvidenceType.WSCEvidenceType.PHOTO
                            If dataFile.Substring(dataFile.Length - 4, 4).ToLower = ".jpg" Then
                                lbPhoto.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" lowsrc='" & dataFile & "' border=""0""   onmouseout=""HideEvidenceImage(this);"" onmouseover=""ShowEvidenceImage(this);"" >  <br>"
                            Else
                                lbPhoto.Text = lbTeknikal.Text & "<img src=""../images/download.gif"" border=""0"" lowsrc='" & dataFile & "' onmouseover=""SetPath(this);"">  <br>"
                            End If
    ...
    Sub dtgEvidence_ItemCommand(ByVal sender As Object, ByVal e As DataGridCommandEventArgs) Handles dtgEvidence.ItemCommand
        ...
        Select Case (e.CommandName)
            Case "lnkKwitansi" '---"Lihat"
                ...
                Dim fileInfox As New FileInfo(KTB.DNet.Lib.WebConfig.GetValue("SAN") & fileLoc)
                ...
                If fileExist Then
                    ...
                    Try
                        ...
                        Response.Redirect("../Download.aspx?file=" & fileLoc)
                    Catch ex As Exception
    ...
    Private Sub ChangeStatus()
        ...
        For Each item As WSCEvidence In arlListWscDownload
    ...
    Private Sub btnDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDownload.Click
        ...
        Try
            RetriveDownload()
            ChangeStatus()
            Dim str As FileInfo = _fileHelper.TransferWSCtoSAP(arlListWscDownload, fileInfo1)
            txtDownload.Text = KTB.DNet.Lib.WebConfig.GetValue("WSCEvidenceFileDirectory").ToString & "\" & str.Name
            BindToDataGrid(dtgEvidence.CurrentPageIndex)
        Catch ex As Exception
