<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmWSCSendEmail.aspx.vb" Inherits="FrmWSCSendEmail" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Permintaan Kirim Bukti WSC</title>
				...
				<tr>
					<td colSpan="3">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage">WSC -&nbsp; Daftar Permintaan Bukti WSC</td>
							</tr>
							<tr>
				...
				<TR vAlign="top">
					...
					<TD valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td valign="top">
									<div id="div1" style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 280px"><asp:datagrid id="dtgSendEmail" runat="server" Width="100%" AutoGenerateColumns="False" align="right"
