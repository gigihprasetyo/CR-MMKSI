<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDepB_KuitansiPrint.aspx.vb" Inherits=".FrmDepB_KuitansiPrint" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Kuitansi Deposit B</title>
				...
				<TR>
					<TD style="WIDTH: 147px; HEIGHT: 116px">
						<TABLE id="Table3" style="WIDTH: 216px; HEIGHT: 48px" cellSpacing="1" cellPadding="1" width="216"
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:Image ID="BarcodeImage" runat="server" Width="250" Height="100" />
                                </td>
                            </tr>
							<TR>
								<TD vAlign="top"><asp:label id="lblInterest" runat="server" Visible="False">Bunga</asp:label>
								</TD>
								<td>
									<asp:label id="lblTitikInterest" runat="server" Visible="False">:</asp:label>
								</td>
								<td>
									<asp:literal id="ltrlInterest" runat="server" Visible="False"></asp:literal><br>
								</td>
							</TR>
							<TR>
								<TD><asp:label id="lblTax" runat="server" Visible="False">Tax (15%) </asp:label>&nbsp;
								</TD>
								<td>
									<asp:label id="lblTitikTax" runat="server" Visible="False">:</asp:label>
								</td>
								<td>
									<asp:literal id="ltrlTax" runat="server" Visible="False"></asp:literal>
								</td>
							</TR>
							<TR>
								<TD><asp:label id="lblTotal" runat="server">Total </asp:label>
								</TD>
								<td>
									<asp:label id="Label3" runat="server">:</asp:label>&nbsp;
								</td>
								<td>
									<asp:literal id="ltrlTotalHarga" runat="server"></asp:literal><br>
								</td>
							</TR>
						</TABLE>
					</TD>
					<TD style="WIDTH: 6px; HEIGHT: 116px">
					</TD>
					<TD style="HEIGHT: 116px" vAlign="top" align="center"><asp:literal id="ltrlDealerPlace" Runat="server"></asp:literal>,
