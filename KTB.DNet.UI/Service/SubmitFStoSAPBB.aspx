<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SubmitFStoSAPBB.aspx.vb" Inherits="SubmitFStoSAPBB" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 19px">FREE SERVICE - Transfer Free Service 
						Special ke SAP</td>
				</tr>
				<tr>
