...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmWSCUpload.aspx.vb" Inherits="FrmWSCUpload" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">WSC - Upload WSC</td>
				</tr>
				<tr>
				...
				<TR>
					<TD valign="top"><div id="div1" style="OVERFLOW: auto; HEIGHT: 370px"><asp:datagrid id="dtgWSC" runat="server" Width="100%" AutoGenerateColumns="False" BorderColor="#CDCDCD"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="ClaimType" HeaderText="Jenis WSC">
										...
										<ItemTemplate>
											<asp:Label id="lblClaimType" runat="server" Text='<%# CType(Container.DataItem, WSCHeader).ClaimType %>'>Label</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="ClaimNumber" HeaderText="Nomor WSC">
										...
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblClaimNumber" runat="server" Text='<%# CType(Container.DataItem, WSCHeader).ClaimNumber %>'>Label</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="ChassisMaster.ChassisNumber" HeaderText="Nomor Rangka">
										<HeaderStyle Width="15%" CssClass="titleTableService"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id="lblChassisNumber" runat="server" Text='<%# IIf(IsNothing(Databinder.Eval(Container,"DataItem.ChassisMaster")), String.Empty, Databinder.Eval(Container,"DataItem.ChassisMaster.ChassisNumber")) %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="ServiceDate" HeaderText="Tgl Service">
										...
										<ItemTemplate>
											<asp:Label id="lblServiceDate" runat="server" Text='<%# CType(Container.DataItem, WSCHeader).StringServiceDate %>'>Label</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Miliage" HeaderText="Jarak Tempuh">
										...
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblMileage" runat="server" Text='<%# String.Format("{0:#,###}", CType(Container.DataItem, WSCHeader).Miliage) %>'>Label</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="EvidenceInvoice" HeaderText="Kuitansi">
										...
										<ItemTemplate>
											<asp:CheckBox id="chkIsKuitansi" runat="server" Checked = '<%# CType(Container.DataItem, WSCHeader).EvidenceInvoice = "X" %>'>
											</asp:CheckBox>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="EvidencePhoto" HeaderText="Foto">
										...
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:CheckBox id="chkIsPhoto" runat="server" Checked = '<%# CType(Container.DataItem, WSCHeader).EvidencePhoto = "X" %>'>
											</asp:CheckBox>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="EvidenceDmgPart" HeaderText="Part">
										...
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:CheckBox id="chkIsDgmPart" runat="server" Checked = '<%# CType(Container.DataItem, WSCHeader).EvidenceDmgPart = "X" %>'>
											</asp:CheckBox>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="Error Message">
										<HeaderStyle Width="15%" CssClass="titleTableService"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id=lblErrorMessage runat="server" Text='<%# CType(Container.DataItem, WSCHeader).ErrorMessage %>' ForeColor="#ff0000">Label</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
