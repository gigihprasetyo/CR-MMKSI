...
Public Class FrmWSCHeaderPrintBarcode
...
#End Region
    ...
    Private Sub btnKembali_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnKembali.Click
        GetRequestString()
        Server.Transfer("../Service/FrmWSCHeader.aspx?viewStateMode=" & intViewStateMode & "&screenFrom=" & screenFrom & "&PQRId=" & pqrId & "&WSCId=" & wscId)
    End Sub
    ...
    Private Function RetriveArrayBarcode(ByVal startIndexRow As Integer, ByRef _arrBarcode As ArrayList)
        ...
        For index = startIndexRow To strIdTmp.Length - 1
            ...
            If strIdAwal <> "" Then
                objParts = New WSCDetailFacade(User).Retrieve(CType(strIdAwal, Integer))
                strKodeBarcode = objParts.WSCHeader.Dealer.DealerCode & strClaimNumber & Replace(objParts.SparePartMaster.PartNumber, "-", " ")
