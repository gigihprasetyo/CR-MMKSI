<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDepB_InterestList.aspx.vb" Inherits=".FrmDepB_InterestList" %>
...
<html>
<head>
    <title>Daftar Interest Deposit B</title>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">Service - Deposit B - Daftar Interest</td>
            </tr>
            <tr>
                ...
                <td>
                    <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="titleField" style="width: 146px; visibility: hidden">Status</td>
                            <td style="width: 2px; visibility: hidden">:</td>
            ...
            <tr>
                <td align="center"valign="center">
                    <div style="width: 60%; border-style: solid; border-color: red">
                        <asp:Label ID="lblInfo" ForeColor="Blue" Font-Bold="true" runat="server"
                            Text="Nilai Interest Deposit B yang tercantum pada modul ini, tidak perlu dibuatkan dan dikirimkan kuitansi kembali oleh Dealer,<br/> dan akan otomatis ditransfer ke Deposit B Dealer masing-masing per 3 bulan">
                        </asp:Label>
                    </div>
                </td>
            </tr>
