<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPositionCode.aspx.vb" Inherits="FrmPositionCode"  smartNavigation="False" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 16px">WSC - Deskripsi Kode Posisi</td>
				</tr>
				<tr>
						...
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
							<TR>
								...
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtKode" onblur="HtmlCharBlur(txtKode)"
										runat="server" MaxLength="50"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="rfvKode" runat="server" EnableClientScript="False" Width="16px" InitialValue=" "
							...
							<TR>
								...
								<td><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtDeskripsi" onblur="HtmlCharBlur(txtDeskripsi)"
										Width="300px" runat="server" MaxLength="100"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="rfvDeskripsi" runat="server" EnableClientScript="False" Width="11px" ControlToValidate="txtDeskripsi"
					...
					<TD>
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgModel" runat="server" Width="100%" AllowSorting="True" BorderColor="#E0E0E0"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="KodePosition" HeaderText="Kode">
										<HeaderStyle Width="20%" CssClass="titleTableService"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id=lblKode runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KodePosition") %>'>
											</asp:Label>
										</ItemTemplate>
										<EditItemTemplate>
											<asp:TextBox id=TextBox3 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KodePosition") %>'>
											</asp:TextBox>
										</EditItemTemplate>
									</asp:TemplateColumn>
