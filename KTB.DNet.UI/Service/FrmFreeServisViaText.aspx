<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmFreeServisViaText.aspx.vb" Inherits="FrmFreeServisViaText" smartNavigation="False"%>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top" align="left">
                        <asp:Label ID="lblKeterangan" runat="server" Text="Kendaraan PKT sebelum September, validasi dari 
                                    tanggal faktur. Kendaraan PKT September, validasi dari tanggal PKT" ForeColor="Red"></asp:Label>
					</TD>
				</TR>
				<TR>
					<TD vAlign="top">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 380px"><asp:datagrid id="dgFreeServisUpload" runat="server" Width="100%" AutoGenerateColumns="False"
								...
								<Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="WO Number">
										...
										<ItemStyle HorizontalAlign="Left"></ItemStyle>
										<ItemTemplate>
											<asp:Label id=lblWONumber runat="server" Width="120px" Text='<%# DataBinder.Eval(Container, "DataItem.WorkOrderNumber") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>									
