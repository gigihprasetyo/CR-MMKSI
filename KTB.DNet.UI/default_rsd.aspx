...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default_rsd.aspx.vb" Inherits="default_rsd" SmartNavigation="False" %>
                                ...
                                <table height="74" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="153" height="30">
                                            <img src="images/04rsd_r1_c1.gif"></td>
                                        <td width="163" height="30">
                                            <img src="images/04rsd_r1_c2.gif"></td>
                                        <td width="152" height="30" background="images/04rsd_r1_c3_bg.gif">
                                            <img src="images/04rsd_r1_c3_bg.gif"></td>
                                        <td width="115" height="30" background="images/04rsd_r1_c3_bg.gif">
                                            <img src="images/04rsd_r1_c3_bg.gif"></td>
                                        <td width="442" height="30" align="left">
                                            <img src="images/04rsd_r1_c4.gif"></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="images/rsd_r2_c1.jpg"></td>
                                        <td>
                                            <img src="images/rsd_r2_c2.jpg"></td>
                                        <td>
                                            <img src="images/rsd_r2_c3.jpg"></td>
                                        ...
                                        <td background="images/04mrk_r3_c3_bg.gif" height="53">
                                            <table width="740" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="menuHor2">
                                                        <asp:LinkButton class="menuHor2" ID="RsdLinkButton" runat="server">SFD</asp:LinkButton></td>
