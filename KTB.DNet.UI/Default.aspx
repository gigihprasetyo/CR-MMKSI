...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="_Default" SmartNavigation="False" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>PT Mitsubishi Motors Krama Yudha Sales Indonesia - Sales</title>
...
<body bottommargin="0" leftmargin="0" topmargin="0" onload="updateClock(); setInterval('updateClock()', 1000 );pageLoad();"
    ...
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                <td valign="top" height="90">
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td height="74">
                                <table height="74" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td width="153" height="30">
                                            <img src="images/04sales_r1_c1.gif"></td>
                                        <td width="163" height="30">
                                            <img src="images/04sales_r1_c2.gif"></td>
                                        <td width="152" background="images/04sales_r1_c3_bg.gif" height="30">
                                            <img src="images/04sales_r1_c3_bg.gif"></td>
                                        <td width="115" background="images/04sales_r1_c3_bg.gif" height="30">
                                            <img src="images/04sales_r1_c3_bg.gif"></td>
                                        <td align="left" width="442" height="30">
                                            <img src="images/04sales_r1_c4.gif" border="0"></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="images/04sales_r2_c1.gif"></td>
                                        <td>
                                            <img src="images/04sales_r2_c2.gif"></td>
                                        <td>
                                            <img src="images/04sales_r2_c3.gif"></td>
                            ...
                            <td>
                                <table height="53" cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td align="right" width="42" background="images/04mrk_r3_c2.gif" height="53">
                                            <img height="53" src="images/04mrk_r3_c2.gif" width="42" border="0"></td>
                                        <td background="images/04mrk_r3_c3_bg.gif" height="53">
                                            <table cellspacing="0" cellpadding="0" width="740" border="0">
                                                <tr>
                                                    ...
                                                    <td class="menuHor">
                                                        <asp:LinkButton class="menuHor2" ID="SalesLinkButton" runat="server" Enabled="False">
                                            ...
                                            <table height="50" cellspacing="6" cellpadding="0" width="191" align="center" border="0">
                                                <tr>
                                                    <td height="50">Selamat Datang,&nbsp;
                                                        ...
                                                        <asp:Label ID="LabelDealer" runat="server" Font-Bold="True"></asp:Label><asp:Label ID="lblTokenText" runat="server" Font-Bold="True">
																<br />
																<br />
																<b>Token Anda valid sampai</b></asp:Label><br>
                                                        <asp:Label ID="lblValidUntil" runat="server" Font-Bold="True"></asp:Label><asp:Panel ID="pnlEmailValidator" runat="server">
                                                            <br>
                                                        </asp:Panel>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <div id="div1" style="height: 380px; overflow: auto">
                                                            <cc1:treemenu id="MyMenu" runat="server" ScreenId="1100" XMLPath="TreeMenu.XML.PathFromRootFU"></cc1:treemenu>
                                                        </div>
        ...
        <!--
			<asp:TextBox Runat="server" ID="txtLastLoginTime" Text="" style="DISPLAY:none"></asp:TextBox>
			-->
    </form>
    <script language="javascript">
        ...
        function pageLoad() {
            ...
            // window.setInterval(sendCheckDuplicate, 5000);
        }
    </script>
</body>
</html>
