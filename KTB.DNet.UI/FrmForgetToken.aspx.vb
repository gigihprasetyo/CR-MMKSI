...
#Region "EventHandler"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim objUsIn As New UserInfo

            objUsIn = CType(sessHelp.GetSession("LOGINUSERINFO"), UserInfo)

            DealerTextBox.Text = objUsIn.Dealer.DealerCode
            NameTextBox.Text = objUsIn.UserName
        Else
            If CType(ViewState("vsProcess"), String) = "False" Then
                ...
                If objUserInfo IsNot Nothing And objUserInfo.ID > 0 Then
        ...
        If (Not objUserInfo Is Nothing) AndAlso (objUserInfo.ID > 0) Then '-- User is registered
            If Not objUserInfo.UserProfile Is Nothing Then  '-- User has profile
                ...
                If Not String.IsNullOrEmpty(objUserInfo.HandPhone) Then
                    ...
                    ViewState("PhoneNumber") = lblPhoneNo.Text.Trim
                Else
            ...
            Else  '-- User without profile
                ...
                Catch ex As Exception
                    strHeader = "D-NET"
                End Try
                MessageBox.Show("Silahkan Login ke " & strHeader & " , lalu isilah nomor HP Anda pada Halaman Sekuriti, sebab Kata Kunci yang baru akan dikirimkan ke HP Anda.")
            End If
    ...
    End Sub
    Private Sub btnReSendOTP_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        Dim otpfunc As New OTPFunction
