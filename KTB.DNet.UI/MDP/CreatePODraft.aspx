<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreatePODraft.aspx.vb" Inherits=".CreatePODraft" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html>
<head runat="server">
    <title>CreatePODraft</title>
    ...
    <script type="text/javascript">
        ...
        function ShowAlert() {
            alert('Anda tidak bisa edit data ini');
        }
    </script>
</head>
                        ...
                        <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                            <tr>
                                <td class="titleField" width="24%">
                                    <asp:Label ID="Label1" runat="server">Kode Dealer</asp:Label>
                                    <asp:TextBox ID="txtID" Style="display: none" runat="server" Width="24px"></asp:TextBox>
                                </td>
                                <td width="1%">:</td>
                                <td width="25%">
                            ...
                            <tr>
                                <td class="titleField">
                                    <asp:Label ID="Label3" runat="server">Permintaan Kirim</asp:Label></td>
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblPermintaanKirim" runat="server"></asp:Label></td>
                                <td class="titleField" style="width: 149px"></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td class="titleField" style="height: 18px">
                                    <asp:Label ID="Label7" runat="server"> Nomor O/C</asp:Label>
                                </td>
                                <td style="height: 18px">:</td>
                                <td style="height: 18px">
                                    <asp:DropDownList ID="ddlContractNumber" runat="server" AutoPostBack="True"></asp:DropDownList>
                                </td>

                                <td class="titleField" style="width: 149px; height: 18px">
                                    <asp:Label ID="Order" runat="server">Jenis O/C</asp:Label>
                                </td>
                                <td style="height: 18px">:</td>
                                <td style="height: 18px">
                            ...
                            <tr>
                                <td class="titleField">
                                    <asp:Label ID="Label6" runat="server">Nomor Draft PO</asp:Label></td>
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblNomorDraftPO" runat="server">[Automatically Generated By System]</asp:Label>
                                </td>
                                <td class="titleField" style="width: 149px">
                                    <asp:Label ID="Label8" runat="server"> Kategori</asp:Label>
                                </td>
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblSalesOrg" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="titleField">
                                    <asp:Label ID="Label14" runat="server">Nomor PO</asp:Label></td>
                                <td>:</td>
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Nomor PO Harus Diisi"
                                        ControlToValidate="txtDealerPONumber" EnableClientScript="False">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="titleField" style="width: 149px">
                                    <asp:Label ID="Label11" runat="server">Tahun Perakitan/Impor</asp:Label>
                                </td>
                                <td>:</td>
                                <td>
                                    <asp:Label ID="lblTahunPerakitan" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="titleField">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="chkFactoring" runat="server" Width="16px" AutoPostBack="True" Text=" " Enabled="False"></asp:CheckBox>
                                </td>
                                <td class="titleField" style="width: 149px">
                                ...
                                <td>&nbsp;
										...
										<asp:Label ID="lblTotalBiayaKirimValue" runat="server" Font-Bold="True">0</asp:Label>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div id="div1" style="height: 250px; overflow: auto">
                            <asp:DataGrid ID="dtgDetail" runat="server" Width="100%" AutoGenerateColumns="False" OnItemDataBound="dtgDetail_ItemDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Sisa stock hari ini">
                                        <HeaderStyle ForeColor="White" Width="8%" CssClass="titleTableSales"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSisaQty" runat="server" Text="Label"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
