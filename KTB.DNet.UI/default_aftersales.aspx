...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default_aftersales.aspx.vb" Inherits="default_aftersales" SmartNavigation="False" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>PT Mitsubishi Motors Krama Yudha Sales Indonesia - After Sales</title>
                                        ...
                                        <td background="images/04mrk_r3_c3_bg.gif" height="53">
                                            <table width="740" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="menuHor">
                                                        <asp:LinkButton class="menuHor2" ID="AfterSalesLinkButton" runat="server" Enabled="True" Width="68px"><b>After Sales</b></asp:LinkButton></td>
