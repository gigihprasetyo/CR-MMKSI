<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmKategoriDiskon.aspx.vb" Inherits="FrmKategoriDiskon" smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmKategoriDiskon</title>
				...
				<TR>
					<TD vAlign="top" align="left">
                        <table width="100%">
                            ...
                            <tr align="center">
								<td colspan="2"><asp:button id="btnSimpan" runat="server" Width="60px" Text="Simpan"></asp:button>&nbsp;<asp:button id="btnBatal" runat="server" Width="60px" Text="Batal" CausesValidation="False"></asp:button>&nbsp;
					...
					<TD>
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgDiscountMaster" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="None"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="Code" SortExpression="Category" HeaderText="Kode">
