<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSalesmanPartEntryResign.aspx.vb" Inherits="FrmSalesmanPartEntryResign" smartNavigation="False" %>
	...
	<HEAD>
		...
		<script language="javascript">
			...
			{	
				...
				showPopUp('../PopUp/PopUpSalesmanPart.aspx?IsGroupDealer=0&IsSales=0&IsResign=0','',470,600,SalesmanSelection);
			}
			...
			function SalesmanSelection(SelectedSalesman)
			{
				...
				lblCategory.innerHTML = tempParam[2];
				lblPosition.innerHTML = tempParam[3];
			}
					...
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								...
								<TD class="titleField" style="HEIGHT: 24px"><asp:button id="btnSimpan" runat="server" Width="60px" Text="Simpan"></asp:button><asp:button id="btnBatal" runat="server" Width="60px" Text="Batal" CausesValidation="False"></asp:button>
									<asp:Button id="btnBack" runat="server" Text="Kembali"></asp:Button></TD>
								<TD class="titleField" style="HEIGHT: 24px"></TD>
								<TD style="HEIGHT: 24px"></TD>
							</TR>
							<TR>
								<TD class="titleField" colSpan="6"><div id="div1" style="OVERFLOW: auto; HEIGHT: 250px"><asp:datagrid id="dgSalesmanHeader" runat="server" Width="100%" CellPadding="3" BorderWidth="0px"
