<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSalesmanRegister.aspx.vb" Inherits="FrmSalesmanRegister" smartNavigation="False"%>
					...
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								...
								<TD style="HEIGHT: 20px" noWrap width="25%"><asp:dropdownlist id="ddlStatus" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
											...
											<Columns>
												...
												<asp:TemplateColumn>
													...
													<ItemTemplate>
                                                        ...
                                                        <%--<asp:LinkButton id="lbtnPreview" runat="server" Width="20px" Text="Hapus" CausesValidation="False"
															CommandName="Delete">
															<img src="../images/trash.gif" border="0" alt="Hapus"></asp:LinkButton>--%>
													</ItemTemplate>
												</asp:TemplateColumn>
