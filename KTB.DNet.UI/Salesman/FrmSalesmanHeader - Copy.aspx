				...
				<TR>
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								<TD class="titleField" width="250">Nama</TD>
								<TD width="102">:</TD>
								<TD noWrap width="263"><asp:textbox onkeypress="TxtKeypress();" id="txtName" onblur="TxtBlur('txtName');" tabIndex="4"
									...
									<table cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<td style="WIDTH: 117px"><asp:textbox onkeypress="TxtKeypress();" id="txtPlaceOfBirth" onblur="TxtBlur('txtPlaceOfBirth');"
													tabIndex="5" runat="server" MaxLength="60" Width="110px"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ErrorMessage="Tempat Lahir Harus diisi"
													ControlToValidate="txtPlaceOfBirth">*</asp:requiredfieldvalidator><asp:label id="lblPlaceOfBirth" runat="server"></asp:label></td>
						...
						<INPUT id="hdnVal" type="hidden" name="hdnVal" runat="server"> <INPUT id="IsInsertSuccess" type="hidden" name="IsInsertSuccess" runat="server">
					</TD>
				</TR>
			</TABLE>
		</form>
