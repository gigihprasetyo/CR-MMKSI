<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSalesmanPartTargetList.aspx.vb" Inherits="FrmSalesmanPartTargetList" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage"><asp:label id="lblPageTitle" runat="server">PART EMPLOYEE - Daftar Sales Target & Realisasi</asp:label></td>
				</tr>
				<tr>
									...
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 240px"><asp:datagrid id="dgSalesmanTarget" runat="server" Width="100%" CellPadding="3" BackColor="#CDCDCD"
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="SalesmanHeader.SalesmanCode" HeaderText="Kode">
													...
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SalesmanHeader.SalesmanCode") %>' ID="Label1"></asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												...
												<asp:TemplateColumn SortExpression="Target" HeaderText="Target">
													<HeaderStyle Width="10%"  CssClass="titleTableParts"></HeaderStyle>
												...
												<asp:TemplateColumn SortExpression="Realization" HeaderText="Realisasi">
													<HeaderStyle Width="10%"  CssClass="titleTableParts"></HeaderStyle>
													<ItemStyle HorizontalAlign="Right"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn SortExpression="Persentage" HeaderText="Persentase">
													<HeaderStyle Width="8%"  CssClass="titleTableParts"></HeaderStyle>
													<ItemStyle HorizontalAlign="Right"></ItemStyle>
													<ItemTemplate>
