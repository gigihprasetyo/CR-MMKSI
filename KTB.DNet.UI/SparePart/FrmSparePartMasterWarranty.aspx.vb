...
Public Class FrmSparePartMasterWarranty
    ...
    Private Sub BindDtgSparePartAlt()
        arrSparePartAlt = New SparePartMasterFacade(User).RetrieveWithOneCriteriaWarranty(1, dtgSparePartAlt.PageSize, 0, "AltPartNumber", MatchType.Exact, ViewState("NoSparePartAlt"), CType(ViewState("currSortColumn"), String), CType(ViewState("currSortDirection"), Sort.SortDirection))
    ...
    Private Sub BindDtgSparePartAlt(ByVal pageIndex As Integer)
        Try
            ...
            If (pageIndex >= 0) Then
                ...
                'dtgSparePartAlt.DataSource = arrSparePartAlt
                arrSparePartAlt = New SparePartMasterFacade(User).RetrieveWithOneCriteriaWarranty(pageIndex, dtgSparePartAlt.PageSize, totalRow, "AltPartNumber", MatchType.Exact, ViewState("NoSparePartAlt"), CType(ViewState("currSortColumn"), String), CType(ViewState("currSortDirection"), Sort.SortDirection))
                dtgSparePartAlt.DataSource = arrSparePartAlt
