<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmBlockMaterial.aspx.vb" Inherits="FrmBlockMaterial"  smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">MASTER BARANG - Setting Blok Material</td>
				</tr>
				<tr>
				...
				<TR>
					<TD vAlign="top" align="left">
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								<TD class="titleField" width="24%" style="HEIGHT: 28px">
									Kode</TD>
								<TD width="1%" style="HEIGHT: 28px">:</TD>
								<td width="75%" style="HEIGHT: 28px"><asp:textbox onkeypress="return HtmlCharUniv(event)" id="txtKodeArea" onblur="HtmlCharBlur(txtKodeArea)"
										runat="server" MaxLength="10" Width="130px"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ControlToValidate="txtKodeArea" ErrorMessage="*"></asp:requiredfieldvalidator>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</TR>
							<TR>
								<TD class="titleField">
									Deskripsi</TD>
				...
				<TR>
					<TD vAlign="top">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 370px"><asp:datagrid id="dtgArea" runat="server" Width="100%" CellSpacing="1" PageSize="25" AllowSorting="True"
