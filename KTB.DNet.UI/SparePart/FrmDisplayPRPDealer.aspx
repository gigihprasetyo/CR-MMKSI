<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmDisplayPRPDealer.aspx.vb" Inherits="KTB.DNet.UI.SparePart.FrmDisplayPRPDealer" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmDisplayPRPDealer</title>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 8px">PARTSHOP REWARD 
						PROGRAM&nbsp;-&nbsp;Daftar PRP PerDealer</td>
				</tr>
				<tr>
				...
				<TR>
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								<TD class="titleField" width="183" style="WIDTH: 183px">Kode Dealer</TD>
								<TD width="2">:</TD>
							...
							<TR>
								<TD vAlign="top" colSpan="3"><asp:button id="btnBack" runat="server" Text="Kembali" Width="72px"></asp:button><asp:button id="btnDownload" text="Download" runat="server"></asp:button></TD>
							</TR>
						</TABLE>
						<TABLE id="Table3" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								<TD vAlign="top" colSpan="3">
									<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 480px"><asp:datagrid id="dtgExcel" runat="server" Width="1565px" AllowSorting="True" CellPadding="3"
											BorderWidth="0px" CellSpacing="1" BorderColor="Gainsboro" BackColor="#CDCDCD" AutoGenerateColumns="False" AllowPaging="True" PageSize="50"
											ShowFooter="True">
											...
											<Columns>
												...
												<asp:BoundColumn Visible="False" DataField="DealerCode" SortExpression="DealerCode" HeaderText="Kode Dealer">
												...
												<asp:BoundColumn DataField="Jan" SortExpression="Jan" HeaderText="Januari" DataFormatString="{0:#,###}">
													...
													<FooterStyle HorizontalAlign="Right" ForeColor="White"></FooterStyle>
												</asp:BoundColumn>
