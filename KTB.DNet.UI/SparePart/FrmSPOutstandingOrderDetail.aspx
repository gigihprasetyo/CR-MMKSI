...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSPOutstandingOrderDetail.aspx.vb" Inherits="FrmSPOutstandingOrderDetail" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>OUTSTANDING ORDER DETAIL</title>
			...
			<TABLE id="Table2" cellSpacing="4" cellPadding="0" width="100%" border="0">
				<tr>
					<td height="20">
						...
						<TR>
							<TD class=titlePage>PEMESANAN - Rincian Outstanding Order </TD></TR>
						<tr>
				...
				<TR>
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							<TR>
								<TD class="titleField"><asp:label id="Label4" runat="server">Tipe Dokumen</asp:label></TD>
								<TD><asp:label id="Label5" runat="server">:</asp:label></TD>
								<TD><asp:label id="lblDocumentType" runat="server"></asp:label></TD>
							...
							<TR>
								<TD class="titleField"><asp:label id="Label9" runat="server">Cara Pembayaran</asp:label></TD>
				...
				<TR>
					<TD align=center> <div id=div1 style="OVERFLOW: auto; HEIGHT: 250px"><asp:datagrid id="dgEstimateDetail" runat="server" Width="100%" AutoGenerateColumns="False" BorderWidth="0px"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Nilai Sudah Dialokasi (Rp)">
									<HeaderStyle Width="9%" CssClass="titleTableParts"></HeaderStyle>
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
										<asp:Label id=lblPrice runat="server" Text='<%# String.Format("{0:#,##0}", CType(Container.DataItem, SparePartOutstandingOrderDetail).AllocationAmount)%>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Nilai Belum Dialokasi (Rp)">
									<HeaderStyle Width="9%" CssClass="titleTableParts"></HeaderStyle>
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
										<asp:Label id=lblTotal runat="server" Text='<%# String.Format("{0:#,##0}", CType(Container.DataItem, SparePartOutstandingOrderDetail).OpenAmount)%>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:BoundColumn DataField="SubtitutePartNumber" HeaderText="Nomor Pengganti">
