<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPartIncidentalUser.aspx.vb" Inherits="FrmPartIncidentalUser" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmPartIncidentalUser</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">PERMINTAAN KHUSUS - Daftar Penerima Email
					</td>
				</tr>
				<tr>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<td style="HEIGHT: 24px">
									<P><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtEmail)" id="txtEmail"
											...
											ValidationExpression="\w+([-+.]\w+)*@ktb.co.id"></asp:regularexpressionvalidator>
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 24px">Jabatan</TD>
								<TD style="HEIGHT: 24px">:</TD>
								<TD style="HEIGHT: 24px">
									<asp:TextBox id="txtPositionCC" runat="server" Width="288px"></asp:TextBox></TD>
							</TR>
							<TR>
				...
				<TR>
					<TD vAlign="top">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 380px"><asp:datagrid id="dtgPIUser" runat="server" Width="100%" Font-Names="MS Reference Sans Serif"
