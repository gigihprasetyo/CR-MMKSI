...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPartShopList.aspx.vb" Inherits="FrmPartShopList" smartNavigation="False" %>
	...
	<HEAD>
		...
		<script language="javascript">
			...
			function checkCharSpaceOrSlashOnfront(txt, e) {
			    if (txt.value.substr(0, 1) == ' ' || txt.value.substr(0, 1) == '/' || txt.value.substr(0, 1) == '-') {
			        if (e.keyCode == 32 || e.keyCode == 191 || e.keyCode == 189)
			        {
			            txt.value = txt.value.substr(1, txt.value.length);
			        }
                }
			}
					...
					<TD align="left">
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<TD style="HEIGHT: 17px" width="1%">:</TD>
								<TD width="79%"><asp:textbox id="txtName" runat="server" Width="250px"></asp:textbox><asp:requiredfieldvalidator id="valName" runat="server" ErrorMessage="Nama Harus diisi" ControlToValidate="txtName">*</asp:requiredfieldvalidator></TD>
							</TR>
							<TR>
								<TD class="titleField" width="20%">Alamat</TD>
								<TD style="HEIGHT: 17px" width="1%">:</TD>
								<TD width="79%"><asp:textbox id="txtAddress" runat="server" Width="450px" Rows="2"></asp:textbox><asp:requiredfieldvalidator id="valAddress" runat="server" ErrorMessage="Alamat Harus diisi" ControlToValidate="txtAddress">*</asp:requiredfieldvalidator></TD>
							</TR>
							<TR>
								...
								<TD><asp:dropdownlist id="ddlProvince" runat="server" AutoPostBack="True"></asp:dropdownlist>
                                    ...
                                    <asp:dropdownlist id="ddlCityPart" runat="server"></asp:dropdownlist>
                                    <asp:requiredfieldvalidator id="valProvince" runat="server" ErrorMessage="Propinsi Harus dipilih" ControlToValidate="ddlProvince">*</asp:requiredfieldvalidator>
                                    <asp:requiredfieldvalidator id="valCity" runat="server" ErrorMessage="Kota Harus dipilih" ControlToValidate="ddlCity">*</asp:requiredfieldvalidator></TD>
                                    <asp:requiredfieldvalidator id="valCityPart" runat="server" ErrorMessage="Kota Part Harus dipilih" ControlToValidate="ddlCityPart">*</asp:requiredfieldvalidator></TD>
							</TR>
							<TR>
								<TD class="titleField" width="20%">Telp / Hp</TD>
								<TD style="HEIGHT: 17px" width="1%">:</TD>
								<TD width="79%"><asp:textbox id="txtPhone" onkeyup="checkCharSpaceOrSlashOnfront(this,event);" onblur="checkDoublecharDelimiter(this);" MaxLength="40" runat="server" Width="180px"></asp:textbox>
                                    <asp:requiredfieldvalidator id="valPhone" runat="server" ErrorMessage="* Telephone Harus diisi" ControlToValidate="txtPhone"></asp:requiredfieldvalidator>
							...
							<TR>
								...
								<TD width="1%"></TD>
								<TD><asp:button id="btnCari" runat="server" width="60px" Text="Cari" CausesValidation="False"></asp:button><asp:button id="btnSave" runat="server" width="60px" Text="Simpan" CausesValidation="True"></asp:button></TD>
							</TR>
							<TR>
								<TD></TD>
							<TR>
								<TD class="titleField" width="20%">Jumlah Partshop</TD>
								<TD style="HEIGHT: 17px" width="1%">:</TD>
								<TD width="79%"><asp:label id="lblJumlah" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD class="titleField" colSpan="3">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 240px"><asp:datagrid id="dgPartShop" runat="server" Width="100%" CellPadding="3" BackColor="#CDCDCD"
											...
											<Columns>
												...
												<asp:TemplateColumn Visible="False"  HeaderText="Dealer Part Shop" SortExpression="Dealer.DealerCode">
													<HeaderStyle CssClass="titleTableParts"></HeaderStyle>
													<ItemStyle HorizontalAlign="Left" wrap="False"></ItemStyle>
													<ItemTemplate>
														<asp:Label id="lblDealerPartshop" runat="server"></asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												...
												<asp:BoundColumn Visible="True" DataField="OldPartShopCode" ReadOnly="True" SortExpression="OldPartShopCode"
													HeaderText="Old Part Shop ID">
													<HeaderStyle Width="10%" CssClass="titleTableParts"></HeaderStyle>
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
												</asp:BoundColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="Kota Part" SortExpression="CityPart.CityName">
													<HeaderStyle CssClass="titleTableParts"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
													<ItemTemplate>
												...
												<asp:TemplateColumn>
													...
													<ItemTemplate>
														<asp:LinkButton id="lbtnActive" Visible="True" Runat="server" text="Aktifkan" CommandName="activate"
															CausesValidation="False">
															<img src="../images/aktif.gif" border="0" alt="Aktifkan"></asp:LinkButton>
														<asp:LinkButton id="lbtnInActive" Visible="True" Runat="server" text="Non Aktifkan" CommandName="inactivate"
															CausesValidation="False">
							...
							<TR>
								<TD colSpan="3"><asp:button id="btnRegister" runat="server" width="60px" Text="Register" CausesValidation="False"></asp:button><asp:button id="btnRequestID" runat="server" width="60px" Text="Request ID" CausesValidation="False"></asp:button><asp:button id="btnDeActivated" runat="server" width="90px" Text="Ajukan Non Aktif" CausesValidation="False"></asp:button><asp:button id="btnDownload" runat="server" width="60px" Text="Download" CausesValidation="False"></asp:button></TD>
							<TR>
							</TR>
						</TABLE>
					</TD>
