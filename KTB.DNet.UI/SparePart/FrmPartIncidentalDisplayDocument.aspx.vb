...
Public Class FrmPartIncidentalDisplayDocument
...
#Region "Event Hendlers"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        CheckDropDownList()
        'btnDisplay.Attributes.Add("onclick", "window.close()")
    End Sub
    ...
    Private Sub BindToDropDownList() '--DropDownlist EmailCCTo
        ...
        If ArrayListForDDl.Count > 0 Then
            For Each item As PartIncidentalUser In ArrayListForDDl
                'Dim listItem As New ListItem(item.UserName, item.value)
                Dim listItem As New listItem(item.UserName, item.id)
    ...
    Private Sub btnDisplay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDisplay.Click
        ...
        'Dim subject As String = "[MMKSI Sparepart] Form Part Incidental"
        Dim subject As String = "[MMKSI Sparepart] Form Permintaan Khusus"
        ...
        '-- HTML Body
        '-- Header
        sb.Append("<table width=500px  cellpadding=0 cellspacing=0><tr><td colspan=3 align=center><b><font face=Verdana size=3>")
        sb.Append("FORM PERMINTAAN KHUSUS")
        sb.Append("</font></b></td></tr><tr><td colspan=3></td></tr><tr><td colspan=3 style=""border-top: black 1px solid; border-bottom: black 1px solid; border-left: black 1px solid; border-right: black 1px solid;""><table bgcolor=white cellspacing=0 width=600px border=0 cellpadding=0><tr bgcolor=white ><td ><table width=300px  border=0 cellpadding=3><tr><td colspan=3><b>")

        '--Header Data Part Incidential User
        sb.Append("Kepada Yth :")
        sb.Append("</b></td></tr><tr><td colspan=3><b><font size=2> ")
        sb.Append("TECHNICAL INFORMATION SEC.")
        sb.Append("</font></b></td></tr><tr><td colspan=3><b><font size=2>")
        ...
        sb.Append("<td width=3% colspan=2>")
        'sb.Append("CC : ")
        'sb.Append("</td><td>")
        'sb.Append(_CCName)
        sb.Append("CC : " + _CCName)
        'sb.Append("</td><td>")
        sb.Append("</td></tr><br><tr><td colspan=2><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        sb.Append(_Position)
        sb.Append("</td><td><b> </b></td></tr>")
        ...
        Try
            'Todo session
            Session("stringBulder") = strBody
            Dim _id As String = Request.QueryString("Id")
            Response.Redirect("FrmPartIncidentalPrintDocument.aspx?id=" & _id)
...
#End Region
    ...
    Private Sub BtnClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Response.Redirect("FrmListPartIncidentalKTBDetail.aspx")
    End Sub
