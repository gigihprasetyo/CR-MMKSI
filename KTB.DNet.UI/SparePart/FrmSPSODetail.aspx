...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSPSODetail.aspx.vb" Inherits="FrmSPSODetail" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Pemesanan - Detail Estimasi </title>
			...
			<TABLE id="Table2" cellSpacing="4" cellPadding="0" width="100%" border="0">
				<tr>
					<td height="20">
						...
						<TR>
							<TD class=titlePage>PEMESANAN&nbsp;- Detail Estimasi </TD></TR>
						<tr>
					...
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD width="20%"><asp:label id="lblTotAllocAmount" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD class="titleField">
								...
								<TD><asp:label id="lblTotTax" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD class="titleField"><asp:label id="Label2" runat="server">Tipe Order</asp:label></TD>
								...
								<TD><asp:label id="lblGrandAmount" runat="server"></asp:label></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD><asp:label id="lblDepositC2" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD class="titleField"><asp:label id="Label5" runat="server">Estimasi Tanggal Pengiriman</asp:label></TD>
								<TD><asp:label id="Label10" runat="server">:</asp:label></TD>
								<TD><asp:label id="lblSchedule" runat="server"></asp:label></TD>
								<TD class="titleField"><asp:label id="Label20" runat="server">Cara Pembayaran</asp:label></TD>
					...
					<TD align=center> <div id=div1 style="OVERFLOW: auto; HEIGHT: 250px"><asp:datagrid id="dgEstimateDetail" runat="server" Width="100%" AutoGenerateColumns="False" BorderWidth="0px"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Harga Eceran (Rp)" SortExpression="RetailPrice">
									...
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
										<asp:Label ID="lblPrice" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RetailPrice","{0:#,##0}") %>' CssClass="textRight"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Nilai Pemenuhan (Rp)">
									...
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
                                            <asp:Label ID="lblAllocAmount" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Amount","{0:#,##0}") %>' CssClass="textRight"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="Diskon (%)" SortExpression="Discount">
									...
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
                                        <asp:Label ID="lblDiscount" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Discount","{0:0.00}") %>' CssClass="textRight"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Tagihan (Rp)">
									...
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
									<ItemTemplate>
										<asp:Label ID="lblTotal" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TotalAmount","{0:#,##0}") %>' CssClass="textRight"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
