<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSparePartDueDateNotification.aspx.vb" Inherits=".FrmSparePartDueDateNotification" SmartNavigation="False" %>
...
<html>
<head>
    <title>FrmSparePartDueDateNotification</title>
...
<body onfocus="return checkModal()" onclick="checkModal()" ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">SPARE PART - Due Date Reminder</td>
            </tr>
            <tr>
                        ...
                        <asp:DataGrid ID="dtgSPPO" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="25"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn SortExpression="Dealer.DealerCode" HeaderText="Kode Dealer">
                                    <HeaderStyle CssClass="titleTableParts"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealerCode" runat="server" Text='<%# CType(Container.DataItem, SparePartDueDateNotification).Dealer.DealerCode %>'>Label</asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn SortExpression="Dealer.DealerName" HeaderText="Nama Dealer">
                                    <HeaderStyle CssClass="titleTableParts"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealerName" runat="server" Text='<%# CType(Container.DataItem, SparePartDueDateNotification).Dealer.DealerName %>'>Label</asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
