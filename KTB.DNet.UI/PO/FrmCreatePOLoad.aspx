<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmCreatePOLoad.aspx.vb" Inherits="FrmCreatePOLoad" SmartNavigation="False" EnableViewStateMac="False" %>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span>:</span></td>
                        <td>
                            <asp:Label ID="lblSave" runat="server"></asp:Label></td>
                    </tr>
                </tbody>
            </table>
        </div>
