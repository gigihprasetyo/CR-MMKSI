...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmCeilingDetail.aspx.vb" Inherits="FrmCeilingDetail" %>
...
<TABLE style="WIDTH: 792px; HEIGHT: 313px; id: 'Table2'" cellSpacing=0 cellPadding=0 width="792" border=0>
  <TR>
    <TD class=titlePage>CREDIT CONTROL&nbsp;- Detail Ceiling Position</TD></TR>
  <TR>
...
<asp:TemplateColumn HeaderText="Jatuh Tempo">
	...
	<ItemStyle Width="100px"></ItemStyle>
	<ItemTemplate>
		<asp:Label ID="lblJatuhTempo" Runat="server" Text='<%# format(DataBinder.Eval(Container, "DataItem.BaselineDate"), "dd/MM/yyyy") %>' ></asp:Label>
	</ItemTemplate>
</asp:TemplateColumn>
