...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmEntryGyro.aspx.vb" Inherits="FrmEntryGyro"%>
				...
				<tr>
					<td>
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD style="WIDTH: 155px"><STRONG><STRONG><STRONG>Nomor Registrasi Pembayaran</STRONG></STRONG></STRONG></TD>
								<TD style="WIDTH: 9px">
							...
							<TR>
								...
								<TD style="WIDTH: 138px; HEIGHT: 25px" align="left"><asp:textbox onkeypress="return alphaNumericExcept(event,'<>?*%$')" id="txtGyroNumber" onblur="omitSomeCharacter('txtGyroNumber','<>?*%$')"
							...
							<TR>
								<TD style="WIDTH: 155px; HEIGHT: 9px"><STRONG><STRONG><STRONG><STRONG>Tujuan Entry</STRONG></STRONG></STRONG></STRONG></TD>
								<TD style="WIDTH: 9px; HEIGHT: 9px">:</TD>
								<TD style="WIDTH: 198px; HEIGHT: 9px">
									<asp:dropdownlist id="ddlGyroType" runat="server" AutoPostBack="True" Width="152px"></asp:dropdownlist></TD>
								<TD style="WIDTH: 125px; HEIGHT: 9px"><STRONG><STRONG>
								...
								<TD style="WIDTH: 138px; HEIGHT: 9px" align="left">
									...
									<DIV id="divHidden" style="OVERFLOW: auto; WIDTH: 800px; HEIGHT: 290px">
										<asp:datagrid id="dtgMain" runat="server" Width="100%" CellSpacing="1" GridLines="Horizontal"
											...
											<Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="LC" Visible="false">
													<HeaderStyle ForeColor="White" Width="150px" HorizontalAlign="Center" CssClass="titleTableSales"></HeaderStyle>
													<ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
													<ItemTemplate>
														<asp:Label runat="server" ID="lblLC">&nbsp;</asp:Label>
													</ItemTemplate>
													<EditItemTemplate>
														<asp:Label runat="server" ID="lblLCE">&nbsp;</asp:Label>
													</EditItemTemplate>
													<FooterTemplate>
														<asp:Label runat="server" ID="lblLCF">&nbsp;</asp:Label>
													</FooterTemplate>
												</asp:TemplateColumn>
												...
												<asp:TemplateColumn HeaderText="Reason">
													<HeaderStyle ForeColor="White" Width="300px" HorizontalAlign="Center" CssClass="titleTableSales"></HeaderStyle>
													<ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
													<ItemTemplate>
							...
							<TR>
								<TD align="center" colSpan="7"><BR>
									<asp:button id="btnBack" runat="server" Width="60px" Text="Back"></asp:button>&nbsp;
