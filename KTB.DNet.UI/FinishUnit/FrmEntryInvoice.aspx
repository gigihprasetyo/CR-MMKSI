...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowLKPPSelection() {
            ...
            showPopUp('../PopUp/PopUpLKPPTersedia.aspx?IsGroupDealer=0&SN=' + lblChassisNumber.innerText, '', 500, 800, LKPPSelection);
        }
            ...
            <tr>
                <td>
                    <table id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            <td class="titleField" height="24">Temporary Faktur</td>
                            <td>:</td>
                            <td colspan="4">
                                <asp:Label ID="lblTmpFaktur" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
