...
Public Class FrmMCPFaktur
    ...
    Private Sub BindData(ByVal currentPageIndex As Integer)
        Try
            ...
            Dim _mcpID As String = Request.QueryString("mcpId")
            ...
            criterias.opAnd(New Criteria(GetType(EndCustomer), "MCPHeader.ID", MatchType.Exact, CInt(_mcpID)))
