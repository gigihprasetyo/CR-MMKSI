<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPaymentStatus.aspx.vb" Inherits="FrmPaymentStatus" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 16px; WIDTH: 680px; POSITION: absolute; TOP: 16px; cellSpacing: "
				cellPadding="1" width="680" border="1">
				<tr>
