...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSPKCustomer.aspx.vb" Inherits="FrmSPKCustomer" SmartNavigation="False" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">MARKETING&nbsp;- Data Awal Konsumen
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left">
                    <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                        ...
                        <tr id="trLKPPNumber" runat="server">
