...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPPHLogisticCostStatus.aspx.vb" Inherits="FrmPPHLogisticCostStatus" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 310px"><asp:datagrid id="dtgLogisticStatus" runat="server" Width="100%" PageSize="25" GridLines="None" CellPadding="3"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Form PPH">
										...
										<ItemTemplate>
											<asp:label id="lblSurat" runat="server">
												<img src="../images/download.gif" style="cursor:hand" border="0" alt="Surat Biaya Logistic"></asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="Total Biaya Logistic">
										<HeaderStyle Width="4%" CssClass="titleTableSales"></HeaderStyle>
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
										<ItemTemplate>
											<asp:label id="lblLogisticCost" runat="server"></asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>

                                     <asp:TemplateColumn HeaderText="Total Biaya PPH">
										<HeaderStyle Width="4%" CssClass="titleTableSales"></HeaderStyle>
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
										<ItemTemplate>
											<asp:label id="lblPPHCost" runat="server"></asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
				...
				<TR>
					<TD class="titleField"><asp:label id="lblGenerate" runat="server">Mengubah Status :</asp:label><asp:dropdownlist id="ddlProcess" Width="160px" Runat="server">
                        ...
                        <asp:Button runat ="server" ID="btnReTransfer" text ="Re Transfer ke SAP" Visible="false" />
