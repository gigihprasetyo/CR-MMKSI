...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDaftarDebitNote.aspx.vb" Inherits="FrmDaftarDebitNote" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">Sales - DepositA - Daftar&nbsp;Debit&nbsp;Note</td>
            </tr>
            <tr>
                    ...
                    <div>
                        <asp:DataGrid ID="dgDaftarDebitNote" runat="server" BorderWidth="0px" CellSpacing="1" BorderColor="Gainsboro"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="PostingDate" ReadOnly="True" HeaderText="Tanggal" DataFormatString="{0:dd/MM/yyyy}">
                                ...
                                <asp:TemplateColumn SortExpression="ProductCategory.Code" HeaderText="Produk">
                                    ...
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblProduct" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductCategory.Code") %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
