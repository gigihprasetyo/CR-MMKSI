...
#Region "Custom Method"
    ...
    Private Sub searchEndCustomer()
        ...
        If EndCustomerColl.Count > 0 Then
            ...
            If Not IsNothing(objEndCustomer.HandoverDate) Then
                If objEndCustomer.HandoverDate <= "1/1/1900" Then
                    lblHandoverDate.Text = ""
                Else
                    lblHandoverDate.Text = objEndCustomer.HandoverDate.ToString("dd/MM/yyyy")
                End If
            End If
        End If
    End Sub
