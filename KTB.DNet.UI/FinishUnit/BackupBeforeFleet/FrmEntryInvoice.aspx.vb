...
#Region " Custom Method "
    ...
    Private Sub BindEndCustomerProfileToControl()
        If IsOpenInvoice Then
            ...
            Select Case _objChassisMaster.Category.CategoryCode
                Case "PC"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_pc"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, False)

                Case "CV"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_cv"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, False)

                Case "LCV"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_lcv"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, False)
        ...
        Else
            Select Case _objChassisMaster.Category.CategoryCode
                Case "PC"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_pc"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, True)

                Case "CV"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_cv"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, True)

                Case "LCV"
                    RenderProfilePanel(_objChassisMaster, New ProfileGroupFacade(User).Retrieve("cust_prf_lcv"), EnumProfileType.ProfileType.CHASSISMASTER, pnlInformasion, True)
    ...
    Private Sub ControlToEndCustomer()
        ...
        Select Case _objChassisMaster.Category.CategoryCode
            Case "PC"
                SetChassisMasterProfile("cust_prf_pc")
            Case "CV"
                SetChassisMasterProfile("cust_prf_cv")
            Case "LCV"
                SetChassisMasterProfile("cust_prf_lcv")
        End Select
        ...
        If (_sErrorMessage = "") Then
            ...
            Select Case _objChassisMaster.Category.CategoryCode
                Case "PC"
                    ...
                    Dim objRenderPanel As RenderingProfile = New RenderingProfile
                    Dim PCList As ArrayList = objRenderPanel.RetrieveProfileValue(Me, New ProfileGroupFacade(User).Retrieve("cust_prf_pc"), CType(EnumProfileType.ProfileType.CHASSISMASTER, Short), User)
                ...
                Case "LCV"
                    ...
                    Dim objRenderPanel As RenderingProfile = New RenderingProfile
                    Dim LCVList As ArrayList = objRenderPanel.RetrieveProfileValue(Me, New ProfileGroupFacade(User).Retrieve("cust_prf_lcv"), CType(EnumProfileType.ProfileType.CHASSISMASTER, Short), User)
                ...
                Case "CV"
                    ...
                    Dim objRenderPanel As RenderingProfile = New RenderingProfile
                    Dim CVList As ArrayList = objRenderPanel.RetrieveProfileValue(Me, New ProfileGroupFacade(User).Retrieve("cust_prf_cv"), CType(EnumProfileType.ProfileType.CHASSISMASTER, Short), User)
