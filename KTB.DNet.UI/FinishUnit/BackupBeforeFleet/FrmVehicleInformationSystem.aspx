		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				...
				<TR>
					...
					<TD class="titleField">Tanggal Unit Keluar KTB</TD>
					<TD>:</TD>
...
<TR>
				...
				<TR>
					...
					<TD style="HEIGHT: 18px">:</TD>
					<TD style="HEIGHT: 18px"><asp:label id="lblHandoverDate" runat="server"></asp:label></TD>
				...
				<TR>
					...
					<TD style="HEIGHT: 18px">:</TD>
					<TD style="HEIGHT: 18px"><asp:label id="lblNoRegRequest" runat="server"></asp:label></TD>
					<TD class="titleField">&nbsp;</TD>
					<TD style="HEIGHT: 18px">&nbsp;</TD>
					<TD style="HEIGHT: 18px">
				...
				<TR>
					...
					<TD valign="top">:</TD>
					<TD><asp:label id="lblKeteranganFleet" runat="server"></asp:label></TD>
					<TD class="titleField"></TD>
					<TD></TD>
					<TD></TD>
				</TR>
