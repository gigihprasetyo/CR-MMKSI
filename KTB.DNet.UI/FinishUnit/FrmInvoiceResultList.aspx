                ...
                <td>
                    <table id="Table1" cellspacing="1" cellpadding="2" width="100%" border="0">
                        <tr>
                            ...
                            <td class="titleField" width="20%" style="height: 11px" valign="top">
                                <asp:Label ID="lblCategory" runat="server"> Kategori</asp:Label></td>
                            <td width="1%" style="height: 11px" valign="top">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDealerBranchCode" runat="server" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="titleField" width="20%" style="height: 11px; display: none;">No Extended Free Service</td>
                            <td width="1%" style="height: 11px; display: none;">:</td>
                            <td style="height: 11px; display: none;">
                        ...
                        <tr>
                            ...
                            <td class="titleField">
                                <asp:CheckBox ID="CBTglPembuatan" runat="server" Text="Tgl Pembuatan"></asp:CheckBox></td>
                            <td>
                            ...
                            <td nowrap>
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td>
                                            <cc1:IntiCalendar ID="ICTglPembuatanStart" runat="server" TextBoxWidth="70"></cc1:IntiCalendar></td>
                                        <td>&nbsp;s/d&nbsp;</td>
                                        <td>
                                            <cc1:IntiCalendar ID="ICTglPembuatanEnd" runat="server" TextBoxWidth="70"></cc1:IntiCalendar></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <asp:DataGrid ID="dgInvoiceList" runat="server" Width="100%" AllowSorting="True" CellPadding="3"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="Cabang Dealer">
                                                ...
                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDealerBranch" runat="server">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn SortExpression="DODate" HeaderText="Tanggal DO">
                                                <HeaderStyle Width="5%" CssClass="titleTableSales"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%# Format(DataBinder.Eval(Container, "DataItem.DODate"), "dd/MM/yyyy")%>' ID="lblDONumber">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn SortExpression="EndCustomer.SPKFaktur.SPKHeader.SPKCustomer.Name1" HeaderText="Konsumen. SPK">
                                                <HeaderStyle Width="10%" CssClass="titleTableSales"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EndCustomer.SPKFaktur.SPKHeader.SPKCustomer.Name1")%>' ID="Label80">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn HeaderText="No Extended Free Service" Visible="false">
                                                <HeaderStyle Width="6%" CssClass="titleTableSales"></HeaderStyle>
                                                <ItemStyle></ItemStyle>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateColumn SortExpression="EndCustomer.CreatedTime" HeaderText="Tanggal Pembuatan">
                                                <HeaderStyle Width="5%" CssClass="titleTableSales"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EndCustomer.CreatedTime")%>' ID="lblTglPembuatan">
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                    ...
                    <asp:Button ID="btnConfirm" runat="server" Width="60px" Text="Konfirmasi"></asp:Button>&nbsp;
						...
						<asp:Button ID="btnReSendPKT" runat="server" Width="96px" Text="Kirim Ulang PKT"></asp:Button>
