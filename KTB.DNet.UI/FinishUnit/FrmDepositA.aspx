...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDepositA.aspx.vb" Inherits="FrmDepositA" SmartNavigation="False" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table style="id: 'Table2'" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">UMUM - Daftar Deposit A</td>
            </tr>
            <tr>
            ...
            <asp:Panel ID="pnlSearch"
                    ...
                    <td>
                        <table id="Table1" cellspacing="1" cellpadding="2" width="100%" border="0">
                            <tr>
                                ...
                                <td class="titleField">
                                    <asp:TextBox onkeypress="return alphaNumericExcept(event,'<>?*%$')" ID="txtKodeDealer" onblur="omitSomeCharacter('txtKodeDealer','<>?*%$')" runat="server" Text=""></asp:TextBox>
                ...
                <tr>
                    <td>
                        <asp:DataList ID="dtlDepositA" runat="server" Width="100%" BorderWidth="0px" BackColor="#CDCDCD" BorderColor="Gainsboro" CellPadding="1" CellSpacing="1" ShowFooter="True">
                            ...
                            <HeaderTemplate>
                                ...
                                <td class="titleTableSales">Produk
                                </td>

                                <td class="titleTableSales">Nama Dealer
                                </td>
                                <td class="titleTableSales">Saldo Awal
                                </td>
                                <td class="titleTableSales">Total Debet
                                </td>
                                <td class="titleTableSales">Total Kredit
                                </td>
                                <td class="titleTableSales">Saldo Akhir					
                                </td>
                                <td class="titleTableSales"></td>
                            ...
                            <ItemTemplate>
                                ...
                                <td style="color: Black; background-color: #F1F6FB" align="center">
                                    <asp:LinkButton ID="Linkbutton1" CausesValidation="False" CommandName="detail" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.Dealer.DealerCode") %>' Text="Lihat" runat="server">
										...
										<tr style="display: none">
                                            <td></td>
                                            <td colspan="7">
                                                <asp:DataGrid runat="server" Width="100%" AutoGenerateColumns="False" ID="dtgDetail" CellSpacing="1" CellPadding="3" BorderColor="Gainsboro" BackColor="#CDCDCD" BorderWidth="0px">
                                                    <AlternatingItemStyle ForeColor="Black" BackColor="White"></AlternatingItemStyle>
                                                    <ItemStyle ForeColor="Black" BackColor="#F1F6FB"></ItemStyle>
                                                    <HeaderStyle ForeColor="black" BackColor="#edd0b5" CssClass="titleTableSales2"></HeaderStyle>
                                                    <Columns>
                                                        <asp:BoundColumn DataField="Periode" ItemStyle-Width="128px" HeaderText="Periode"></asp:BoundColumn>
                                                        <asp:BoundColumn ItemStyle-HorizontalAlign="Right" DataField="SaldoAwal" ItemStyle-Width="121px" HeaderText="Saldo Awal" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn ItemStyle-HorizontalAlign="Right" DataField="Debet" ItemStyle-Width="125px" HeaderText="Debet (Rp)" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn ItemStyle-HorizontalAlign="Right" DataField="Kredit" ItemStyle-Width="125px" HeaderText="Kredit (Rp)" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn ItemStyle-HorizontalAlign="Right" DataField="SaldoAkhir" HeaderText="Saldo Akhir" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                    </Columns>
                                                </asp:DataGrid>
                            </ItemTemplate>
                            <AlternatingItemTemplate>
                                ...
                                <td style="color: black; background-color: white;" align="center">
                                    <asp:LinkButton ID="Linkbutton2" CausesValidation="False" CommandName="detail" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.Dealer.DealerCode") %>' Text="Lihat" runat="server">
													<img src="../images/detail.gif" border="0" alt="Lihat"></asp:LinkButton>
                                </td>
                                </tr>												
										<tr style="display: none">
                                            ...
                                            <td colspan="7" align="left">
                                                <asp:DataGrid Width="100%" AutoGenerateColumns="False" runat="server" ID="dtgDetail" CellSpacing="1" CellPadding="3" BorderColor="Gainsboro" BackColor="#CDCDCD" BorderWidth="0px">
                                                    <AlternatingItemStyle ForeColor="Black" BackColor="White"></AlternatingItemStyle>
                                                    <ItemStyle ForeColor="Black" BackColor="#F1F6FB"></ItemStyle>
                                                    <HeaderStyle CssClass="titleTableSales"></HeaderStyle>
                                                    <Columns>
                                                        <asp:BoundColumn DataField="Periode" HeaderStyle-ForeColor="White" ItemStyle-Width="128px" HeaderText="Periode"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SaldoAwal" HeaderStyle-ForeColor="White" ItemStyle-Width="121px" HeaderText="Saldo Awal" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="Debet" HeaderStyle-ForeColor="White" ItemStyle-Width="125px" HeaderText="Debet (Rp)" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="Kredit" HeaderStyle-ForeColor="White" ItemStyle-Width="125px" HeaderText="Kredit (Rp)" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SaldoAkhir" HeaderStyle-ForeColor="White" HeaderText="Saldo Akhir" DataFormatString="{0:#,###}"></asp:BoundColumn>
                                                    </Columns>
                                                </asp:DataGrid>
                            </AlternatingItemTemplate>
                            <FooterTemplate>
        ...
        <table cellspacing="1" cellpadding="3" width="100%" border="0">
            <tr class="titleField">
               ...
               <td>Dealer</td>  <td>:&nbsp;<asp:Label ID="lblDealerDetail" runat="server"></asp:Label> </td> <td style="width:20%;"></td>
            </tr>
            <tr class="titleField">
                <td height="20">Total Debet </td>
                <td width="30%">:&nbsp;
                    <asp:Label ID="lblTotalDebetAll" runat="server"></asp:Label></td>
                 <td>Produk</td>  <td>:&nbsp;<asp:Label ID="lblProdukDetail" runat="server"></asp:Label> </td> <td style="width:20%;"></td>
            </tr>
            <tr class="titleField">
                <td nowrap height="20">Total Kredit </td>
              <td width="30%">:&nbsp;
  <asp:Label ID="lblTotalKreditAll" runat="server"></asp:Label></td>
                <td colspan="3"></td>
            </tr>
        </table>
        </TR><tr>
            <td>
                <table cellspacing="1" cellpadding="3" width="100%" border="0">
                    <asp:Repeater ID="dtlDetails" runat="server">
                        <HeaderTemplate>
                            <tr>
                                <td class="titleTableSales" width="13%">Tanggal Transaksi
                                </td>
                                <td class="titleTableSales" width="15%">Keterangan
                                </td>
                                <td class="titleTableSales" width="10%">No Dokumen
                                </td>
                                <td class="titleTableSales" width="15%">Reference
                                </td>
                                <td class="titleTableSales" width="25%">Text
                                </td>
                                <td class="titleTableSales" width="11%">Debet (Rp)
                                </td>
                                <td class="titleTableSales" width="11%">Kredit (Rp)																						
                                </td>
                            </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
