<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmCategory.aspx.vb" Inherits="FrmCategory" smartNavigation="False"%>
	...
	<BODY>
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">MAINTENANCE - Kategori Kendaraan</td>
				</tr>
				<tr>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								...
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtCode)" id="txtCode"
										runat="server" MaxLength="4"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="ValidateCode" runat="server" ControlToValidate="txtCode" Height="16px" ErrorMessage="Kode Kategori Harus Diisi!"
							...
							<TR>
								...
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtDescription)" id="txtDescription"
										runat="server" MaxLength="40"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="ValidateDescription" runat="server" ControlToValidate="txtDescription" Height="16px"
										ErrorMessage="Deskripsi Kategori Harus Diisi!" Width="8px" EnableClientScript="False">*</asp:requiredfieldvalidator></td>
							</TR>
							<TR>
								<TD class="titleField" width="24%">Produk</TD>
								<TD width="1%">:</TD>
								<td width="75%">
									<asp:dropdownlisT runat="server" id="ddlProductCategory" width="130px" Enabled="false"></asp:dropdownlisT>
								</td>
							</TR>
							<TR>
					...
					<TD vAlign="top">
						<div id="div1" style="HEIGHT: 390px; OVERFLOW: auto"><asp:datagrid id="dtgCategory" runat="server" Width="100%" PageSize="10" AllowSorting="True" CellSpacing="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="CategoryCode" HeaderText="Kode" SortExpression="CategoryCode">
										<HeaderStyle Width="25%" CssClass="titleTableGeneral"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="Description" HeaderText="Deskripsi" SortExpression="Description">
