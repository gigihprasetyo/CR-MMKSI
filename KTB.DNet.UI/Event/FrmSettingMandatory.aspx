<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSettingMandatory.aspx.vb" Inherits=".FrmSettingMandatory" %>

<%@ Register TagPrefix="cc1" Namespace="KTB.DNet.WebCC" Assembly="KTB.DNet.WebCC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>FrmSettingMandatory</title>
        ...
        <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage" style="height: 18px">
                    <asp:Label ID="lblTitle" runat="server" Text="EVENT - SETTING MANDATORY"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <table id="Table1" width="50%" border="0">
                        <tr>
                            <td class="titleField" style="height: 30px">Jenis Babit
                            <%--</td>--%>
                                ...
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="20%" AutoGenerateColumns="False" ShowFooter="True" ShowHeader="false" GridLines="None">
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn>
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtCats1" runat="server"></asp:TextBox>
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                        ...
                        <tr>
                            <td class="titleField" style="height: 30px;" colspan="3">Dokumen yang HARUS diupload untuk Persetujuan</td>
                        </tr>
                        <tr>
                            <td colspan="3">
