...
#Region "Private Declaration"
    Private containerPage As default_service
        ...
        If Not objDealer Is Nothing Then
            ...
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    'masih pending
                    If IsTraineeUpdate(objDealer) Then
                        SetTreeMenu("TreeMenu.XML.PathFromRootFreeServiceDealer", 9000)
                    Else
                        SetTreeMenu("TreeMenu.XML.PathFromRootServiceDealerNoTraining", 9000)
                    End If
                Else
...
#Region "Private Method"
    ...
    'Apply 2011-02-14
    'Start
    Private Function IsTraineeUpdate(ByVal objDealer As Dealer) As Boolean
        ...
        For Each objAlertConfirmation As AlertConfirmation In arlAlertConfirmation
            If Not objAlertConfirmation.ConfirmDate = Nothing Then
                If Now <= (objAlertConfirmation.ConfirmDate).AddDays(2) Then
                    bReturn = True
                End If
            End If
        Next
