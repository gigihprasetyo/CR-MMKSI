...
Public Class default_aftersales
...
#Region "Private Declaration"
    Private containerPage As default_aftersales
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=aftersales"
#End Region
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootAfterSales", 2900)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootAfterSalesDealer", 2913)
                End If
...
#Region "Page Event"
    ...
    Private Sub AfterSalesLinkButon_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AfterSalesLinkButton.Click
        Dim objDealer As Dealer = sessionHelper.GetSession("DEALER")
        If Not objDealer Is Nothing Then
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootAfterSales", 2900)
    ...
    Private Sub doLogout()
        LogTosyslog("user logout successfully", "logout-aftersales", "success")
        Session.RemoveAll()
...
#End Region
    ...
    Private Sub lnkMaintenance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkMaintenance.Click
        MainFrameSrc = "AfterSales/FrmChecklistMaintenance.aspx"
    End Sub
