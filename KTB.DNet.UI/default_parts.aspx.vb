...
#Region "Private Declaration"
    Private containerPage As default_parts
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=parts"
#End Region
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootSparePart", 200)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootSparePartDealer", 200)

                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootSparePartLeasing", 200)
...
#Region "Event Handler"
    ...
    Private Sub dologout()
        LogTosyslog("user logout successfully", "logout-parts", "success")
        Session.RemoveAll()
