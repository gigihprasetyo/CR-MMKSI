<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default_parts.aspx.vb" Inherits="default_parts" SmartNavigation="False" %>

<%@ Register TagPrefix="cc1" Namespace="KTB.DNet.Menu" Assembly="KTB.DNet.Menu" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>PT Mitsubishi Motors Krama Yudha Sales Indonesia - Sparepart</title>
                                ...
                                <table height="74" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="153" height="30">
                                            <img src="images/spareparts_r1_c1.gif"></td>
                                        <td width="163" height="30">
                                            <img src="images/spareparts_r1_c2.gif"></td>
                                        <td width="152" height="30" background="images/spareparts_r1_c3_bg.gif">
                                            <img src="images/spareparts_r1_c3_bg.gif"></td>
                                        <td width="115" height="30" background="images/spareparts_r1_c3_bg.gif">
                                            <img src="images/spareparts_r1_c3_bg.gif"></td>
                                        <td width="442" height="30" align="left">
                                            <img src="images/04spareparts_r1_c4.gif"></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="images/spareparts_r2_c1.jpg"></td>
                                        <td>
                                            <img src="images/spareparts_r2_c2.jpg"></td>
                                        <td>
                                            <img src="images/spareparts_r2_c3.jpg"></td>
                                        ...
                                        <td background="images/04mrk_r3_c3_bg.gif" height="53">
                                            <table width="740" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="menuHor">
                                                        <asp:LinkButton class="menuHor2" ID="SparepartLinkButton" runat="server" Enabled="False"><b>Parts</b></asp:LinkButton></td>
                                                ...
                                                <tr>
                                                    <td height="27">
                                                        <div id="div1" style="height: 380px; overflow: auto">
                                                            <cc1:TreeMenu id="MyMenu" runat="server" XMLPath="TreeMenu.XML.PathFromRootSparePart" ScreenId="200"></cc1:TreeMenu>
                                                        </div>
