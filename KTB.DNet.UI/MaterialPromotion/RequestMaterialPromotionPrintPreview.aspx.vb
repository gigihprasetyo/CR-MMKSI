...
Public Class RequestMaterialPromotionPrintPreview
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblThn As System.Web.UI.WebControls.Label
...
#Region "Custom Method"
    ...
    Private Sub BindHeader()
        If (Request.QueryString("id") <> "") Then
            ...
            lblApprovedDate.Text = IIf(Header.Status = 3, Header.LastUpdateTime, String.Empty)
            ...
            Dim Tanggal As String = String.Format("{0} {1} {2}", Header.RequestDate.Day.ToString(), CType(LookUp.ArrayBulan(Header.RequestDate.Month - 1), ListItem).Text, Header.RequestDate.Year.ToString())
            lblThn.Text = Tanggal
        Else
            ...
            Dim Tangggal As String = String.Format("{0} {1} {2}", DateTime.Now.Day.ToString(), CType(LookUp.ArrayBulan(DateTime.Now.Month - 1), ListItem).Text, DateTime.Now.Year.ToString())
            lblThn.Text = Tangggal
        End If
    End Sub
...
#Region "Event Handler"
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtgMaterialPromotion.Columns(4).Visible = False
        dtgMaterialPromotion.Columns(8).Visible = False
        dtgMaterialPromotion.Columns(9).Visible = False
        dtgMaterialPromotion.Columns(10).Visible = False
    End Sub
