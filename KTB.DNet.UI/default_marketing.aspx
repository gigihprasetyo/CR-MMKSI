<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default_marketing.aspx.vb" Inherits="default_marketing" SmartNavigation="False" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" onload="updateClock(); setInterval('updateClock()', 1000 );pageLoad();"
    ...
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" height="100%" cellpadding="0" width="100%" border="0" valign="middle">
            <tr>
                                ...
                                <table height="74" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="153" height="30">
                                            <img src="images/04mrk_r1_c1.gif"></td>
                                        <td width="163" height="30">
                                            <img src="images/04mrk_r1_c2.gif"></td>
                                        <td width="152" height="30" background="images/04mrk_r1_c3_bg.gif">
                                            <img src="images/04mrk_r1_c3_bg.gif"></td>
                                        <td width="115" height="30" background="images/04mrk_r1_c3_bg.gif">
                                            <img src="images/04mrk_r1_c3_bg.gif"></td>
                                        <td width="442" height="30" align="left">
                                            <img src="images/04mrk_r1_c4.gif"></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="images/mrk_r2_c1.jpg"></td>
                                        <td>
                                            <img src="images/mrk_r2_c2.jpg"></td>
                                        <td>
                                            <img src="images/mrk_r2_c3.jpg"></td>
                                        ...
                                        <td background="images/04mrk_r3_c3_bg.gif" height="53">
                                            <table width="740" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="menuHor2">
                                                        <asp:LinkButton class="menuHor2" ID="MrkLinkButton" runat="server" Enabled="False">Marketing</asp:LinkButton></td>
                ...
                <td valign="top" width="90%">
                    <table height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr valign="top" height="99%">
                            <td rowspan="2" valign="top" align="center" width="200" bgcolor="#e6e6e6" height="99%">
                                <!-- start Left -->
                                                ...
                                                <tr>
                                                    <td height="50">Selamat Datang,&nbsp;
                                                        ...
                                                        <asp:Label ID="lblTokenText" runat="server" Font-Bold="True">
																<br />
																<br />
																<b>Token Anda valid sampai</b></asp:Label>
                                                        <br>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <div id="div1" style="height: 380px; overflow: auto">
                                                            <cc1:treemenu id="MyMenu" runat="server" ScreenId="9980" XMLPath="TreeMenu.XML.PathFromRootMarketing"></cc1:treemenu></div>
                                                    </td>
                                                    <td valign="top">
