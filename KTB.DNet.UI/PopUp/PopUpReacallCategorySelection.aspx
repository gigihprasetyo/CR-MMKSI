<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpReacallCategorySelection.aspx.vb" Inherits="PopUpReacallCategorySelection" smartNavigation="False"%>
<%@ Register TagPrefix="cc1" Namespace="FilterCompositeControl" Assembly="FilterCompositeControl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>PopUpReacallCategorySelection</title>
		...
		function GetSelectedDealer()
		{
			...
			if (bcheck)
			  ...
			  {
				alert("Silahkan Pilih Kategori Field Fix Campaign terlebih dahulu");	
			  }
		}
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" colSpan="7">Daftar - Kategori Field Fix Campaign</td>
							</tr>
							<tr>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR valign="top">
								<TD class="titleField" width="20%" style="HEIGHT: 20px">Field Fix Reg No</TD>
								<TD width="1%" style="HEIGHT: 20px">:</TD>
								<TD width="25%" style="HEIGHT: 20px"><asp:textbox id="txtRecallRegNo" runat="server" Width="152px" ></asp:textbox></TD>
							...
							<TR valign="top">
								...
								<TD style="HEIGHT: 13px"> <asp:textbox id="txtDEscription" runat="server" Width="152px" ></asp:textbox></TD>
								...
								<TD colSpan="7">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 260px"><asp:datagrid id="dtgDealerSelection" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="2" 
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="RecallRegNo" HeaderText="Field Fix No">
													<HeaderStyle Width="15%" ></HeaderStyle>
													<ItemTemplate>
														<asp:Label id=lblDealerCode runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RecallRegNo") %>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
