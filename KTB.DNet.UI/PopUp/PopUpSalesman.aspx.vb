...
#End Region
    ...
    Private Sub BindDataGrid(ByVal idxPage As Integer)
        ...
        If Not IsNothing(objDealer.ParentDealer) Then
            criterias.opAnd(New Criteria(GetType(SalesmanHeader), "Dealer.ID", MatchType.InSet, "(" & objDealer.ID & "," & objDealer.ParentDealer.ID & ")"))
        Else
