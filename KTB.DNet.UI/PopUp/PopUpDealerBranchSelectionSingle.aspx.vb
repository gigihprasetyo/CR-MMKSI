...
Public Class PopUpDealerBranchSelectionSingle
...
#Region " Event Hendler "
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If Not IsNothing(Request.QueryString("deal")) Then
                Dim dealerCode As String = Request.QueryString("deal")
                lblDealerCode.Text = dealerCode
            End If
    ...
    Public Sub BindSearch()
        ...
        If objDealer.Title = EnumDealerTittle.DealerTittle.DEALER Then
            ...
            If IsNothing(Request.QueryString("m")) Then
                ...
                If lblDealerCode.Text <> String.Empty Then
                    criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "ParentDealerID", MatchType.InSet, funcD.GenerateDealerIDSelection(lblDealerCode.Text)))
                End If
        ...
        If Not lblDealerCode.Text = "" Then
            criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "ParentDealerID", MatchType.InSet, funcD.GenerateDealerIDSelection(lblDealerCode.Text)))
        End If
