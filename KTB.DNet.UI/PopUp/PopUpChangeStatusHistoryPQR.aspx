<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpChangeStatusHistoryPQR.aspx.vb" Inherits="PopUpChangeStatusHistoryPQR" smartNavigation="False"%>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<TR>
					...
					<TD width="1%">:</TD>
					<TD width="60%">
						<asp:Label id="Label2" runat="server">Product Quality Report</asp:Label></TD>
				</TR>
				<TR>
					<TD class="titleField" width="40%">
