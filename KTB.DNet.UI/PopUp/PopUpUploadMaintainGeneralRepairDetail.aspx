<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpUploadMaintainGeneralRepairDetail.aspx.vb" Inherits=".PopUpUploadMaintainGeneralRepairDetail" %>
<%@ Register TagPrefix="cc1" Namespace="KTB.DNet.WebCC" Assembly="KTB.DNet.WebCC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PopupMaintainGeneralRepairDetail</title>
...
<body MS_POSITIONING="GridLayout">
    ...
    <table id="Table2" cellspacing="3" cellpadding="3" width="100%" border="0">
            <tr>
                <td class="titleTableParts3" colspan="3">Popup Maintain General Repair Detail</td>
            </tr>
						...
						OnSortCommand="dtgServiceStandardTime_SortCommand"	
							...
							<Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Nama Sparepart">
                                            ...
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lbNamaSparePart" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.NamaSparePart")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Kode Sparepart">
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbKodeSparepart" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KodeSparePart")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Harga Satuan">
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbHargaSatuan" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.HargaSatuan")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Jumlah">
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbJumlah" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JumlahUnit")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
						...
						OnSortCommand="dtgServiceStandardTimeDetail_SortCommand"	
							...
							<Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Variant">
                                            ...
                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lbVariantDetail" runat="server" Text=''></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Jenis Service">
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbJenisServiceDetail" runat="server" Text=''></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                 <asp:TemplateColumn HeaderText="Kind Code">
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lbKindCodeDetail" runat="server" Text=''></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Nama Sparepart">
                                                <HeaderStyle Width="20%" CssClass="titleTableService"></HeaderStyle>
