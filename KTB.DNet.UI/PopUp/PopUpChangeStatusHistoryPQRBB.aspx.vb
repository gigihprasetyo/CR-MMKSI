...
Public Class PopUpChangeStatusHistoryPQRBB
...
#End Region
    ...
    Private objDomain As PQRHeaderBB

    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Put user code to initialize the page here
        Response.Cache.SetCacheability(HttpCacheability.NoCache)
        If Not IsPostBack Then
            objDomain = New PQRHeaderBBFacade(User).Retrieve(CInt(Request.QueryString("id")))
            BindData()
        End If
    End Sub
    ...
    Private Sub BindData()
        ...
        dtgStatusChangeHistory.DataSource = objDomain.PQRChangesHistoryBBs
    ...
    Sub dtgStatusChangeHistory_itemdataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs)
        If e.Item.ItemIndex <> -1 Then
            Dim RowData As PQRChangesHistoryBB = CType(e.Item.DataItem, PQRChangesHistoryBB)
