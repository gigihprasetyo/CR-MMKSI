<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpCsTeam.aspx.vb" Inherits="PopUpCsTeam" %>
			...
			for (i = 1; i < table.rows.length; i++)
			{
				...
				if (RadioButton != null && RadioButton.checked)
				{
					if(navigator.appName == "Microsoft Internet Explorer")
					  {
						retVal = table.rows[i].cells[1].innerText + ';' + table.rows[i].cells[2].innerText + ';' + table.rows[i].cells[3].innerText;
					  ...
					  {
						retVal = table.rows[i].cells[1].getElementsByTagName("span")[0].innerHTML + ';' + table.rows[i].cells[2].getElementsByTagName("span")[0].innerHTML + ';' + table.rows[i].cells[3].getElementsByTagName("span")[0].innerHTML;
						opener.dialogWin.returnFunc(retVal);
						bcheck=true;
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" style="HEIGHT: 18px" colSpan="7">CS Team</td>
							</tr>
							<tr>
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 22px" width="20%">Kode CS Employee</TD>
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 13px">Nama CS Employee</TD>
