<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpDealerBranchEventMultipleSelection.aspx.vb" Inherits=".PopUpDealerBranchEventMultipleSelection" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function GetSelectedDealer() {
            ...
            var hdnBabitEvent;
            var bcheck = false;
            hdnBabitEvent = document.getElementById("hdnBabitEvent");
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <asp:HiddenField ID="hdnBabitEvent" runat="server" />
