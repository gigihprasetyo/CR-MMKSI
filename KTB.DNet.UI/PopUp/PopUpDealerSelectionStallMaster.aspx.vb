...
Public Class PopUpDealerSelectionStallMaster
...
#Region " Event Hendler "
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If Not IsNothing(CStr(Request.QueryString("Group"))) Then
                ViewState.Add("Group", CStr(Request.QueryString("Group")))
                ViewState.Add("Dealer", CStr(Request.QueryString("Dealer")))
            End If
    ...
    Public Sub BindSearch()
        ...
        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "OrganizationBranchType", MatchType.InSet, "(" & "1, 2, 3, 4, 5" & ")"))

        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "ServiceFlag", MatchType.Exact, 1))
