<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpWSCParamBuletinNumSelection.aspx.vb" Inherits=".PopUpWSCParamBuletinNumSelection" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PopUpWSCParamBuletinNumSelection</title>
    ...
    <script language="javascript">
        function GetSelectedBuletinNum() {
            var table;
            var bcheck = false;
            table = document.getElementById("dtgBuletinNumSelection");
            var BuletinNum = '';
            for (i = 1; i < table.rows.length; i++) {
                ...
                if (CheckBox != null && CheckBox.checked) {
                    if (navigator.appName == "Microsoft Internet Explorer") {
                        if (BuletinNum == '') {
                            BuletinNum = replace(table.rows[i].cells[1].innerText, ' ', '');
                        }
                        else {
                            BuletinNum = BuletinNum + ';' + replace(table.rows[i].cells[1].innerText, ' ', '');
                        }
                        window.returnValue = BuletinNum;
                        bcheck = true;
                    }
                        ...
                        if (BuletinNum == '') {
                            BuletinNum = replace(table.rows[i].cells[1].getElementsByTagName("span")[0].innerHTML, ' ', '');
                        }
                        else {
                            BuletinNum = BuletinNum + ';' + replace(table.rows[i].cells[1].getElementsByTagName("span")[0].innerHTML, ' ', '');
                        }
                        bcheck = true;
                    }
                }
            ...
            if (bcheck) {
                window.close();
                if (navigator.appName != "Microsoft Internet Explorer")
                { opener.dialogWin.returnFunc(BuletinNum); }
            }
            else {
            ...
            <tr>
                <td>
                    <table id="Table2" cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td class="titlePage" colspan="7">Daftar - Nomor Buletin</td>
                        </tr>
                        <tr>
                    ...
                    <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                        <tr valign="top">
                            <td class="titleField" width="20%" style="height: 20px">Nomor Buletin</td>
                        ...
                        <tr>
                            <td colspan="7">
                                <div id="div1" style="overflow: auto; height: 260px">
                                    <asp:DataGrid ID="dtgBuletinNumSelection" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="2"
                                        AllowSorting="True">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn SortExpression="RecallRegNo" HeaderText="Nomor Buletin">
                                                <HeaderStyle Width="15%"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBuletinNumCode" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RecallRegNo") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                        ...
                        <tr>
                            <td align="center" colspan="7">
                                <input id="btnChoose" style="width: 60px" disabled onclick="GetSelectedBuletinNum()" type="button"
