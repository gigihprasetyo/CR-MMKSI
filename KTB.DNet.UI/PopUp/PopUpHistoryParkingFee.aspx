<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpHistoryParkingFee.aspx.vb" Inherits="PopUpHistoryParkingFee" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7">History Status Penalty Parkir</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="7">
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 150px">
							<asp:datagrid id="dgHistoryParkingFee" runat="server" Width="100%" AutoGenerateColumns="False">
