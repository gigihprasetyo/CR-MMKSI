<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpDealerSelectionEvent.aspx.vb" Inherits=".PopUpDealerSelectionEvent" %>
<%@ Register TagPrefix="cc1" Namespace="FilterCompositeControl" Assembly="FilterCompositeControl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Pencarian Dealer Event</title>
				...
				<tr>
					<td>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR valign="top">
								<TD class="titleField" width="10%" style="HEIGHT: 20px">Nama Dealer</TD>
								<TD width="1%" style="HEIGHT: 20px">:</TD>
								<TD width="38%" style="HEIGHT: 20px"><asp:textbox id="txtDealerName" runat="server" Width="152px" ></asp:textbox></TD>
								<TD style="WIDTH: 17px; HEIGHT: 20px" width="2%"></TD>
								<TD class="titleField" width="20%" style="HEIGHT: 20px">Term Cari 1</TD>
								<TD width="1%" style="HEIGHT: 20px">:</TD>
								<TD width="30%" style="HEIGHT: 20px"><asp:textbox id="txtSearch1" runat="server" ></asp:textbox></TD>
							</TR>
							<TR valign="top">
								<TD class="titleField" style="HEIGHT: 13px">Area</TD>
								<TD style="HEIGHT: 13px">:</TD>
								<TD style="HEIGHT: 13px"><asp:listbox id="lboxGroup" runat="server" Width="100%" SelectionMode="Multiple" Rows="3"></asp:listbox></TD>
							...
							<TR>
								<TD align="center" colspan="7">
                                    <INPUT id="btnChoose" style="WIDTH: 60px" disabled type="button" runat="server"
