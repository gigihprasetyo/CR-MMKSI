<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpStatusClaimChangeCBUReturn.aspx.vb" Inherits=".PopUpStatusClaimChangeCBUReturn" %>
					...
					<TD>
						<asp:datagrid id="dgDetails" runat="server" Width="100%" AutoGenerateColumns="False" CellSpacing="1"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="OldStatus" HeaderText="Dari Status">
									<HeaderStyle CssClass="titleTableSales"></HeaderStyle>
									<ItemTemplate>
										<asp:Label id="lblOldStatus" runat="server"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn SortExpression="NewStatus" HeaderText="Ke Status">
									<HeaderStyle CssClass="titleTableSales"></HeaderStyle>
									<ItemTemplate>
								...
								<asp:TemplateColumn SortExpression="CreatedTime" HeaderText="Diproses Tanggal">
									<HeaderStyle CssClass="titleTableSales"></HeaderStyle>
									<ItemTemplate>
										<asp:Label id="lblProcessDate" runat="server" Text='<%# Format(DataBinder.Eval(Container, "DataItem.CreatedTime"), "dd/MM/yyyy HH:mm")%>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
