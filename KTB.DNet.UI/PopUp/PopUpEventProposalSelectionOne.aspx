...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpEventProposalSelectionOne.aspx.vb" Inherits="PopUpEventProposalSelectionOne" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>EVENT - &nbsp;Pencarian Proposal Event</title>
		    ...
		    for (i = 1; i < table.rows.length; i++) {
		        ...
		        if (radioBtn != null && radioBtn.checked) {
		            if (navigator.appName == "Microsoft Internet Explorer") {
		                ...
		                EventInfo = table.rows[i].cells[1].getElementsByTagName("span")[0].innerText + ";" + table.rows[i].cells[1].getElementsByTagName("span")[1].innerText + ";" + table.rows[i].cells[2].innerText;
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" colSpan="7">EVENT - &nbsp;Pencarian Proposal Event </td>
							</tr>
							<tr>
							...
							<TR valign="top">
								<TD class="titleField" width="20%">No Proposal Event</TD>
								<TD width="1%">:</TD>
								<TD width="25%"><asp:textbox id="txtEventRegNumber" runat="server" Width="172px"></asp:textbox></TD>
								<TD style="WIDTH: 17px" width="10%"></TD>
								<TD class="titleField" width="20%">Nama Proposal Event</TD>
								<TD width="1%">:</TD>
								<TD style="WIDTH: 225px" width="225"><asp:TextBox ID="txtProposalEventName" runat="server" Width="192px" /></TD>
							</TR>
							<TR valign="top">
								<TD class="titleField" width="20%">Periode Proposal</TD>
									...
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 280px">
                                        <asp:datagrid id="dtgEventProposalSelection" runat="server" Width="100%" AutoGenerateColumns="False" 
											...
											<Columns>
												...
												<asp:TemplateColumn SortExpression="EventRegNumber" HeaderText="No Proposal Event">
													<HeaderStyle Width="15%" CssClass="titleTablePromo"></HeaderStyle>
													<ItemTemplate>                                                        
								                        <asp:Label id="lblEventProposalHeaderID" style="display:none" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ID")%>'>
								                        </asp:Label>
								                        <asp:Label id="lblEventDealerHeaderID" style="display:none" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EventDealerHeader.ID")%>'>
								                        </asp:Label>
														<asp:Label id=lblEventRegNumber runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EventRegNumber")%>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:BoundColumn DataField="EventProposalName" SortExpression="EventProposalName" HeaderText="Nama Proposal Event">
