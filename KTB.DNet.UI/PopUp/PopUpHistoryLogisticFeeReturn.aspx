<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpHistoryLogisticFeeReturn.aspx.vb" Inherits="PopUpHistoryLogisticFeeReturn" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>History Status Pengembalian PPh Logistic</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7" style="HEIGHT: 17px">
						History Status Pengembalian PPh Logistic </TD>
				</TR>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 30%" class="titleField">Kode Dealer</TD>
					<TD width="1%">:</TD>
					<td style="WIDTH: 69%"><asp:Label ID="lblDealer" Runat="server"></asp:Label></td>
				</TR>
				<TR>
					<TD style="WIDTH: 30%" class="titleField">No. Reg. Bukti Potong</TD>
					<TD width="1%">:</TD>
					<td style="WIDTH: 69%"><asp:Label ID="lblNoRegBuktiPotong" Runat="server"></asp:Label></td>
				</TR>
				<TR>
					<TD style="WIDTH: 30%" class="titleField">No. Bukti Potong PPH</TD>
					<TD width="1%">:</TD>
					<td style="WIDTH: 69%"><asp:Label ID="lblNoBuktiPotong" Runat="server"></asp:Label></td>
				</TR>
				<TR>
					<TD style="WIDTH: 30%" class="titleField"></TD>
					<TD width="1%"></TD>
				...
				<TR>
					<TD colSpan="7">
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 150px">
							<asp:datagrid id="dgHistoryLogisticFeeReturn" runat="server" Width="100%" AutoGenerateColumns="False">
