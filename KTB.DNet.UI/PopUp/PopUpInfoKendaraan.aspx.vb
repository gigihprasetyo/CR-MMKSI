...
Public Class PopUpInfoKendaraan
...
#Region "Custom Method"
    ...
    Private Sub bindFreeService()
        ...
        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.ChassisMaster), "ChassisNumber", MatchType.Exact, Me.lblChassisNumber.Text))
    ...
    Private Sub SearchPMDataShort(ByVal currPageindex As Integer)
        ...
        criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.PMHeader), "ChassisMaster.ChassisNumber", MatchType.Exact, lblChassisNumber.Text))
