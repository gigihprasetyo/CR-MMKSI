<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpChassisMasterSelection.aspx.vb" Inherits="PopUpChassisMasterSelection"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 21px">Pengiriman Kendaraan - Chassis Master</td>
				</tr>
				<tr>
							...
							<asp:datagrid id="dtgChassisMaster" runat="server" Width="100%" CellPadding="3" BackColor="#CDCDCD"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="ChassisNumber" HeaderText="Nomor Rangka">
										...
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblNoRangka" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ChassisNumber") %>'>
											</asp:Label>
									...
									<%--<asp:TemplateColumn SortExpression="EngineNumber" HeaderText="Nomor Mesin">
										...
										<ItemTemplate>
											<asp:Label id="lblNoMesin" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EngineNumber") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>--%>
									<asp:TemplateColumn SortExpression="StockStatus" HeaderText="Status Stock">
										<HeaderStyle Width="20%" CssClass="titleTablePromo"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
				...
				<tr>
					<td align="center"><br>
						<INPUT id="btnChooseIndent" style="WIDTH: 60px" onclick="GetSelectedChassisIndent()" type="button"
							value="Pilih" name="btnChooseIndent" runat="server"> <INPUT id="btnChoose" style="WIDTH: 60px" disabled onclick="GetSelectedChassis()" type="button"
