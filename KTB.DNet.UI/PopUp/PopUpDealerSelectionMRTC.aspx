<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpDealerSelectionMRTC.aspx.vb" Inherits=".PopUpDealerSelectionMRTC" %>
				...
				<tr>
					<td>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 15px">Main Area</TD>
								<TD style="HEIGHT: 15px">:</TD>
								<TD style="HEIGHT: 15px">  <asp:DropDownList ID="ddlMainArea" runat="server"></asp:DropDownList></TD>
