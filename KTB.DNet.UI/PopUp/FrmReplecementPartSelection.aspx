<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmReplecementPartSelection.aspx.vb" Inherits="FrmReplecementPartSelection" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
	
		<title>FrmReplecementPartSelection</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7">Penggantian Part&nbsp;</TD>
				</TR>
				<TR>
						...
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 310px">
							<asp:datagrid id="dtgPartSelection" runat="server" Width="100%" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PartDescription" HeaderText="Item Penggantian Part">
