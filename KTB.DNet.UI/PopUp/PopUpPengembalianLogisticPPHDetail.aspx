<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpPengembalianLogisticPPHDetail.aspx.vb" Inherits="PopUpPengembalianLogisticPPHDetail" %>
...
<HTML>
	<HEAD>
		...
		{
			txtPPn.value = 0.02 * txtAmount.value;
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Status Pengembalian PPh Logistic</td>
				</tr>
				<tr>
			...
			<TABLE cellSpacing="1" cellPadding="2" width="100%" border="0">
				...
				<tr>
					<td class="titleField" style="WIDTH: 171px">Total Biaya Logistic</td>
					<td style="WIDTH: 10px">:</td>
			...
			<div id="div1" style="OVERFLOW: auto; HEIGHT: 265px"><asp:datagrid id="dgPengembalianPPH" runat="server" BackColor="#CDCDCD" Width="100%" ShowFooter="False"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="No. Debit Memo">
							...
							<ItemTemplate>
								<asp:Label id="lblDebitMemo" runat="server" NAME="lblDebitMemo" Text='<%# DataBinder.Eval(Container.DataItem, "LogisticFee.LogisticDN.DebitMemoNo" )  %>'>
								</asp:Label>
							</ItemTemplate>
							<EditItemTemplate>
						...
						<asp:TemplateColumn HeaderText="Tanggal Invoice">
							...
							<EditItemTemplate>
								<asp:Label id="lblTglInvoiceE" Runat="server"></asp:Label>
							</EditItemTemplate>
							<FooterTemplate>
								<asp:Label id="lblTglInvoiceF" Runat="server"></asp:Label>
							</FooterTemplate>
						</asp:TemplateColumn>
						
						<asp:TemplateColumn HeaderText="Biaya Logistic">
							<HeaderStyle Width="26%" CssClass="titleTableSales"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
							<ItemTemplate>
								<asp:Label id="lblAmount" runat="server" NAME="lblAmount" Text='<%# DataBinder.Eval(Container.DataItem, "LogisticFee.Amount", "{0:#,###}")%>'>
								</asp:Label>
							</ItemTemplate>
							<EditItemTemplate>
