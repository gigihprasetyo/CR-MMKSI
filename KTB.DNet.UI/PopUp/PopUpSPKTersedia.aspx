<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpSPKTersedia.aspx.vb" Inherits="PopUpSPKTersedia" smartNavigation="False" %>
				...
				if (radioBtn != null && radioBtn.checked)			
					{
						...
						{	
						    spknumber = trim(table.rows[i].cells[2].innerText) + ";" + trim(table.rows[i].cells[11].innerText) + ";" + trim(table.rows[i].cells[12].innerText) + ";" + trim(table.rows[i].cells[13].innerText) + ";" + trim(table.rows[i].cells[14].innerText) + ";" + trim(table.rows[i].cells[15].innerText) + ";" + trim(table.rows[i].cells[16].innerText) + ";" + trim(table.rows[i].cells[17].innerText);
						...
						{	
							if (spknumber == '')
							{
							    spknumber = replace(table.rows[i].cells[2].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[11].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[12].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[13].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[14].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[15].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[16].getElementsByTagName("span")[0].innerHTML, ' ', '') + ';' + replace(table.rows[i].cells[17].getElementsByTagName("span")[0].innerHTML, ' ', '');
							}
							window.close();
							opener.dialogWin.returnFunc(spknumber);
							bcheck=true;	
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 21px">SPK - Daftar SPK dengan kuota masih tersedia</td>
				</tr>
				<tr>
						...
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 310px">
							<asp:datagrid id="dtgSPK" runat="server" Width="100%" CellPadding="3" BackColor="#CDCDCD"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="Quantity" SortExpression="Quantity" HeaderText="Unit SPK">
										<HeaderStyle Width="12%" CssClass="titleTableSales"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="Faktur" SortExpression="Faktur" HeaderText="Unit Terpakai">
										<HeaderStyle Width="12%" CssClass="titleTableSales"></HeaderStyle>
									</asp:BoundColumn>
                                    ...
                                    <asp:TemplateColumn   HeaderText="Kode Cabang" SortExpression="SalesmanHeader.DealerBranch.DealerBranchCode" >
										<HeaderStyle Width="7%" CssClass=" " ></HeaderStyle>
										<ItemTemplate>
											<asp:Label id="lblCabang" runat="server" CssClass=" " >
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>

                                    <asp:TemplateColumn SortExpression="CustomerRequest.CustomerCode" HeaderText="Kode Customer">
										<HeaderStyle Width="7%" CssClass="hdd"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id="Label3x" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerRequest.CustomerCode") %>' CssClass="hdd" >
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>

                                    
                                    <asp:TemplateColumn SortExpression="CustomerRequestID" HeaderText="CustomerRequestID">
										<HeaderStyle Width="7%" CssClass="hdd"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id="Label4x" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerRequestID") %>' CssClass="hdd" >
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
