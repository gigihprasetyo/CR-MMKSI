<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpHistoryDepositABiayaParkir.aspx.vb" Inherits="PopUpHistoryDepositABiayaParkir" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>History Status Pengembalian PPh Parkir</title>
			...
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7" style="HEIGHT: 17px">
						History Status Pengembalian PPh Parkir</TD>
				</TR>
				<TR>
