...
Public Class PopUpChangeStatusHistoryDSF
...
#End Region
    ...
    Private objDomain As DSFLeasingClaim
    ...
    Sub dtgStatusChangeHistory_itemdataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs)
        If e.Item.ItemIndex <> -1 Then
            ...
            If RowData.OldStatus.ToString = "" Then
                lblStatusLama.Text = ""
            Else
                lblStatusLama.Text = CommonFunction.GetEnumDescription(RowData.OldStatus, "EnumDSFClaim.ClaimStatus")
            End If
            ...
            If RowData.NewStatus.ToString = "" Then
                lblStatusBaru.Text = ""
            Else
                lblStatusBaru.Text = CommonFunction.GetEnumDescription(RowData.NewStatus, "EnumDSFClaim.ClaimStatus")
            End If
