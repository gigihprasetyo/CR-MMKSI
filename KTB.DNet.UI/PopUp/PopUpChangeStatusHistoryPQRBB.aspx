<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpChangeStatusHistoryPQRBB.aspx.vb" Inherits="PopUpChangeStatusHistoryPQRBB" smartNavigation="False" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<TR>
					...
					<TD width="1%">:</TD>
					<TD width="60%">
						<asp:Label id="Label2" runat="server">Product Quality Report Special</asp:Label></TD>
				</TR>
				<TR>
					<TD class="titleField" width="40%">
						<asp:Label id="lblNoPQR" runat="server">Nomor PQR</asp:Label></TD>
					<TD width="1%">:</TD>
					<TD>
						<asp:Label id="lblNoPQRVal" runat="server"></asp:Label></TD>
				</TR>
						...
						<asp:DataGrid id="dtgStatusChangeHistory" runat="server" AutoGenerateColumns="False" Width="100%"
							...
							<Columns>
								<asp:TemplateColumn HeaderText="No">
									<HeaderStyle HorizontalAlign="Center" Width="2%" CssClass="titleTableService"></HeaderStyle>
								...
								<asp:TemplateColumn HeaderText="Status Lama">
									<HeaderStyle HorizontalAlign="Center" Width="18%" CssClass="titleTableService"></HeaderStyle>
								...
								<asp:BoundColumn DataField="CreatedTime" HeaderText="Diproses Tanggal" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}">
									<HeaderStyle HorizontalAlign="Center" Width="26%" CssClass="titleTableService"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
