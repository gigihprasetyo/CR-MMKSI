<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpPartConfirmationList.aspx.vb" Inherits=".PopUpPartConfirmationList" %>
		...
		<script language="javascript">
		    ...
		    function GetSelectedPart() {
		        ...
		        if (bcheck) {
		            ...
		            alert("Silahkan Pilih Nomor part terlebih dahulu");
		        }
		    }
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" height="20">&nbsp;&nbsp;SPAREPART - Daftar Part</td>
							</tr>
							<tr>
