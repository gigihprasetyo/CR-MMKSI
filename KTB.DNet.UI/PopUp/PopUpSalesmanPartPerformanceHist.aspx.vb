...
Imports KTB.DNet.BusinessFacade.Salesman
    ...
    Public Class PopUpSalesmanPartPerformanceHist
...
#End Region
        ...
        Dim objSalesmanPartPerformance As New SalesmanPartPerformance
        objSalesmanPartPerformance = New SalesmanPartPerformanceFacade(User).Retrieve(CInt(Request.QueryString("Id")))
        If Not IsNothing(objSalesmanPartPerformance) Then
            lblDealerCode.Text = objSalesmanPartPerformance.SalesmanHeader.Dealer.DealerCode
            lblSalesmanCode.Text = objSalesmanPartPerformance.SalesmanHeader.SalesmanCode
            lblSalesmanName.Text = objSalesmanPartPerformance.SalesmanHeader.Name
            BindDataGrid(0)
        End If
    End Sub
    ...
    Public Sub BindDataGrid(ByVal IndexPage As Integer)
        ...
        criterias.opAnd(New Criteria(GetType(SalesmanPartPerformanceHist), "SalesmanPartPerformance.ID", MatchType.Exact, CInt(Request.QueryString("Id"))))
        _arrList = New SalesmanPartPerformanceHistFacade(User).RetrieveByCriteria(criterias, IndexPage + 1, dgHistory.PageSize, totalRow, CType(ViewState("currentSortColumn"), String), CType(ViewState("currentSortDirection"), Sort.SortDirection))
