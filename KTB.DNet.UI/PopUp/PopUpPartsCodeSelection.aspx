<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpPartsCodeSelection.aspx.vb" Inherits="PopUpPartsCodeSelection" smartNavigation="False" %>
					...
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD style="HEIGHT: 22px" width="1%">:</TD>
								<TD style="HEIGHT: 22px" width="25%"><asp:textbox id="txtModel" runat="server" Width="152px"></asp:textbox></TD>
							</TR>
							<TR>
										...
										<asp:datagrid id="dtgParts" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="Horizontal"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Model">
													...
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ModelCode") %>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
