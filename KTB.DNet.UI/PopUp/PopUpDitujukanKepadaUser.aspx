<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpDitujukanKepadaUser.aspx.vb" Inherits="PopUpDitujukanKepadaUser" smartNavigation = "False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage"><asp:Label ID="lblTitle" Runat="server" CssClass="titlePage"></asp:Label></td>
				</tr>
				<tr>
				...
				<TR>
					<TD height="40" align="center">
						<asp:Panel ID="pnlForum" Runat="server"><INPUT id="btnChoose" style="WIDTH: 60px" onclick="GetSelectedMemberMany()" type="button"
								value="Pilih" name="btnChoose">&nbsp;<INPUT id="btnCancel" style="WIDTH: 60px" onclick="window.close()" type="button" value="Tutup"
								name="btnCancel">
					</asp:Panel>
						<asp:Panel ID="pnlBuletinButton" Runat="server">
