<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpSalesmanPartPerformanceHist.aspx.vb" Inherits="PopUpSalesmanPartPerformanceHist" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD class="titlePage" colSpan="7">History Performance Salesman Part</TD>
				</TR>
				<TR>
						...
						<DIV id="div1" style="OVERFLOW: auto; HEIGHT: 150px">
							<asp:datagrid id="dgHistory" runat="server" Width="100%" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Harga Cost Penjualan" SortExpression="HargaPokok">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemStyle Wrap="False" HorizontalAlign="right"></ItemStyle>
										<ItemTemplate>
											<asp:Label id=lblTarget runat="server" Text='<%# String.Format("{0:#,###}",DataBinder.Eval(Container, "DataItem.HargaPokok")) %>'></asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="Harga Retail Penjualan" SortExpression="HargaJual">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemStyle Wrap="False" HorizontalAlign="right"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblRealisasi" runat="server" Text='<%# String.Format("{0:#,###}",DataBinder.Eval(Container, "DataItem.HargaJual")) %>'></asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="Profit" SortExpression="Profit">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemStyle Wrap="False" HorizontalAlign="right"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="lblProfit" runat="server" Text='<%# String.Format("{0:#,###}",DataBinder.Eval(Container, "DataItem.Profit")) %>'></asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="Prosentase (%)" SortExpression="Percentage">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemStyle Wrap="False" HorizontalAlign="right"></ItemStyle>
										<ItemTemplate>
