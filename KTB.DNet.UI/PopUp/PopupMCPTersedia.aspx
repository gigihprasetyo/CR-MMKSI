<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopupMCPTersedia.aspx.vb" Inherits=".PopupMCPTersedia" smartNavigation="False"%>
	...
	<HEAD>
		...
		<script language="javascript">
		    ...
		    function GetSelectedMCP() {
		        var table;
		        var bcheck = false;
		        table = document.getElementById("dtgMCP");
		        var mcpnumber = '';
		        ...
		        for (i = 1; i < table.rows.length; i++) {
		            ...
		            if (radioBtn != null && radioBtn.checked) {
		                if (navigator.appName == "Microsoft Internet Explorer") {
		                    mcpnumber = trim(table.rows[i].cells[1].innerText) + ";" + trim(table.rows[i].cells[2].innerText);
		                    window.returnValue = mcpnumber;
		                    bcheck = true;
		                    break;
		                }
		                else {
		                    if (mcpnumber == '') {
		                        mcpnumber = replace(table.rows[i].cells[1].innerHTML, '', '') + ';' + replace(table.rows[i].cells[2].getElementsByTagName("span")[0].innerHTML, ' ', '');
		                    }
		                    window.close();
		                    opener.dialogWin.returnFunc(mcpnumber);
		                    bcheck = true;
		                    break;
		                }
		            }
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 21px">MCP - Daftar MCP dengan kuota masih tersedia</td>
				</tr>
				<tr>
				...
				<TR>
					<TD align="left">
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								<TD class="titleField" width="91" style="WIDTH: 140px">Nomor MCP</TD>
								<TD width="1%">:</TD>
								<TD width="75%"><asp:textbox id="txtMCPNumber" onkeypress="return alphaNumericExcept(event,'<>?*%$;')" onblur="omitSomeCharacter('txtMCPNumber','<>?*%$;')"
				...
				<tr>
					<TD colSpan="7">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 310px">
							<asp:datagrid id="dtgMCP" runat="server" Width="100%" CellPadding="3" BackColor="#CDCDCD"
				...
				<TR>
					<TD align="center" colSpan="7">
						<INPUT id="btnChoose" style="WIDTH: 60px" onclick="GetSelectedMCP()" type="button"
