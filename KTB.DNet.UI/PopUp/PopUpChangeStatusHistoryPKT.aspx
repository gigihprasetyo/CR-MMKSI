<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpChangeStatusHistoryPKT.aspx.vb" Inherits=".PopUpChangeStatusHistoryPKT" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				...
				<TR>
					<TD class="titleField">
						<asp:Label id="lblNoRegDokumen" runat="server">Chassis Master</asp:Label></TD>
					<TD>:</TD>
					<TD>
					...
					<TD colSpan="4">
						<asp:DataGrid id="dtgStatusChangeHistory" runat="server" AutoGenerateColumns="False" Width="100%"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="OldDate" HeaderText="Data Lama">
									<HeaderStyle HorizontalAlign="Center" Width="18%" CssClass="titleTableSales"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="NewDate" HeaderText="Data Baru">
									<HeaderStyle HorizontalAlign="Center" Width="18%" CssClass="titleTableSales"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
