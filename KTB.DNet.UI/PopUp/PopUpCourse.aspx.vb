...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtSelectedIndex As Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents ddlJobPositionCategory As System.Web.UI.WebControls.DropDownList
    Protected WithEvents ddlPaymentType As System.Web.UI.WebControls.DropDownList
    Protected WithEvents rowCategory As System.Web.UI.HtmlControls.HtmlTableRow
...
#End Region
    ...
    Private ReadOnly Property AreaID As String
        Get
            Select Case Request.QueryString("category").ToString().ToLower()
                Case String.Empty
                    Return "2"
                Case "sales"
                    Return "1"
    ...
    Private Sub FillDropDownPaymentType()
        ddlPaymentType.Items.Clear()
        Dim listItem As New ListItem("Silakan Pilih", "-1")
        ddlPaymentType.Items.Add(listItem)

        listItem = New ListItem(EnumTrCourse.GetPaymentStringValue(EnumTrCourse.PaymentType.FREE), EnumTrCourse.PaymentType.FREE)
        ddlPaymentType.Items.Add(listItem)

        listItem = New ListItem(EnumTrCourse.GetPaymentStringValue(EnumTrCourse.PaymentType.CHARGE), EnumTrCourse.PaymentType.CHARGE)
        ddlPaymentType.Items.Add(listItem)
    ...
    Public Function CriteriaSearch() As CriteriaComposite
        ...
        If ddlJobPositionCategory.SelectedValue <> "-1" Then
            criterias.opAnd(New Criteria(GetType(TrCourse), "JobPositionCategory.ID", MatchType.Exact, ddlJobPositionCategory.SelectedValue))
        End If

        If ddlPaymentType.SelectedValue <> "-1" Then
            criterias.opAnd(New Criteria(GetType(TrCourse), "PaymentType", MatchType.Exact, ddlPaymentType.SelectedValue))
        End If
        ...
        criterias.opAnd(New Criteria(GetType(TrCourse), "JobPositionCategory.AreaID", MatchType.Exact, AreaID))
    ...
    Private Sub dtgDealerSelection_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgCourseSelection.ItemDataBound
        ...
        If Not e.Item.DataItem Is Nothing Then
            ...
            If ItemType = ListItemType.Item Or ItemType = ListItemType.AlternatingItem Then
                ...
                If Not IsNothing(RowValue.PaymentType) Then
                    lblPaymentType.Text = EnumTrCourse.GetPaymentStringValue(RowValue.PaymentType)
                End If
