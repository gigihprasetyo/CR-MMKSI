...
Public Class PopUpDealerBranchEventMultipleSelection
...
#Region " Event Hendler "
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If (Not IsNothing(Request.QueryString("DealerCode")) AndAlso Request.QueryString("DealerCode").ToString() <> "") Then
                If objDealer.Title = EnumDealerTittle.DealerTittle.KTB OrElse 1 = 1 Then
            ...
            If Not objDealer.DealerGroup Is Nothing OrElse objDealer.Title = EnumDealerTittle.DealerTittle.KTB Then
                BindDdlGroup()
            End If
            If Request.QueryString("f") = "event" Then
                hdnBabitEvent.Value = "event"
                txtDealerCode.Enabled = False
                hdnDealerBranchCode.Value = Request.QueryString("DealerCode")
                If txtDealerCode.Text <> String.Empty OrElse hdnDealerBranchCode.Value <> String.Empty Then
    ...
    Public Sub BindSearch()
        ...
        Else
            criterias.opAnd(New Criteria(GetType(KTB.DNet.Domain.Dealer), "OrganizationBranchType", MatchType.Exact, CInt(EnumOrganizationBranchType.EnumOrgBranchType.TempOutlet).ToString()))
        End If
    ...
    Private Sub dtgDealerSelection_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dtgDealerSelection.ItemDataBound
        ...
        If Not e.Item.DataItem Is Nothing Then
            ...
            If ItemType = ListItemType.Item Or ItemType = ListItemType.AlternatingItem Then
                ...
                If hdnDealerBranchCode.Value.Contains(RowValue.DealerCode) Then
