<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpStatusChangeBabitProposal.aspx.vb" Inherits="PopUpStatusChangeBabitProposal" smartNavigation="False"%>
					...
					<TD>
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								...
								<TD class="titleField">
									<asp:Label id="lblNoDucument" runat="server"></asp:Label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
						...
						<asp:datagrid id="dgDetails" runat="server" Width="100%" AutoGenerateColumns="False" CellSpacing="1"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="CreatedTime" HeaderText="Diproses Tanggal">
									<HeaderStyle CssClass="titleTableParts"></HeaderStyle>
									<ItemTemplate>
										<asp:Label id="lblProcessDate" runat="server" Text='<%# Format(DataBinder.Eval(Container, "DataItem.CreatedTime"),"dd/MM/yyyy HH:mm:ss") %>'>
										</asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
