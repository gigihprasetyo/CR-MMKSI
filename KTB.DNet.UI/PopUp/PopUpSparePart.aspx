...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpSparePart.aspx.vb" Inherits="PopUpSparePart" SmartNavigation="False" %>
            ...
            for (i = 1; i < table.rows.length; i++) {
                ...
                if (radioButton != null && radioButton.checked) {
                    ...
                    if (navigator.appName == "Microsoft Internet Explorer") {
                        ...
                        partModel = replace(table.rows[i].cells[3].innerText, ' ', '');
                        retailPrice = replace(table.rows[i].cells[4].innerText, '.', '');
                        id = replace(table.rows[i].cells[5].innerText, ' ', '');
                        ...
                        partModel = table.rows[i].cells[3].getElementsByTagName("SPAN")[0].innerHTML;
                        retailPrice = replace(table.rows[i].cells[4].getElementsByTagName("SPAN")[0].innerHTML, '.', '');
                        id = table.rows[i].cells[5].getElementsByTagName("SPAN")[0].innerHTML;
                        partName = replace(partName, ';', ',');
                        opener.dialogWin.returnFunc(partNumber + ";" + partName + ";" + retailPrice + ";" + Hidden1.value + ";" + partModel + ";" + id);
                    }
                    find = true;
                                ...
                                <div id="div1" style="height: 350px; overflow: auto">
                                    <asp:DataGrid ID="dtgSparePart" runat="server" PageSize="20" AllowSorting="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn SortExpression="ID" HeaderText="ID" ItemStyle-CssClass="HiddenCol">
