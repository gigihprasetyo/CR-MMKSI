<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpPositionCode.aspx.vb" Inherits="PopUpPositionCode"  smartNavigation="False" %>
	...
	<HEAD>
		...
		function getSelectedCourse()
		{
			...
			if (bcheck)
			  ...
			  {
				alert("Silahkan pilih kode posisi");	
			  }	
		}
		</script>
	</HEAD>
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD colSpan="7">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 350px"><asp:datagrid id="dtgPosisi" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="Horizontal"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="KodePosition" SortExpression="KodePosition" HeaderText="Kode Posisi">
