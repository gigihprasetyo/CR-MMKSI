<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpCreditAccountSelection2.aspx.vb" Inherits="PopUpCreditAccountSelection2"%>
				...
				<tr>
					<td>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								<TD colSpan="7">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 260px"><asp:datagrid id="dtgDealerSelection" runat="server" Width="100%" AutoGenerateColumns="False"
											CellPadding="2" AllowSorting="True">
