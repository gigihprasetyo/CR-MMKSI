<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpSAPRegisterSalesman.aspx.vb" Inherits="PopUpSAPRegisterSalesman" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Daftar Salesman</title>
			...
			for (i = 1; i < table.rows.length; i++)
			{
				...
				if (RadioButton != null && RadioButton.checked)
				{
					if(navigator.appName == "Microsoft Internet Explorer")
					  {
					    retVal = table.rows[i].cells[1].innerText + ';' + table.rows[i].cells[2].innerText + ';' + table.rows[i].cells[3].innerText + ';' + table.rows[i].cells[4].innerText+ ';' + table.rows[i].cells[5].innerText +';' + table.rows[i].cells[6].innerText;
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" style="HEIGHT: 18px" colSpan="7">Salesman</td>
							</tr>
							<tr>
