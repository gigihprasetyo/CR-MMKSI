...
Public Class PopUpChangeStatusHistorySV
...
#End Region
    ...
    Sub dtgStatusChangeHistory_itemdataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs)
        If e.Item.ItemIndex <> -1 Then
            ...
            ElseIf CInt(Request.QueryString("DocType")) = LookUp.DocumentType.Estimation_Equip Then
                If arrListStatusChangeHistory(e.Item.ItemIndex).OldStatus <> -1 Then
                    e.Item.Cells(2).Text = CType(arrListStatusChangeHistory(e.Item.ItemIndex).OldStatus, EnumEstimationEquipStatus.EstimationEquipStatusHeader).ToString
                Else
                    e.Item.Cells(2).Text = ""
                End If
                e.Item.Cells(3).Text = CType(arrListStatusChangeHistory(e.Item.ItemIndex).NewStatus, EnumEstimationEquipStatus.EstimationEquipStatusHeader).ToString
            End If
