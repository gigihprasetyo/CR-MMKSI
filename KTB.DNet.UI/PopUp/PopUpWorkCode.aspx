<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpWorkCode.aspx.vb" Inherits="PopUpWorkCode"  smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>PopUpWorkCode</title>
		...
		function getSelectedCourse()
		{
			var table;
			var bcheck =false;
			table = document.getElementById("dtgKerja");
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="titleField" style="HEIGHT: 22px" width="20%">Kode&nbsp;Kerja</TD>
								<TD style="HEIGHT: 22px" width="1%">:</TD>
								<TD style="HEIGHT: 22px" width="25%"><asp:textbox id="txtKodeKerja" runat="server" Width="152px"></asp:textbox></TD>
							...
							<TR>
								<TD colSpan="7">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 350px"><asp:datagrid id="dtgKerja" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="Horizontal"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="KodeKerja" SortExpression="KodeKerja" HeaderText="Kode Kerja">
							...
							<TR>
								<TD colspan=7 align=center><INPUT id="btnChoose" style="WIDTH: 60px" onclick="getSelectedCourse()" type="button"
