...
Public Class PopUpMaterialPromotionforRequest
...
#End Region
    ...
    Public Sub CreateCriteria()
        ...
        criterias.opAnd(New Criteria(GetType(MaterialPromotion), "Status", MatchType.Exact, CType(New EnumMaterialPromotion().MasterMaterialPromotionStatus.Aktif, Integer)))
