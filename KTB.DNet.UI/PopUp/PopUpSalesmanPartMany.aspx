<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpSalesmanPartMany.aspx.vb" Inherits="PopUpSalesmanPartMany" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Salesman Part</title>
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" style="HEIGHT: 18px" colSpan="7">Part Employee</td>
							</tr>
							<tr>
