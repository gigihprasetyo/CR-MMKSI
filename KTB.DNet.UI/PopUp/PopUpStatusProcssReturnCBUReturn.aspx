<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpStatusProcssReturnCBUReturn.aspx.vb" Inherits=".PopUpStatusProcssReturnCBUReturn" %>
						...
						<asp:datagrid id="dgDetails" runat="server" Width="100%" AutoGenerateColumns="False" CellSpacing="1"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Proses">
									...
									<ItemTemplate>
										<asp:Label id="lblProses" runat="server"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
