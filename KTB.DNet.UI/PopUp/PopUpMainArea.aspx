<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpMainArea.aspx.vb" Inherits="PopUpMainArea" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
	
		<title>PopUpMainArea</title>
		...
		{
		    var table;
		    table = document.getElementById("dtgMainArea");
		    var find = false;
		    for (i = 1; i < table.rows.length; i++) {
		        ...
		        if (radioButton != null && radioButton.checked) {
		            if (navigator.appName == "Microsoft Internet Explorer") {
		                area = table.rows[i].cells[1].innerText;
		    ...
		    if (find)
		        ...
		        alert("Silahkan pilih Main Area");
		}
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Selection - Main Area</td>
				</tr>
				<tr>
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 390px"><asp:datagrid id="dtgMainArea" runat="server" Width="100%" GridLines="None" CellPadding="3" BackColor="#E0E0E0"
								...
								<Columns>
									<asp:TemplateColumn>
										...
										<ItemTemplate>
											...
											<%--<asp:RadioButton id="chkItemChecked" runat="server"></asp:RadioButton>--%>
										</ItemTemplate>
									</asp:TemplateColumn>
