<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpDealerHistorySelection.aspx.vb" Inherits="PopUpDealerHistorySelection" smartNavigation="False"%>
<%@ Register TagPrefix="cc1" Namespace="FilterCompositeControl" Assembly="FilterCompositeControl" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>

		<title>FrmDealerHistorySelection</title>
				...
				<tr>
					<td>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								<TD align="center" colspan="7"><INPUT id="btnChoose" style="WIDTH: 60px" onclick="GetSelectedDealer()" type="button"
