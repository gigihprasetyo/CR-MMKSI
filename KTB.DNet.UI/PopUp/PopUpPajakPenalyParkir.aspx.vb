...
Public Class PopUpPajakPenalyParkir
...
#End Region
    ...
    Private objPFRH As ParkingFeeReturnHeader
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If Not IsNothing(Request.QueryString("id")) Then
                ...
                objPFRH = New ParkingFeeReturnHeaderFacade(User).Retrieve(CType(Request.QueryString("id"), Integer))
    ...
    Private Sub MapToScreen(ByVal objPFRH As ParkingFeeReturnHeader)
        ...
        lblNilai1.Text = objPFRH.TotalAmount.ToString("#,##0")
        lblNilai2.Text = objPFRH.PPHAmount.ToString("#,##0")
        lblPPH.Text = String.Format("{0}%", CInt(CalcHelper.GetPercentage(objPFRH.PPHAmount, objPFRH.TotalAmount)))
    ...
    Private Sub btnSimpan_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSimpan.ServerClick
        objPFRH = CType(sessHelper.GetSession("PFRHFAKTURPAJAK"), ParkingFeeReturnHeader)
        If Not IsNothing(objPFRH) AndAlso objPFRH.ID > 0 Then
            objPFRH.KantorPajak = txtKtrPajak.Value
            objPFRH.KotaDealer = txtKota.Value
            objPFRH.Pejabat = txtPejabat.Value
            objPFRH.Jabatan = txtJabatan.Value
            Dim iReturn As Integer = New KTB.DNet.BusinessFacade.FinishUnit.ParkingFeeReturnHeaderFacade(User).Update(objPFRH)
