...
Public Class PopUpSalesmanPart
...
#End Region
    ...
    Private Sub CreateCriteriaSearch()
        ...
        End If
        If Val(Request.QueryString("IsSales")) = 1 Then
            'CR 20 -05 -2015
            Dim FIlterSales As String = KTB.DNet.Lib.WebConfig.GetValue("PartSalesmanPosisi")

            '  Dim strSql As String = "( Select ID from V_SalesmanPart where V_SalesmanPart.PosisiID = 12 and RowStatus = 0 )"
            Dim strSql As String = "( Select ID from V_SalesmanPart where V_SalesmanPart.PosisiID IN (" & FIlterSales & ")   and RowStatus = 0 )"
