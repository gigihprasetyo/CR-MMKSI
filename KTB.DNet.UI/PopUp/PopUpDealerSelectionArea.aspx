<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpDealerSelectionArea.aspx.vb" Inherits=".PopUpDealerSelectionArea" smartNavigation="False"%>
				...
				<tr>
					<td>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR valign="top">
								<TD class="titleField" style="HEIGHT: 13px" rowspan="2">Grup</TD>
								<TD style="HEIGHT: 13px" rowspan="2">:</TD>
								<TD style="HEIGHT: 13px" rowspan="2"><asp:listbox id="lboxGroup" runat="server" Width="152px" SelectionMode="Multiple" Rows="3"></asp:listbox></TD>
							...
							<TR valign="top">
								...
								<TD style="HEIGHT: 15px">Area 1</TD>
								<TD style="HEIGHT: 15px">:</TD>
								<TD style="WIDTH: 17px; HEIGHT: 15px"><asp:listbox id="lboxArea1" runat="server" Width="152px" SelectionMode="Multiple" Rows="3"></asp:listbox></TD>
