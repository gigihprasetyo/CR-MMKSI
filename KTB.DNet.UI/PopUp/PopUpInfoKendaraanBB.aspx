<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopUpInfoKendaraanBB.aspx.vb" Inherits="PopUpInfoKendaraanBB" smartNavigation="False"%>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
				...
				<TR>
					...
					<TD width="1%">:</TD>
					<TD width="75%" colSpan="4"><asp:label id="lblChassisNumber" runat="server"></asp:label></TD>
				</TR>
				<TR>
					<TD class="titleField" width="24%">Model / Tipe / Warna</TD>
					<TD width="1%">:</TD>
					<TD width="25%"><asp:label id="lblMaterial" runat="server"></asp:label></TD>
					<TD class="titleField" width="20%">No Serial</TD>
					<TD width="1%">:</TD>
					<TD width="29%"><asp:label id="lblNoSerial" runat="server"></asp:label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="titleField" style="HEIGHT: 18px">Dealer Pelaksana PDI</TD>
					<TD style="HEIGHT: 18px">:</TD>
					<TD style="HEIGHT: 18px"><asp:label id="lblDealerPDI" runat="server"></asp:label></TD>
