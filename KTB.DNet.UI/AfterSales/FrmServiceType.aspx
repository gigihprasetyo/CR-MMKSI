<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmServiceType.aspx.vb" Inherits="FrmServiceType" smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmServiceType</title>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Master - Layanan</td>
				</tr>
				<tr>
				...
				<TR>
					<TD>
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
							<TR>
								<TD class="titleField" width="24%">Tipe Layanan</TD>
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtServiceTypeCode)" id="txtServiceTypeCode"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="rfvKode" runat="server" ErrorMessage="*" ControlToValidate="txtServiceTypeCode" InitialValue=" "
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgServiceType" runat="server" Width="100%" PageSize="25" AllowCustomPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="ServiceTypeCode" HeaderText="Kode Layanan">
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id=Label1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ServiceTypeCode")%>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
