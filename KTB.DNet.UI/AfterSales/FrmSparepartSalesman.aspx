<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmSparepartSalesman.aspx.vb" Inherits="FrmSparepartSalesman" smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmEmailUser</title>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Master - Sparepart Salesman</td>
				</tr>
				<tr>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
                            ...
                            <TR>
								...
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtKode)" id="txtKode"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="rfvKode" runat="server" ErrorMessage="*" ControlToValidate="txtKode" InitialValue=" "
										Width="16px" EnableClientScript="False"></asp:requiredfieldvalidator></td>
							</TR>
                             <TR>
								<TD class="titleField" width="24%">Kode Salesman</TD>
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtKodeSalesman)" id="txtKodeSalesman"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="Requiredfieldvalidator3" runat="server" ErrorMessage="*" ControlToValidate="txtKodeSalesman" InitialValue=" "
										Width="16px" EnableClientScript="False"></asp:requiredfieldvalidator></td>
							</TR>
                            <TR>
							...
							<TR>
								<TD class="titleField" width="24%">Position</TD>
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtPosition)" id="txtPosition"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" ErrorMessage="*" ControlToValidate="txtPosition" InitialValue=" "
										Width="16px" EnableClientScript="False"></asp:requiredfieldvalidator></td>
							</TR>
							<TR>
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgSparepartSalesman" runat="server" Width="100%" PageSize="25" AllowCustomPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="ID" HeaderText="Kode">
										<HeaderStyle Width="10%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
                                    ...
                                    <asp:TemplateColumn SortExpression="SalesmanCode" HeaderText="Kode Salesman">
										<HeaderStyle Width="10%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SalesmanCode")%>' ID="Label8" NAME="Label8">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Name" HeaderText="Nama">
                                    	...
                                    	<asp:TemplateColumn SortExpression="City" HeaderText="Kota">
										<HeaderStyle Width="15%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.City")%>' ID="Label5" NAME="Label5">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
                                    <asp:TemplateColumn SortExpression="JobPosition.Description" HeaderText="Position">
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JobPosition.Description")%>' ID="Label7" NAME="Label7">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
                                    <asp:TemplateColumn SortExpression="Status" HeaderText="Status">
										<HeaderStyle Width="10%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='Aktif' ID="Label6" NAME="Label6">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
