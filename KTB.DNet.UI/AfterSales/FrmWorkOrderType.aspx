<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmWorkOrderType.aspx.vb" Inherits="FrmWorkOrderType" smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmWorkOrderType</title>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Master - Tipe Work Order</td>
				</tr>
				<tr>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
							<TR>
								...
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtWorkOrderType)" id="txtWorkOrderType"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server" ErrorMessage="*" ControlToValidate="txtWorkOrderType" InitialValue=" "
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgWorkOrderType" runat="server" Width="100%" PageSize="25" AllowCustomPaging="True"
								AllowPaging="True" CellSpacing="1" ToolTip="Work Order Type" AutoGenerateColumns="False" CellPadding="3" GridLines="None" BackColor="#E0E0E0"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="WorkOrderType" HeaderText="Tipe Work Order">
                                        ...
                                        <ItemStyle horizontalalign="Center"/>
                                        <ItemTemplate>
											<asp:Label id=Label4 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.WorkOrderType")%>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
            ...
            <INPUT id="hdnActivate" type="hidden" runat="server" name="hdnActivate">
            <INPUT id="hdnDeactivate" type="hidden" runat="server" name="hdnDeactivate">
		</form>
