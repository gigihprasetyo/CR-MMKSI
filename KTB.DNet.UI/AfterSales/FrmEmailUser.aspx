<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmEmailUser.aspx.vb" Inherits="FrmEmailUser" smartNavigation="False" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Master - Email User</td>
				</tr>
				<tr>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
							...
							<TR>
								...
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtEmail)" id="txtEmail"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="rfvKode" runat="server" ErrorMessage="*" ControlToValidate="txtEmail" InitialValue=" "
										Width="16px" EnableClientScript="False"></asp:requiredfieldvalidator></td>
							</TR>
							<TR>
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgEmailUser" runat="server" Width="100%" PageSize="25" AllowCustomPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="DealerPosition" HeaderText="Dealer Position">
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DealerPosition")%>' ID="Label2" NAME="Label2">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Name" HeaderText="Nama">
										...
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Email")%>' ID="Label5" NAME="Label5">
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
