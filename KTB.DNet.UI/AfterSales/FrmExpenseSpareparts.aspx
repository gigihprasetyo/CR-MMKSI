<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmExpenseSpareparts.aspx.vb" Inherits="FrmExpenseSpareparts" smartNavigation="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<%@ Register TagPrefix="cc1" Namespace="KTB.DNet.WebCC" Assembly="KTB.DNet.WebCC" %>

<HTML>
	<HEAD>
		<title>FrmExpenseSpareParts</title>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Data Upload - Dealer Expense Spareparts</td>
				</tr>
				<tr>
					...
					<TD>
						...
						<TR>
                            ...
                            <TR>
                                ...
                                <TD style="WIDTH: 150px"><asp:label id="Label3" runat="server">V. Total Biaya Umum</asp:label>&nbsp;</TD>
                             ...
                             <TR>
                                ...
                                <TD style="WIDTH: 150px"><asp:label id="Label2" runat="server">VI. Total Biaya Bunga</asp:label>&nbsp;</TD>
								<TD style="WIDTH: 12px">:</TD>
                                <TD><asp:label id="lblTotalBiayaBunga" runat="server" Font-Bold="True"></asp:label></TD>
							</TR>
                             <TR>
                                ...
                                <TD style="WIDTH: 150px"><asp:label id="Label1" runat="server">VII. Total Saldo Piutang</asp:label>&nbsp;</TD>
								<TD style="WIDTH: 12px">:</TD>
                                <TD><asp:label id="lblTotalSaldoPiutang" runat="server" Font-Bold="True"></asp:label></TD>
							</TR>
                            <TR>
								<TD width="150px">IV. Total Biaya Penyusutan</TD>
								<TD width="1%">:</TD>
								<TD><asp:label id="lblTotalBiayaPenyusutan" runat="server" Font-Bold="True"></asp:label></TD>
                                <TD style="WIDTH: 150px"><asp:label id="Label4" runat="server">VIII. Total Pembayaran Piutang</asp:label>&nbsp;</TD>
								<TD style="WIDTH: 12px">:</TD>
                                <TD><asp:label id="lblTotalPembayaranPiutang" runat="server" Font-Bold="True"></asp:label></TD>
							</TR>
							<TR>
				...
				<TR>
					<TD>
                        <br>
                        <b>LAMPIRAN TARGET DEALER SALES</b><br>
                            A. TARGET DEALER
            ...
            <TR>
                <TD>
                    <br>
                        <b>LAMPIRAN REALISASI BIAYA SPAREPART</b><br>
                            I. BIAYA KARYAWAN
            ...
            <TR>
                <TD>
                    <br>
                            VI. BIAYA BUNGA
                            <div id="divBunga"   ><asp:datagrid id="dtgBiayaBunga" runat="server" Width="45%"  PageSize="100" AllowCustomPaging="True"
								AllowPaging="True" CellSpacing="1" ToolTip="Module" AutoGenerateColumns="False" CellPadding="3" GridLines="None" BackColor="#E0E0E0"
								BorderWidth="0px" BorderStyle="None" BorderColor="#E0E0E0" AllowSorting="True" ShowFooter="True">
								<SelectedItemStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#738A9C"></SelectedItemStyle>
								<ItemStyle ForeColor="Black" BackColor="White"></ItemStyle>
             ...
             <TR>
                <TD>
                    <br>
                            VII. SALDO PIUTANG SAMPAI AKHIR BULAN
                            <div id="divPiutang"   ><asp:datagrid id="dtgSaldoPiutang" runat="server" Width="45%"  PageSize="100" AllowCustomPaging="True"
								AllowPaging="True" CellSpacing="1" ToolTip="Module" AutoGenerateColumns="False" CellPadding="3" GridLines="None" BackColor="#E0E0E0"
								BorderWidth="0px" BorderStyle="None" BorderColor="#E0E0E0" AllowSorting="True" ShowFooter="True">
								<SelectedItemStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#738A9C"></SelectedItemStyle>
								<ItemStyle ForeColor="Black" BackColor="White"></ItemStyle>
            ...
            <TR>
                <TD>
                    <br>
                            VIII. SALDO PEMBAYARAN PIUTANG SAMPAI AKHIR BULAN
                            <div id="divPembayarangPiutang"   ><asp:datagrid id="dtgPembayaranPiutang" runat="server" Width="45%"  PageSize="100" AllowCustomPaging="True"
								AllowPaging="True" CellSpacing="1" ToolTip="Module" AutoGenerateColumns="False" CellPadding="3" GridLines="None" BackColor="#E0E0E0"
								BorderWidth="0px" BorderStyle="None" BorderColor="#E0E0E0" AllowSorting="True" ShowFooter="True">
								<SelectedItemStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#738A9C"></SelectedItemStyle>
								<ItemStyle ForeColor="Black" BackColor="White"></ItemStyle>
