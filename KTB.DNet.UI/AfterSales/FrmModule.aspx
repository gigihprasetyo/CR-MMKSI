<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmModule.aspx.vb" Inherits="FrmModule" smartNavigation="False" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">Master - Module</td>
				</tr>
				<tr>
						...
						<TABLE id="Table2" cellSpacing="2" cellPadding="2">
							<TR>
								...
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtName)" id="txtName"
										runat="server" MaxLength="50" Width="150px"></asp:textbox>&nbsp;<asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server" ErrorMessage="*" ControlToValidate="txtName" InitialValue=" "
										Width="16px" EnableClientScript="False"></asp:requiredfieldvalidator></td>
							</TR>
                            <TR>
								<TD class="titleField">Template File Name</TD>
								<TD>:</TD>
								<td><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtTemplateFileName)" id="txtTemplateFileName"
										runat="server" MaxLength="100" Width="250px" ></asp:textbox>&nbsp;</td>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD></TD>
								<td><asp:button id="btnSimpan" visible="false" runat="server" Text="Simpan" width="60px"></asp:button>&nbsp;
									<asp:button id="btnBatal" visible="false" runat="server" Text="Batal" width="60px" CausesValidation="False"></asp:button>&nbsp;
				...
				<TR>
					<TD><div id="div1" style="OVERFLOW: auto; HEIGHT: 360px"><asp:datagrid id="dtgModule" runat="server" Width="100%" PageSize="25" AllowCustomPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="TemplateFileName" HeaderText="Template File Name">
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
                                        <ItemTemplate>
											<asp:Label id=Label6 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TemplateFileName")%>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
