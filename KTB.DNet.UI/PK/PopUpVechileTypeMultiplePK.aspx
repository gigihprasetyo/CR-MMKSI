<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PopUpVechileTypeMultiplePK.aspx.vb" Inherits="PopUpVechileTypeMultiplePK"  smartNavigation="False" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td class="titlePage" style="HEIGHT: 18px" colSpan="7">
									AKTIVASI KENDARAAN&nbsp;- Tipe Kendaraan</td>
							</tr>
							<tr>
                            ...
                            <TR>
								<TD class="titleField" style="HEIGHT: 22px" width="40%">Kode Kendaraan</TD>
                            ...
                            <TR>
								<TD class="titleField" style="HEIGHT: 22px" width="40%">Deskripsi Kendaraan</TD>
								<TD style="HEIGHT: 22px" width="1%">:</TD>
								<TD style="HEIGHT: 22px" width="33%"><asp:textbox id="txtDescription" onkeypress="return alphaNumericExcept(event,'<>?*%$')" onblur="omitSomeCharacter('txtDescription','<>?*%$')"
										runat="server" Width="152px"></asp:textbox></TD>
                                <TD style="display:none" width="33%"><asp:textbox id="txtCategory" style="display:none" runat="server"></asp:textbox></TD>
                                <TD style="display:none" width="33%"><asp:textbox id="txtSubCategory" style="display:none" runat="server"></asp:textbox></TD>
							</TR>
							<TR>
