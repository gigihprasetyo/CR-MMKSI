<%@ Page Language="vb" AutoEventWireup="false" Codebehind="frmAdditionalInformationPK.aspx.vb" Inherits="frmAdditionalInformationPK" smartNavigation="False"%>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 3px; WIDTH: 98%; POSITION: absolute; TOP: 3px; HEIGHT: 98%"
				...
				<tr>
					<td colspan="2" class="titleTableSales">
						<asp:Label id="lblTitle" runat="server" BackColor="#F28625">Pengajuan PK Khusus</asp:Label></td>
				</tr>
				<tr>
