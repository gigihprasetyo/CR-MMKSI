<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmBusinessSectorHeader.aspx.vb" Inherits="FrmBusinessSectorHeader" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 17px">UMUM - Industri</td>
				</tr>
				<tr>
						...
						<TABLE id="Table1" cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<TR>
								...
								<TD style="HEIGHT: 10px" width="25%">
									<asp:TextBox id="txtIndustri" runat="server" Width="152px" AutoPostBack="False"></asp:TextBox>
                                    <asp:requiredfieldvalidator id="rfvIndustri" runat="server" ErrorMessage="*" ControlToValidate="txtIndustri"></asp:requiredfieldvalidator>
								</TD>
							...
							<TR>
								<TD vAlign="top" colSpan="6">
									<div id="div1" style="OVERFLOW: auto; HEIGHT: 330px"><asp:datagrid id="dgIndustri" runat="server" Width="100%" CellPadding="3" BorderWidth="0px" CellSpacing="1"
