<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmListDealerBranch.aspx.vb" Inherits=".FrmListDealerBranch" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>FrmListDealerBranch</title>
                ...
                <td>
                    <table id="Table2" cellspacing="1" cellpadding="2" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td width="1%">:</td>
                            <td width="40%">
                                <asp:DropDownList runat="server" ID="ddlBranchType" Width="128px"></asp:DropDownList></td>
                            <td class="titleField" width="14%">Kode Cabang/TO</td>
                            <td width="1%">:</td>
                            <td width="45%">
                                <asp:TextBox runat="server" ID="txtBranchCode"></asp:TextBox></td>
                        </tr>
                        <tr>
                    ...
                    <div id="div1" style="overflow: auto; width: 100%; height: 380px">
                        <asp:DataGrid ID="dtgDealerList" runat="server" Width="100%" PageSize="25" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="DealerCode" SortExpression="DealerCode" ReadOnly="True" HeaderText="Kode Cabang">
                                    <HeaderStyle Width="8%" CssClass="titleTableGeneral"></HeaderStyle>
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="DealerName" SortExpression="DealerName" ReadOnly="True" HeaderText="Nama Cabang">
                                ...
                                <asp:TemplateColumn SortExpression="Dealer.DealerCode" HeaderText="Kode Org">
                                    <HeaderStyle Width="8%" CssClass="titleTableGeneral"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealerCode" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ParentDealer.DealerCode")%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn SortExpression="Dealer.DealerName" HeaderText="Nama Org">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblDealerName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ParentDealer.DealerName")%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn SortExpression="MainArea.AreaCode" HeaderText="Region">
                                    <HeaderStyle Width="10%" CssClass="titleTableGeneral"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblMainArea" runat="server" Width="68px" Text='<%# DataBinder.Eval(Container, "DataItem.ParentDealer.MainArea.Description")%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
