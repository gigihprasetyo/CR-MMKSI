<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmGlobalUpload.aspx.vb" Inherits=".FrmGlobalUpload" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td class="titlePage">
                    <asp:Label ID="lblTitle" Text="Global Upload" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
