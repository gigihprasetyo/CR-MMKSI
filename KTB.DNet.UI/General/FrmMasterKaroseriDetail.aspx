<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmMasterKaroseriDetail.aspx.vb" Inherits="FrmMasterKaroseriDetail" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="5" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 17px" colSpan="2">UMUM - Master Karoseri Detail</td>
				</tr>
				<tr>
                ...
                <tr>
					<td colspan="2">
                        <asp:Panel ID="formKaroseri" runat="server" >
                            <table>
                                <tr>
					                <td class="titleField" width="10%">Kode Karoseri&nbsp;</td>
								    <TD width="3%" align="center">:</TD>
					                <td><asp:label id="lblCode" runat="server" Width="242px"></asp:label></td>
				                </tr>
                                <tr>
					                <td class="titleField" width="20%">Nama Karoseri&nbsp;</td>
								    <TD width="3%" align="center">:</TD>
