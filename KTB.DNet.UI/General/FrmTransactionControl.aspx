<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmTransactionControl.aspx.vb" Inherits="FrmTransactionControl" smartNavigation="False"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmTransactionControl</title>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="740" border="0">
							<TBODY>
								<TR>
									...
									<TD width="20%"><STRONG>Tipe Transaksi</STRONG></TD>
									<td width="1%">:</td>
									<TD width="29%"><asp:dropdownlist id="ddlTransactionType" runat="server" Width="140px"></asp:dropdownlist></TD>
								</TR>
								<TR>
					...
					<TD>
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 375px"><asp:datagrid id="dtgDealerList" runat="server" Width="100%" PageSize="25" Height="1px" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="SearchTerm1" HeaderText="Search 1 / 2">
										<HeaderStyle Width="11%" CssClass="titleTableGeneral"></HeaderStyle>
										<ItemTemplate>
											<asp:Label id=Label1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SearchTerm1")+" / "+DataBinder.Eval(Container, "DataItem.SearchTerm2") %>'>
											</asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
									...
									<asp:TemplateColumn HeaderText="Diubah Oleh">
										<HeaderStyle ForeColor="White" Width="8%" BackColor="#C22C32"></HeaderStyle>
										<ItemTemplate>
