<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmManualDocList.aspx.vb" Inherits="FrmManualDocList" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">BULETIN &amp; MANUAL - Daftar Manual Doc</td>
				</tr>
				<tr>
			...
			<table id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
				<tr>
					<td><asp:LinkButton id="lnkBaru" runat="server"><img src="../images/btn_new.gif" alt="Upload Manual Baru" border="0"></asp:LinkButton></td>
				</tr>
				<TR>
