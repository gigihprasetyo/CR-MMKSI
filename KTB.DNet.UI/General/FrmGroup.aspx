<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmGroup.aspx.vb" Inherits="FrmGroup"  smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">MAINTENANCE - Grup Dealer
					</td>
				</tr>
				<tr>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD class="titleField" width="24%">Kode Grup</TD>
								<TD width="1%">:</TD>
								<td width="75%"><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtGroupCode)" id="txtGroupCode" runat="server" MaxLength="3"></asp:textbox>
									<asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtGroupCode"
							...
							<TR>
								...
								<TD>:</TD>
								<td>
									<P><asp:textbox onkeypress="return HtmlCharUniv(event)" onblur="HtmlCharBlur(txtGroupName)" id="txtGroupName" runat="server" MaxLength="40"></asp:textbox>
										<asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtGroupName"
				...
				<TR>
					<TD vAlign="top">
						<div id="div1" style="OVERFLOW: auto; HEIGHT: 380px"><asp:datagrid id="dtgGroup" runat="server" Font-Names="MS Reference Sans Serif" CellSpacing="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="DealerGroupCode" SortExpression="DealerGroupCode" HeaderText="Kode Grup">
										<HeaderStyle Width="20%" CssClass="titleTableGeneral"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="GroupName" SortExpression="GroupName" HeaderText="Nama Grup">
