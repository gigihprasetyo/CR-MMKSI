<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmMasterLeasingList.aspx.vb" Inherits="FrmMasterLeasingList" smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="5" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" style="HEIGHT: 17px" colSpan="2">UMUM - Master Leasing</td>
				</tr>
				<tr>
                        ...
                        <asp:Panel ID="formLeasing" runat="server" >
                            <table>
                                ...
                                <tr>
								    ...
								    <TD width="1%">:</TD>
					                <td><asp:textbox onkeypress="return alphaNumericExcept(event,'<>?*%$;')" id="txtCode" 
							                runat="server" Width="242px"></asp:textbox></td>
				                </tr>
                                <tr>
                            	...
                            	<div id="div1" style="OVERFLOW: auto; HEIGHT: 440px">
                                        <asp:datagrid id="dgTable" runat="server" Width="100%" AllowPaging="True" AllowSorting="True"
											...
											<Columns>
                                                ...
                                                <asp:TemplateColumn SortExpression="LeasingCode" HeaderText="Kode Leasing">
													<HeaderStyle Width="10%" CssClass="titleTableGeneral"></HeaderStyle>
													<ItemTemplate>
														<asp:Label ID="lblCode" Runat="server"></asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
                                                <asp:TemplateColumn SortExpression="LeasingName" HeaderText="Nama Leasing">
