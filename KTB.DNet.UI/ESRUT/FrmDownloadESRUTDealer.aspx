<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmDownloadESRUTDealer.aspx.vb" Inherits=".FrmDownloadESRUTDealer" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td>
                    <table>
                        <tr id="rowDealer" runat="server" visible="false">
                        ...
                        <Columns>
                           ...
                           <asp:TemplateColumn SortExpression="Dealer.DealerName" HeaderText="Nama Dealer">
                             ...
                             <asp:TemplateColumn SortExpression="DODate" HeaderText="Tanggal DO">
                              ...
                              <asp:TemplateColumn HeaderText="Nomor SRUT">
                                <HeaderStyle Width="17%" HorizontalAlign="Center" CssClass="titleTableService"></HeaderStyle>
                                <ItemStyle Font-Size="XX-Small" VerticalAlign="Top" HorizontalAlign="Center"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkDownload" runat="server" Width="16px" Text="Download" CausesValidation="False" CommandName="Download">
