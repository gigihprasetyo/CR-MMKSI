...
Public Class FrmTOPSPReportCeiling
...
#Region "Variables"
    ...
    Private _vstCritProductCategory As String = "FrmTOPSPReportCeiling._vstCritProductCategory"
    Private _vstCritCreditAccount As String = "FrmTOPSPReportCeiling._vstCritCreditAccount"
    Private _vstCritEffectiveStart As String = "FrmTOPSPReportCeiling._vstCritEffectiveStart"
    Private _vstCritEffectiveEnd As String = "FrmTOPSPReportCeiling._vstCritEffectiveEnd"
    Private _vstCritPaymentType As String = "FrmTOPSPReportCeiling._vstCritPaymentType"
    Private _sessDtCeiling As String = "FrmTOPSPReportCeiling._sessDtCeiling"
#End Region
...
#Region "Custom"
    ...
    Private Sub checkPrivilege()
        Dim objDealer As Dealer = Me._sessHelper.GetSession("DEALER")
        If Not SecurityProvider.Authorize(Context.User, SR.Lihat_TOPSP_Report_Ceiling_Privilege) Then
    ...
    Protected Sub dtgMain_ItemCommand(source As Object, e As DataGridCommandEventArgs) Handles dtgMain.ItemCommand
        ...
        If cmdName.StartsWith("day") Then
            ...
            If aTCs.Count > 0 Then
                oTC = aTCs(0)
                Me.SaveCriteria()
                Response.Redirect("FrmTOPSPReportCeilingDetail.aspx?ID=" & oTC.ID.ToString())
            End If
        End If
    End Sub
