...
#Region "Private Declaration"
    Private containerPage As default_TAF
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=service"
#End Region
...
#Region "Event Handler"
    Private Sub IsBingoNoExpiration()
        If User.Identity.Name <> String.Empty Then
            ...
            End If
            Dim objUserInfo As UserInfo = New UserInfoFacade(User).Retrieve(User.Identity.Name.Substring(6), objDealer.DealerCode)
        ...
        If Not objDealer Is Nothing Then
            ...
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootFreeServiceDealer", 9000)
                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootFreeServiceLeasing", 9000)
                End If
...
#Region "Private Method"
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            If User.Identity.Name <> String.Empty Then
                objUserInfo = New UserInfoFacade(User).Retrieve(User.Identity.Name.Substring(6), objDealer.DealerCode)
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootTAF", 100100)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootTAFDealer", 100100)
                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootTAFLeasing", 100100)
                End If
            End If
        End If
    ...
    Private Sub SetTreeMenu(ByVal strXMLPath As String, ByVal intScreenID As Int32)
        MyMenu.ResetCache()
...
#Region "Clock"
    ...
    Public Function clockTimeString(ByVal inHours As Integer, ByVal inMinutes As Integer, ByVal inSeconds As Integer) As String
        ...
        End If
        Return strInHours & ":" & strInMinutes & ":" & strInSeconds & strAMPM
    End Function
#End Region
    ...
    Private Sub TAFLinkButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TAFLinkButton.Click
        Dim objDealer As Dealer = sessionHelper.GetSession("DEALER")
        If Not objDealer Is Nothing Then
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootTAF", 100100)
