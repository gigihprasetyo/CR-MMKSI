...
#Region "Private Declaration"
    Private containerPage As default_rsd
...
#Region "Public Declaration"
    Public MainFrameSrc As String = "Welcome.aspx?modcat=rsd"
#End Region
    ...
    Private Sub Initialization()
        ...
        If Not objDealer Is Nothing Then
            ...
            If objDealer.Title = CType(EnumDealerTittle.DealerTittle.KTB, String) Then
                SetTreeMenu("TreeMenu.XML.PathFromRootRSD", 9990)
            Else
                If objDealer.Title = CType(EnumDealerTittle.DealerTittle.DEALER, String) Then
                    SetTreeMenu("TreeMenu.XML.PathFromRootRSDDealer", 9990)
                Else
                    SetTreeMenu("TreeMenu.XML.PathFromRootRSDLeasing", 9990)
                End If
            End If
...
#Region "Page Event"
    ...
    Private Sub dologout()
        LogTosyslog("user logout successfully", "logout-rsd", "success")
        Session.RemoveAll()
...
#End Region
    ...
    Private Sub LogTosyslog(ByVal message As String, ByVal sbMsg As String, ByVal rslMsg As String)
        ...
        If strLog Then
            ...
            Try
                m.UserName = CType(IIf(User.Identity.Name.Length > 6, Right(User.Identity.Name, User.Identity.Name.Length - 6), User.Identity.Name).ToLower, String)
