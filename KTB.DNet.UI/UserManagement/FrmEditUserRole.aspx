<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmEditUserRole.aspx.vb" Inherits="FrmEditUserRole" smartNavigation="False" %>
							...
							<tr>
								<td width="30%"><asp:datagrid id="dtgUserRole1" runat="server" Width="100%" CellSpacing="1" GridLines="Horizontal"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="Nama Role" SortExpression="RoleName">
												...
												<EditItemTemplate>
													<asp:TextBox runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.RoleName") %>'>
													</asp:TextBox>
												</EditItemTemplate>
											</asp:TemplateColumn>
