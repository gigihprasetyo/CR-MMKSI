<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPQRAdditionalInfoBB.aspx.vb" Inherits="FrmPQRAdditionalInfoBB" smartNavigation="False" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table width="70%">
				...
				<tr>
					<td colSpan="3"><asp:panel id="pnlViewPQRAdditionalInfoBB" Height="380px" wrap="False" Width="100%" Runat="server"></asp:panel></td>
				</tr>
				<tr>
					<td colSpan="3">
