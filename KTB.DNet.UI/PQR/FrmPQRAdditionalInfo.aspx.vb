...
Public Class FrmPQRAdditionalInfo
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents pnlViewPQRAdditionalInfo As System.Web.UI.WebControls.Panel
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        _PQRHeader = New PQRHeaderFacade(User).Retrieve(CInt(Request.QueryString("PQRID")))
        lblPQRNo.Text = _PQRHeader.PQRNo
        If _PQRHeader.PQRAdditionalInfos.Count > 0 Then
            GenerateControl(_PQRHeader.PQRAdditionalInfos)
        End If
        ...
        If Not IsPostBack Then
            ...
            Else
                If CType(_PQRHeader.RowStatus, EnumPQR.PQRStatus) = EnumPQR.PQRStatus.Proses Then
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        ...
        If ValidateSave() Then
            ...
            '_PQRHeader = CType(sessHelper.GetSession("AIPQRHeader"), PQRHeader)
            Dim _objPQRAdditionalInfo As New PQRAdditionalInfo
            _objPQRAdditionalInfo.Sender = txtPengirim.Text
            _objPQRAdditionalInfo.PQRHeader = _PQRHeader
            If Not IsNothing(inFileLocation) And inFileLocation.Value <> String.Empty Then
                ...
                _objPQRAdditionalInfo.Attachment = AttachmentDirectory & "\" & _PQRHeader.PQRNo.Replace("/", "-") & "\" & DateTime.Now.ToString("ddMMyyyyHHmmss_") & Filename
            Else
                _objPQRAdditionalInfo.Attachment = ""
            End If

            If Not IsNothing(inFileLocation) And inFileLocation.Value <> String.Empty Then
                If UploadFile(inFileLocation.PostedFile, _objPQRAdditionalInfo.Attachment) = -1 Then
                    MessageBox.Show(SR.SaveFail)
                    Return
                End If
            End If

            result = New PQRAdditionalInfoFacade(User).Insert(_objPQRAdditionalInfo)
            If result = -1 Then
                MessageBox.Show(SR.SaveFail)
            Else
                ...
                _PQRHeader = New PQRHeaderFacade(User).Retrieve(CInt(Request.QueryString("PQRID")))
                sessHelper.SetSession("PQR", _PQRHeader)
                GenerateControl(_PQRHeader.PQRAdditionalInfos)
    ...
    Private Sub GenerateControl(ByVal _arrInfo As ArrayList)
        pnlViewPQRAdditionalInfo.Controls.Clear()

        With pnlViewPQRAdditionalInfo.Controls
            .Add(New LiteralControl("<table width='100%'><tr><td colspan=3><hr width = 100% style='HEIGHT: 2px'></td></tr>"))
            Dim x As Integer = 1
            For Each item As PQRAdditionalInfo In _arrInfo
