...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPQRPrintPreview.aspx.vb" Inherits="FrmPQRPrintPreview"%>
	...
	<BODY>
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage" align="center">PRODUCT QUALITY REPORT "CONFIDENTIAL"</td>
				</tr>
				<tr>
				...
				<tr vAlign="top">
					<td width="0">
						<table  cellSpacing="1" cellPadding="2" width="100%" border="0">
							...
							<tr valign=top>
          <TD class="titleField><asp:label id="lblTglFaktur" Runat="server" ><B>Tanggal Buka Faktur</B> </asp:label> </TD>
          <TD>:</TD>
          <TD>
...
<asp:label id=lblRefPQRNo Runat="server">No PQR Ref</asp:label></TD>
          <TD>:</TD>
          <TD>
<asp:label id=lblRefPQRNoVal Runat="server"></asp:label></TD>
							</tr>
        <TR vAlign=top>
          <TD class=titleField>
...
<asp:label id=lblNoMesin Runat="server">No Mesin</asp:label></TD>
								<td style="HEIGHT: 16px"><asp:Label ID="lblNoMesinColon" runat="server" Text=":"></asp:Label></td>
