...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPQRListKondisi.aspx.vb" Inherits="FrmPQRListKondisi"  smartNavigation="False"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="titlePage">PRODUCT QUALITY REPORT -&nbsp; Daftar Kondisi</td>
				</tr>
				<tr>
					...
					<TD align="left">
						<TABLE id="Table2" cellSpacing="1" cellPadding="2" width="100%" border="0">
							<TR>
								...
								<TD width="1%">:</TD>
								<TD width="34%"><asp:textbox id="txtKodeDealer" runat="server" MaxLength="10" Width="156px"></asp:textbox><asp:label id="lblSearchDealer" runat="server">
							...
							<TR>
								...
								<TD>:</TD>
								<TD><asp:textbox id="txtPQRNo" runat="server" MaxLength="25" Width="156px"></asp:textbox></TD>
			...
			<div id="div1" style="OVERFLOW: auto; HEIGHT: 260px"><asp:datagrid id="dgListPQR" runat="server" Width="100%" DataKeyField="ID" BorderStyle="None"
