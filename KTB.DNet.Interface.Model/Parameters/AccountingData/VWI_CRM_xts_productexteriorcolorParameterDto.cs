...
// PURPOSE       : VWI_CRM_xts_productexteriorcolorParameterDto  class
// SPECIAL NOTES : DNet WebApi Project
// ---------------------
// Copyright  (c) 2018 
// ---------------------
// $History      : $
// Created on 12/18/2020 08:08:00
//
// ===========================================================================	
#endregion
...
{
    public class VWI_CRM_xts_productexteriorcolorParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
        ...
        [AntiXss]
        public string ktb_specialflagname { get; set; }
        [AntiXss]
        public int statecode { get; set; }
        [AntiXss]
        public bool ktb_specialflag { get; set; }
        [AntiXss]
