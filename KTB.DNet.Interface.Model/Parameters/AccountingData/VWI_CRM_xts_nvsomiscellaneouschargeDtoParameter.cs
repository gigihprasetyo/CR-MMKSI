...
// PURPOSE       : VWI_CRM_xts_nvsomiscellaneouschargeParameterDto  class
...
{
    public class VWI_CRM_xts_nvsomiscellaneouschargeParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
