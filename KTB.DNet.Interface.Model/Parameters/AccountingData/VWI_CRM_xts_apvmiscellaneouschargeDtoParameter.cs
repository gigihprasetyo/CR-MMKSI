...
// PURPOSE       : VWI_CRM_xts_apvmiscellaneouschargeParameterDto  class
...
{
    public class VWI_CRM_xts_apvmiscellaneouschargeParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public string xts_apvmiscellaneouscharge { get; set; }
		...
		[AntiXss]
		public Guid xts_apvmiscellaneouschargeid { get; set; }
