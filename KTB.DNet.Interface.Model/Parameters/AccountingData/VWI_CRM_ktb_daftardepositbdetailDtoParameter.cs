...
{
    public class VWI_CRM_ktb_daftardepositbdetailDtoParameter : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
        ...
        [AntiXss]
        public Guid ktb_daftardepositbdetailid { get; set; }
        [AntiXss]
        public string modifiedonbehalfbyname { get; set; }
        [AntiXss]
        public string ktb_depositbid { get; set; }
        [AntiXss]
        ...
        [AntiXss]
        public string ktb_daftardepositbidname { get; set; }
        [AntiXss]
        ...
        [AntiXss]
        public Guid ktb_daftardepositbid { get; set; }
        [AntiXss]
        ...
        [AntiXss]
        public string ktb_daftardepositbdetail { get; set; }
        [AntiXss]
