...
{
    public class VWI_CRM_ktb_daftardepositbDtoParameter : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
        ...
        [AntiXss]
        public string ktb_productcategoryid { get; set; }
        [AntiXss]
        public string owneridyominame { get; set; }
        [AntiXss]
        public string ktb_daftardepositb { get; set; }
        [AntiXss]
