...
// PURPOSE       : VWI_CRM_xts_deliveryordermiscellaneouschargeParameterDto  class
...
{
    public class VWI_CRM_xts_deliveryordermiscellaneouschargeParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public string xts_deliveryordermiscellaneouscharge { get; set; }
		...
		[AntiXss]
		public Guid xts_deliveryordermiscellaneouschargeid { get; set; }
