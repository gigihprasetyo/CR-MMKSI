...
// PURPOSE       : VWI_CRM_xts_aptransactiondocumentdetailParameterDto  class
...
{
    public class VWI_CRM_xts_aptransactiondocumentdetailParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public Guid xts_aptransactiondocumentdetailid { get; set; }
		...
		[AntiXss]
		public Guid xts_aptransactiondocumentid { get; set; }
		...
		[AntiXss]
		public string xts_aptransactiondocumentdetailnumber { get; set; }
		...
		[AntiXss]
		public string xts_aptransactiondocumentidname { get; set; }
