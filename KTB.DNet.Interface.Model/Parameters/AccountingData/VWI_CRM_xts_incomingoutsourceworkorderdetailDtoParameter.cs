...
// PURPOSE       : VWI_CRM_xts_incomingoutsourceworkorderdetailParameterDto  class
...
{
    public class VWI_CRM_xts_incomingoutsourceworkorderdetailParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
