...
// PURPOSE       : VWI_CRM_xts_aptransactiondocumentParameterDto  class
...
{
    public class VWI_CRM_xts_aptransactiondocumentParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public string xts_transactiondocnumber { get; set; }

		[AntiXss]
		public decimal exchangerate { get; set; }

		[AntiXss]
		public string xts_aptransactiondocumentnumber { get; set; }
