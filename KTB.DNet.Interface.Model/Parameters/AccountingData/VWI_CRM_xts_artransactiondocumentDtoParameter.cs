...
// PURPOSE       : VWI_CRM_xts_artransactiondocumentParameterDto  class
...
{
    public class VWI_CRM_xts_artransactiondocumentParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
