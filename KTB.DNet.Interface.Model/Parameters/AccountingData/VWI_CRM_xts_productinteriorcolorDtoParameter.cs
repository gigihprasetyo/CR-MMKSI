...
// PURPOSE       : VWI_CRM_xts_productinteriorcolorParameterDto  class
...
{
    public class VWI_CRM_xts_productinteriorcolorParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
