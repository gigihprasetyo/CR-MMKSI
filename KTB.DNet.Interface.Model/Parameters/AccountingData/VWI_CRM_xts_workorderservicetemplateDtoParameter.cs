...
// PURPOSE       : VWI_CRM_xts_workorderservicetemplateParameterDto  class
...
{
    public class VWI_CRM_xts_workorderservicetemplateParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public string xts_workorderservicetemplate { get; set; }
		...
		[AntiXss]
		public Guid xts_workorderservicetemplateid { get; set; }
