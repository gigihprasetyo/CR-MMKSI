...
// PURPOSE       : VWI_CRM_xts_nvsoaccessoriesParameterDto  class
...
{
    public class VWI_CRM_xts_nvsoaccessoriesParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public string xts_nvsqaccessoriesidname { get; set; }
		...
		[AntiXss]
		public string xts_nvsoaccessories { get; set; }
		...
		[AntiXss]
		public decimal xts_acquisitiontaxprice { get; set; }
		...
		[AntiXss]
		public decimal xts_acquisitiontaxprice_base { get; set; }
