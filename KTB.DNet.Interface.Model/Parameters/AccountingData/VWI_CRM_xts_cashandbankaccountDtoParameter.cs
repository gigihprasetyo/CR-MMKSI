...
// PURPOSE       : VWI_CRM_xts_cashandbankaccountParameterDto  class
...
{
    public class VWI_CRM_xts_cashandbankaccountParameterDto : ParameterDtoBase, IValidatableObject
    {
        [AntiXss]
		...
		[AntiXss]
		public int xts_virtualaccountstartnumber { get; set; }
		...
		[AntiXss]
		public string xts_cashandbankaccountnumber { get; set; }
		...
		[AntiXss]
		public int xts_virtualaccountendnumber { get; set; }
