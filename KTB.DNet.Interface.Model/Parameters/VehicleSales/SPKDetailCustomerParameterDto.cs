...
{
    public class SPKDetailCustomerParameterDto : DtoBase, IValidatableObject
    {
        ...
        public string DMSSPKDetailNo { get; set; }
        ...
        public DateTime LastUpdateCustomer { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (TipeCustomer == 0)
            {
                DateTime dateTglLahir;
                if (!Utils.IsValidDateByFormat(TGLLAHIR, "yyyy-MM-dd", out dateTglLahir))
                {
                    results.Add(new ValidationResult(string.Format(MessageResource.ErrorMsgInvalidDataTypeFormat, "TGLLAHIR", "yyyy-MM-dd")));
                }
            }
            ...
            Alamat = Alamat == null ? Alamat : Alamat.ToUpper().TrimEnd().TrimStart();
            CustomerName = CustomerName == null ? CustomerName : CustomerName.ToUpper().TrimEnd().TrimStart();
            CustomerName2 = CustomerName2 == null ? CustomerName2 : CustomerName2.ToUpper().TrimEnd().TrimStart();
            Gedung = Gedung == null ? Gedung : Gedung.ToUpper().TrimEnd().TrimStart();
            Kelurahan = Kelurahan == null ? Kelurahan : Kelurahan.ToUpper().TrimEnd().TrimStart();
            Kecamatan = Kecamatan == null ? Kecamatan : Kecamatan.ToUpper().TrimEnd().TrimStart();
            PreArea = PreArea == null ? PreArea : PreArea.ToUpper().TrimEnd().TrimStart();
