...
{
    public class CRM_xts_writeoffbalanceParameterDto : ParameterDtoBase, IValidatableObject
    {
		...
		//[StringLength(510, ErrorMessageResourceType = typeof(MessageResource), ErrorMessageResourceName = "ErrorMsgLengthCannotExceed")]
		//[AntiXss]
		public int? xts_writeofftype { get; set; }
    ...
    public class CRM_xts_writeoffbalanceDeleteParameterDto
	{
	...
	public class CRM_xts_writeoffbalanceUpdateParameterDto : CRM_xts_writeoffbalanceParameterDto
    {
	...
	public class CRM_xts_writeoffbalanceCreateParameterDto : CRM_xts_writeoffbalanceParameterDto
    {
		...
		[Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(MessageResource), ErrorMessageResourceName = "ErrorMsgDataRequired")]
		public new int? xts_writeofftype { get { return base.xts_writeofftype; } set { base.xts_writeofftype = value; } }
