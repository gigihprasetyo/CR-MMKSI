	...
	public class SimpleHashTest
	{
		...
		static void Main(string[] args)
		{
			...
			string passwordHashMD5 = 
				DNetEncryption.ComputeHash(password, "MD5", null);
			string passwordHashSha1 = 
				DNetEncryption.ComputeHash(password, "SHA1", null);
			string passwordHashSha256 = 
				DNetEncryption.ComputeHash(password, "SHA256", null);
			string passwordHashSha384 = 
				DNetEncryption.ComputeHash(password, "SHA384", null);
			string passwordHashSha512 = 
				DNetEncryption.ComputeHash(password, "SHA512", null);
