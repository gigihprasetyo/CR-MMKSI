...
{
    public class VWI_CRM_xts_accessorieskitgroup
    {
        public Int64 IDRow { get; set; }
        public string company { get; set; }
        public string businessunitcode { get; set; }
        public string xts_xts_accessorieskitgrouptypename { get; set; }
        ...
        public string xts_xts_accessorieskitgrouptype { get; set; }
