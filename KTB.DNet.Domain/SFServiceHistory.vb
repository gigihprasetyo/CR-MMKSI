...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SFServiceHistory Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
...
namespace KTB.DNet.Domain
	<Serializable(), TableInfo("SFServiceHistory")> _
	public class SFServiceHistory
        ...
        Private _objPMHeaer As PMHeader
        ...
        <ColumnInfo("PMHeaderID", "{0}"), _
            RelationInfo("PMHeader", "ID", "SFServiceHistory", "PMHeaderID")> _
        Public Property PMHeader As PMHeader
            Get
                Try
                    If Not IsNothing(Me._objPMHeaer) AndAlso (Not Me._objPMHeaer.IsLoaded) Then
                        Me._objPMHeaer = CType(DoLoad(GetType(PMHeader).ToString(), _objPMHeaer.ID), PMHeader)
                        Me._objPMHeaer.MarkLoaded()
                    End If

                    Return Me._objPMHeaer
