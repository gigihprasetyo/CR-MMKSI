...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SalesmanUniformOrderDetail Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 8/21/2007 - 4:46:58 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SalesmanUniformOrderDetail")> _
    Public Class SalesmanUniformOrderDetail
...
#Region "Private Variables"
        ...
        Private _salesmanUniformOrderHeader As SalesmanUniformOrderHeader
...
#Region "Public Properties"
        ...
        <ColumnInfo("SalesmanUniformOrderHeaderID", "{0}"), _
        RelationInfo("SalesmanUniformOrderHeader", "ID", "SalesmanUniformOrderDetail", "SalesmanUniformOrderHeaderID")> _
        Public Property SalesmanUniformOrderHeader() As SalesmanUniformOrderHeader
            Get
                Try
                    If Not isnothing(Me._salesmanUniformOrderHeader) AndAlso (Not Me._salesmanUniformOrderHeader.IsLoaded) Then

                        Me._salesmanUniformOrderHeader = CType(DoLoad(GetType(SalesmanUniformOrderHeader).ToString(), _salesmanUniformOrderHeader.ID), SalesmanUniformOrderHeader)
                        Me._salesmanUniformOrderHeader.MarkLoaded()

                    End If

                    Return Me._salesmanUniformOrderHeader
            ...
            Set(ByVal value As SalesmanUniformOrderHeader)

                Me._salesmanUniformOrderHeader = value
        ...
        RelationInfo("SalesmanUniform", "ID", "SalesmanUniformOrderDetail", "SalesmanUniformID")> _
