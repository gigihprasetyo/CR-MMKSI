...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : RevisionTransferActual Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2020 
'// ---------------------
'// $History      : $
'// Generated on 20/03/2020 - 9:18:23
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("RevisionTransferActual")> _
    Public Class RevisionTransferActual
...
#Region "Private Variables"
        ...
        Private _revisionPaymentHeaderID As Integer
...
#Region "Public Properties"
        ...
        Public Property RevisionPaymentHeaderID As Integer
            Get
                Return _revisionPaymentHeaderID
            End Get
            Set(ByVal value As Integer)
                _revisionPaymentHeaderID = value
            End Set
        End Property
        ...
        <ColumnInfo("RevisionPaymentHeaderID", "{0}"), _
        RelationInfo("RevisionPaymentHeader", "ID", "RevisionTransferActual", "RevisionPaymentHeaderID")> _
