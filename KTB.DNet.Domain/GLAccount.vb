...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : GLAccount Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2006 
'// ---------------------
'// $History      : $
'// Generated on 4/6/2006 - 10:10:15 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("GLAccount")> _
            ...
            Get
                Try
                    If (Me._babitPayments.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(BabitPayment), "GLAccount", Me.ID)
