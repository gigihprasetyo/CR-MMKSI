...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : BabitReportJV Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2019 
'// ---------------------
'// $History      : $
'// Generated on 02/10/2019 - 14:01:52
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("BabitReportJV")> _
    Public Class BabitReportJV
...
#Region "Public Properties"
        ...
        <ColumnInfo("DealerID", "{0}"), _
        RelationInfo("Dealer", "ID", "BabitReportJV", "DealerID")> _
