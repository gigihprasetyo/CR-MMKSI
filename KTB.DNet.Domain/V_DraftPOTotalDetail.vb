...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : V_DraftPOTotalDetail Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2010 
'// ---------------------
'// $History      : $
'// Generated on 12/26/2018 - 10:58:08 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("V_DraftPOTotalDetail")> _
    Public Class V_DraftPOTotalDetail
...
#Region "Public Properties"
        ...
        <ColumnInfo("Gyro", "{0}")> _
        Public Property Gyro() As Integer
            Get
                Return _gyro
            End Get
            Set(ByVal value As Integer)
        ...
        RelationInfo("ProductCategory", "ID", "V_DraftPOTotalDetail", "ProductCategoryID")> _
