...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SparePartForecastMaster")> _
    Public Class SparePartForecastMaster
...
#Region "Private Variables"
        ...
        Private _buletinNo As String = String.Empty
...
#Region "Public Properties"
        ...
        <ColumnInfo("NoReCallCategory", "'{0}'")> _
        Public Property NoReCallCategory As String
            Get
                Return _recallRegNo
            End Get
        ...
        <ColumnInfo("NoBulletinService", "'{0}'")> _
        Public Property NoBulletinService As String
            Get
                Return _buletinNo
            End Get
            Set(ByVal value As String)
        ...
        RelationInfo("SparePartMaster", "ID", "SparePartForecastMaster", "SparepartMasterID")> _
