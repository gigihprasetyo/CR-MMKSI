...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : v_POEffectiveDate Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2009 
'// ---------------------
'// $History      : $
'// Generated on 10/18/2009 - 7:14:21 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("v_POEffectiveDate")> _
    Public Class v_POEffectiveDate
...
#Region "Public Properties"
        ...
        Public Property POHeader() As POHeader
            Get
                Try
                    If IsNothing(Me._pOHeader) Then 'If Not IsNothing(Me._pOHeader) Then ' AndAlso (Not Me._pOHeader.IsLoaded) Then

                        'Me._pOHeader = CType(DoLoad(GetType(POHeader).ToString(),  _pOHeader.ID), POHeader)
                        Me._pOHeader = CType(DoLoad(GetType(POHeader).ToString(), _iD), POHeader)
