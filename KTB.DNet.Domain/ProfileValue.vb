...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : ProfileValue Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/19/2007 - 4:31:21 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("ProfileValue")> _
...
#Region "Private Variables"
        ...
        Private _profileValueHistorys As System.Collections.ArrayList = New System.Collections.ArrayList
...
#Region "Public Properties"
        ...
        RelationInfo("ProfileGroup", "ID", "ProfileValue", "GroupID")> _
        ...
        RelationInfo("ProfileHeader", "ID", "ProfileValue", "ProfileHeaderID")> _
        ...
        <RelationInfo("ProfileValue", "ID", "ProfileValueHistory", "ProfileValueID")> _
        Public ReadOnly Property ProfileValueHistorys() As System.Collections.ArrayList
            Get
                Try
                    If (Me._profileValueHistorys.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(ProfileValueHistory), "ProfileValue", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(ProfileValueHistory), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._profileValueHistorys = DoLoadArray(GetType(ProfileValueHistory).ToString, criterias)
                    End If

                    Return Me._profileValueHistorys
