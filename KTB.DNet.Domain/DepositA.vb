...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : DepositA Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 12/11/2007 - 1:11:33 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("DepositA")> _
...
#Region "Private Variables"
        ...
        Private _depositADetails As System.Collections.ArrayList = New System.Collections.ArrayList
...
#Region "Public Properties"
        ...
        RelationInfo("Dealer", "ID", "DepositA", "DealerID")> _
    ...
    RelationInfo("ProductCategory", "ID", "DepositA", "ProductCategoryID")> _
        ...
        <RelationInfo("DepositA", "ID", "DepositADetail", "DepositAID")> _
        Public ReadOnly Property DepositADetails() As System.Collections.ArrayList
            Get
                Try
                    If (Me._depositADetails.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(DepositADetail), "DepositA", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(DepositADetail), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._depositADetails = DoLoadArray(GetType(DepositADetail).ToString, criterias)
                    End If

                    Return Me._depositADetails
