...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : DealerProfile Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/23/2007 - 10:21:45 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("DealerProfile")> _
...
#Region "Private Variables"
        ...
        Private _dealerProfileHistorys As System.Collections.ArrayList = New System.Collections.ArrayList
...
#Region "Public Properties"
        ...
        RelationInfo("Dealer", "ID", "DealerProfile", "DealerID")> _
        ...
        RelationInfo("ProfileHeader", "ID", "DealerProfile", "ProfileHeaderID")> _
        ...
        RelationInfo("ProfileGroup", "ID", "DealerProfile", "GroupID")> _
        ...
        <RelationInfo("DealerProfile", "ID", "DealerProfileHistory", "DealerProfileID")> _
        Public ReadOnly Property DealerProfileHistorys() As System.Collections.ArrayList
            Get
                Try
                    If (Me._dealerProfileHistorys.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(DealerProfileHistory), "DealerProfile", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(DealerProfileHistory), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._dealerProfileHistorys = DoLoadArray(GetType(DealerProfileHistory).ToString, criterias)
                    End If

                    Return Me._dealerProfileHistorys
