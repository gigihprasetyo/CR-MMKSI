...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : FlatRateMasterFieldFix Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2005 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("FlatRateMasterFieldFix")> _
    Public Class FlatRateMasterFieldFix
...
#Region "Private Variables"
        ...
        Private _fieldfix As RecallCategory
...
#Region "Public Properties"
        ...
        <ColumnInfo("FieldFixID", "{0}"), _
        RelationInfo("RecallCategory", "ID", "FlatRateMasterFieldFix", "FieldFixID")> _
        Public Property RecallCategory() As RecallCategory
            Get
                Try
                    If Not IsNothing(Me._fieldfix) AndAlso (Not Me._fieldfix.IsLoaded) Then

                        Me._fieldfix = CType(DoLoad(GetType(RecallCategory).ToString(), _fieldfix.ID), RecallCategory)

                        If Not IsNothing(Me._fieldfix) Then
                            Me._fieldfix.MarkLoaded()
                        End If
