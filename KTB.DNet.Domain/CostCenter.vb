...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : CostCenter Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2006 
'// ---------------------
'// $History      : $
'// Generated on 4/6/2006 - 10:18:05 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("CostCenter")> _
...
#Region "Private Variables"
        ...
        Private _shortText As String = String.Empty
            ...
            Get
                Try
                    If (Me._babitPayments.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(BabitPayment), "CostCenter", Me.ID)
