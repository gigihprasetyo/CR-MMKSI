...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : BabitParameterHeader Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2019 
'// ---------------------
'// $History      : $
'// Generated on 08/05/2019 - 8:21:32
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("BabitParameterHeader")> _
    Public Class BabitParameterHeader
...
#Region "Private Variables"
        ...
        Private _parameterCategory As Integer
...
#Region "Public Properties"
        ...
        <ColumnInfo("ParameterCategory", "{0}")> _
        Public Property ParameterCategory As Integer
            Get
                Return _parameterCategory
            End Get
            Set(ByVal value As Integer)
                _parameterCategory = value
            End Set
        End Property
        ...
        RelationInfo("BabitMasterEventType", "ID", "BabitParameterHeader", "BabitMasterEventTypeID")> _
