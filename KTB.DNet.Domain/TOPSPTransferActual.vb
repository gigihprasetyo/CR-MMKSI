...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : TOPSPTransferActual Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
'// $History      : $
'// Generated on 9/7/2018 - 2:01:43 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("TOPSPTransferActual")> _
    Public Class TOPSPTransferActual
...
#Region "Public Properties"
        ...
        RelationInfo("TOPSPTransferPayment", "ID", "TOPSPTransferActual", "TOPSPTransferPaymentID")> _
        ...
        <ColumnInfo("TOPSPTransferPaymentID", "{0}")> _
        Public Property TOPSPTransferPaymentID As Integer

            Get
                Return _tOPSPTransferPaymentID
            End Get
            Set(ByVal value As Integer)
                _tOPSPTransferPaymentID = value
            End Set
        End Property
