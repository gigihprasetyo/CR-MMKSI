...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : FSChassisCampaign Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2015 
'// ---------------------
'// $History      : $
'// Generated on 23/12/2015 - 11:21:55
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("FSChassisCampaign")> _
    Public Class FSChassisCampaign
...
#Region "Public Properties"
        ...
        <ColumnInfo("IsAllow", "{0}")> _
        Public Property IsAllow As Boolean
            Get
                Return _isAllow
            End Get
        ...
        <ColumnInfo("ChassisMasterID", "{0}"), _
          RelationInfo("ChassisMaster", "ID", "FSChassisCampaign", "ChassisMasterID")> _
        ...
        RelationInfo("FSKind", "ID", "FSChassisCampaign", "FSKindID")> _
