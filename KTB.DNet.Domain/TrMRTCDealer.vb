...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : TrMRTCDealer Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2019 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("TrMRTCDealer")> _
    Public Class TrMRTCDealer
...
#Region "Public Properties"
        ...
        <ColumnInfo("DealerID", "{0}"), _
          RelationInfo("Dealer", "ID", "TrMRTCDealer", "DealerID")> _
        ...
        <ColumnInfo("DealerID", "{0}")> _
        Public Property DelaerID As Integer
            Get
                Return _dealerID
            End Get
            Set(ByVal value As Integer)
