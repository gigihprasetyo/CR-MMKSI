...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : BingoMatrix Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 1/4/2007 - 9:51:17 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("BingoMatrix")> _
...
#Region "Private Variables"
        ...
        Private _posisiX As String = String.Empty
        Private _posisiY As String = String.Empty
...
#Region "Public Properties"
        ...
        <ColumnInfo("PosisiX", "'{0}'")> _
        Public Property PosisiX() As String
            Get
                Return _posisiX
            End Get
        ...
        <ColumnInfo("PosisiY", "'{0}'")> _
        Public Property PosisiY() As String
            Get
                Return _posisiY
            End Get
            Set(ByVal value As String)
