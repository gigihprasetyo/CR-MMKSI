...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : ClaimProgress Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 9/27/2007 - 10:47:40 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("ClaimProgress")> _
            ...
            Get
                Try
                    If (Me._claimHeaders.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(ClaimHeader), "ClaimProgress", Me.ID)
