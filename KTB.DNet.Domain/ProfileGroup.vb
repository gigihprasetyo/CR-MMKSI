...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : ProfileGroup Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/18/2007 - 9:01:07 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("ProfileGroup")> _
            ...
            Get
                Try
                    If (Me._profileHeaderToGroups.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(ProfileHeaderToGroup), "ProfileGroup", Me.ID)
