...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : V_RekapPO Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2009 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("V_RekapPO")> _
    Public Class V_RekapPO
...
#Region "Public Properties"
        ...
        <ColumnInfo("ID", "{0}"), _
        RelationInfo("POHeader", "ID", "V_RekapPO", "ID")> _
            ...
            Get
                Try 'If IsNothing(Me._pOHeader) Then '
                    If Not IsNothing(Me._pOHeader) AndAlso (Not Me._pOHeader.IsLoaded) Then
                        Me._pOHeader = CType(DoLoad(GetType(POHeader).ToString(), Me._pOHeader.ID), POHeader)
