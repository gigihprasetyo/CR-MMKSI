...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : DealerBankAccount Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2008 
'// ---------------------
'// $History      : $
'// Generated on 12/4/2008 - 8:53:35 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("DealerBankAccount")> _
...
#Region "Private Variables"
        ...
        Private _bankKey As String = String.Empty
        Private _bankAccount As String = String.Empty
        Private _bankName As String = String.Empty
        Private _beneficiaryName As String = String.Empty
...
#Region "Public Properties"
        ...
        <ColumnInfo("BeneficiaryName", "'{0}'")> _
