...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : DealerStockReportDetail Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2006 
'// ---------------------
'// $History      : $
'// Generated on 9/2/2006 - 8:48:15 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("DealerStockReportDetail")> _
    Public Class DealerStockReportDetail
...
#Region "Private Variables"
        ...
        Private _dealerStockReportHeader As DealerStockReportHeader
...
#Region "Public Properties"
        ...
        <ColumnInfo("DealerStockReportHeaderID", "{0}"), _
        RelationInfo("DealerStockReportHeader", "ID", "DealerStockReportDetail", "DealerStockReportHeaderID")> _
        Public Property DealerStockReportHeader() As DealerStockReportHeader
            Get
                Try
                    If Not isnothing(Me._dealerStockReportHeader) AndAlso (Not Me._dealerStockReportHeader.IsLoaded) Then

                        Me._dealerStockReportHeader = CType(DoLoad(GetType(DealerStockReportHeader).ToString(), _dealerStockReportHeader.ID), DealerStockReportHeader)
                        Me._dealerStockReportHeader.MarkLoaded()

                    End If

                    Return Me._dealerStockReportHeader
            ...
            Set(ByVal value As DealerStockReportHeader)

                Me._dealerStockReportHeader = value
        ...
        RelationInfo("VechileColor", "ID", "DealerStockReportDetail", "VehicleColorID")> _
