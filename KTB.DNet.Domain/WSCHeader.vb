...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : WSCHeader Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2005 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("WSCHeader")> _
    Public Class WSCHeader
...
#Region "Private Variables"
        ...
        Private _installMiliage As Integer
        ...
        Private _wSCDamageRequestParts As System.Collections.ArrayList = New System.Collections.ArrayList
        Private _wSCEvidences As System.Collections.ArrayList = New System.Collections.ArrayList
        Private _wSCDetails As System.Collections.ArrayList = New System.Collections.ArrayList
...
#Region "Public Properties"
        ...
        <ColumnInfo("InstallMiliage", "{0}")> _
        Public Property InstallMiliage() As Integer
            Get
                Return _installMiliage
            End Get
            Set(ByVal value As Integer)
                _installMiliage = value
            End Set
        End Property
        ...
        RelationInfo("Reason", "ID", "WSCHeader", "ReasonID")> _
        ...
        RelationInfo("ChassisMaster", "ID", "WSCHeader", "ChassisMasterID")> _
        ...
        RelationInfo("Dealer", "ID", "WSCHeader", "DealerID")> _
        ...
        RelationInfo("DealerBranch", "ID", "WSCHeader", "DealerBranchID")> _
        ...
        Public ReadOnly Property WSCDamageRequestParts() As System.Collections.ArrayList
            Get
                Try
                    If (Me._wSCDamageRequestParts.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(WSCDamageRequestPart), "WSCHeader", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(WSCDamageRequestPart), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._wSCDamageRequestParts = DoLoadArray(GetType(WSCDamageRequestPart).ToString, criterias)
                    End If

                    Return Me._wSCDamageRequestParts
        ...
        Public ReadOnly Property WSCEvidences() As System.Collections.ArrayList
            Get
                Try
                    If (Me._wSCEvidences.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(WSCEvidence), "WSCHeader", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(WSCEvidence), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._wSCEvidences = DoLoadArray(GetType(WSCEvidence).ToString, criterias)
                    End If

                    Return Me._wSCEvidences
        ...
        Public ReadOnly Property WSCDetails() As System.Collections.ArrayList
            Get
                Try
                    If (Me._wSCDetails.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(WSCDetail), "WSCHeader", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(WSCDetail), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._wSCDetails = DoLoadArray(GetType(WSCDetail).ToString, criterias)
                    End If

                    Return Me._wSCDetails
