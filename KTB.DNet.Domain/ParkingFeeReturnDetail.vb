...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : ParkingFeeReturnDetail Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2012 
'// ---------------------
'// $History      : $
'// Generated on 3/7/2012 - 2:35:26 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("ParkingFeeReturnDetail")> _
    Public Class ParkingFeeReturnDetail
...
#Region "Public Properties"
        ...
        <ColumnInfo("ParkingFeeID", "{0}"), _
        RelationInfo("ParkingFee", "ID", "ParkingFeeReturnDetail", "ParkingFeeID")> _
        Public Property ParkingFee() As ParkingFee
            Get
                Try
                    If Not isnothing(Me._parkingFee) AndAlso (Not Me._parkingFee.IsLoaded) Then

                        Me._parkingFee = CType(DoLoad(GetType(ParkingFee).ToString(), _parkingFee.ID), ParkingFee)
                        Me._parkingFee.MarkLoaded()

                    End If

                    Return Me._parkingFee
            ...
            Set(ByVal value As ParkingFee)

                Me._parkingFee = value
                If (Not isnothing(value)) AndAlso (CType(value, DomainObject)).IsLoaded Then
                    Me._parkingFee.MarkLoaded()
                End If
            End Set
