...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : V_BenefitClaimDeducted Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2017 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("V_BenefitClaimDeducted")> _
    Public Class V_BenefitClaimDeducted
...
#Region "Private Variables"
        ...
        Private _regNumberDSF As String = String.Empty
        Private _regNumberDealer As String = String.Empty
...
#Region "Public Properties"
        ...
        <ColumnInfo("RegNumberDSF", "'{0}'")> _
        Public Property RegNumberDSF As String
            Get
                Return _regNumberDSF
            End Get
            Set(ByVal value As String)
                _regNumberDSF = value
            End Set
        ...
        <ColumnInfo("RegNumberDealer", "'{0}'")> _
        Public Property RegNumberDealer As String
            Get
                Return _regNumberDealer
            End Get
            Set(ByVal value As String)
                _regNumberDealer = value
            End Set
        End Property
