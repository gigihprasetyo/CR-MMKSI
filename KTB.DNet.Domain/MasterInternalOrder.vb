...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : MasterInternalOrder Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2019 
'// ---------------------
'// $History      : $
'// Generated on 08/10/2019 - 9:12:34
'//
'// ===========================================================================	
#end region
...
namespace KTB.DNet.Domain
	<Serializable(), TableInfo("MasterInternalOrder")> _
	public class MasterInternalOrder
		...
		private _internalOrderCode as string = String.Empty 		
		...
		<ColumnInfo("InternalOrderCode","'{0}'")> _
		public property InternalOrderCode as string
			get
