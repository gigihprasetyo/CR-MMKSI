...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : LeasingCompany Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2015 
'// ---------------------
'// $History      : $
'// Generated on 12/2/2015 - 11:05:43 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("LeasingCompany")> _
            ...
            Get
                Try
                    If (Me._benefitMasterLeasings.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(BenefitMasterLeasing), "LeasingCompany", Me.ID)
