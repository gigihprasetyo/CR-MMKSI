...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SalesmanAccomplish Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/30/2007 - 3:55:01 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SalesmanAccomplish")> _
    Public Class SalesmanAccomplish
...
#Region "Private Variables"
        ...
        Private _accomplishYear As Short
        Private _accomplishment As String = String.Empty
...
#Region "Public Properties"
        ...
        <ColumnInfo("AccomplishYear", "{0}")> _
        Public Property AccomplishYear() As Short
            Get
                Return _accomplishYear
            End Get
            Set(ByVal value As Short)
                _accomplishYear = value
            End Set
        End Property


        <ColumnInfo("Accomplishment", "'{0}'")> _
        Public Property Accomplishment() As String
            Get
                Return _accomplishment
            End Get
            Set(ByVal value As String)
                _accomplishment = value
            End Set
        End Property
