...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : BenefitParticipant Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2015 
'// ---------------------
'// $History      : $
'// Generated on 12/2/2015 - 11:04:33 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("BenefitParticipant")> _
    Public Class BenefitParticipant
            ...
            Get
                Try
                    If (Me._benefitEventDetails.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(BenefitEventDetail), "BenefitParticipant", Me.ID)
