...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SalesmanSalesTarget Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/30/2007 - 4:19:18 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SalesmanSalesTarget")> _
    Public Class SalesmanSalesTarget
...
#Region "Private Variables"
        ...
        Private _yearTarget As Short
        Private _monthTarget As Short
        Private _valueTarget As Decimal
...
#Region "Public Properties"
        ...
        <ColumnInfo("YearTarget", "{0}")> _
        Public Property YearTarget() As Short
            Get
                Return _yearTarget
            End Get
        ...
        <ColumnInfo("MonthTarget", "{0}")> _
        Public Property MonthTarget() As Short
            Get
                Return _monthTarget
            End Get
            Set(ByVal value As Short)
        ...
        <ColumnInfo("ValueTarget", "{0}")> _
        Public Property ValueTarget() As Decimal
            Get
                Return _valueTarget
            End Get
