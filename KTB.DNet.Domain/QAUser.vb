...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : QAUser Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 1/16/2007 - 10:10:50 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("QAUser")> _
    Public Class QAUser
...
#Region "Public Properties"
        ...
        <ColumnInfo("UserProfileID", "{0}"), _
        RelationInfo("UserProfile", "ID", "QAUser", "UserProfileID")> _
        Public Property UserProfile() As UserProfile
            Get
                Try
                    If Not isnothing(Me._userProfile) AndAlso (Not Me._userProfile.IsLoaded) Then

                        Me._userProfile = CType(DoLoad(GetType(UserProfile).ToString(), _userProfile.ID), UserProfile)
                        Me._userProfile.MarkLoaded()
