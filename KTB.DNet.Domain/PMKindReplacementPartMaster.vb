...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : PMKindReplacementPartMaster Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 10/22/2007 - 3:26:44 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("PMKindReplacementPartMaster")> _
    Public Class PMKindReplacementPartMaster
...
#Region "Public Properties"
        ...
        RelationInfo("PMKind", "ID", "PMKindReplacementPartMaster", "PMKindID")> _
        ...
        <ColumnInfo("ReplecemetPartMasterID", "{0}"), _
        RelationInfo("ReplecementPartMaster", "ID", "PMKindReplacementPartMaster", "ReplecemetPartMasterID")> _
