...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : EventSales Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 8/21/2007 - 12:02:21 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("EventSales")> _
...
#Region "Public Properties"
        ...
        <ColumnInfo("EventInfoID", "{0}"), _
        RelationInfo("EventInfo", "ID", "EventSales", "EventInfoID")> _
        Public Property EventInfo() As EventInfo
            Get
                Try
                    If Not isnothing(Me._eventInfo) AndAlso (Not Me._eventInfo.IsLoaded) Then

                        Me._eventInfo = CType(DoLoad(GetType(EventInfo).ToString(), _eventInfo.ID), EventInfo)
                        Me._eventInfo.MarkLoaded()

                    End If

                    Return Me._eventInfo
