...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("V_Price")> _
    Public Class V_Price
...
#Region "Public Properties"
        ...
        RelationInfo("VechileColor", "ID", "V_Price", "VechileColorID")> _
            ...
            Get
                Try
                    If Not IsNothing(Me._vechileColor) And (Not Me._vechileColor.IsLoaded) Then
                        ...
                        Me._MaterialNumber = Me._vechileColor.MaterialNumber
                    End If
        ...
        <ColumnInfo("DealerID", "{0}"), _
                RelationInfo("Dealer", "ID", "V_Price", "DealerID")> _
   Public Property Dealer() As Dealer
            Get
                Try
                    If Not IsNothing(Me._dealer) AndAlso (Not Me._dealer.IsLoaded) Then
                        ...
                        Me._DealerCode = Me._dealer.DealerCode
                    End If
        ...
        Public Property DealerCode() As String
            Get
                Try
                    If _DealerCode.Equals(String.Empty) Then
                        _DealerCode = Dealer.DealerCode
                    End If
        ...
        Public Property MaterialNumber() As String
            Get
                Try
                    If _MaterialNumber.Equals(String.Empty) Then
                        _MaterialNumber = VechileColor.MaterialNumber
                    End If

                    Return Me._MaterialNumber
