...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : DepositADetail Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 12/11/2007 - 1:12:31 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("DepositADetail")> _
    Public Class DepositADetail
...
#Region "Public Properties"
        ...
        <ColumnInfo("DepositAID", "{0}"), _
        RelationInfo("DepositA", "ID", "DepositADetail", "DepositAID")> _
        Public Property DepositA() As DepositA
            Get
                Try
                    If Not isnothing(Me._depositA) AndAlso (Not Me._depositA.IsLoaded) Then

                        Me._depositA = CType(DoLoad(GetType(DepositA).ToString(), _depositA.ID), DepositA)
                        Me._depositA.MarkLoaded()
