...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SparepartMaxOrder Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2006 
'// ---------------------
'// $History      : $
'// Generated on 10/17/2006 - 9:13:50 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SparepartMaxOrder")> _
    Public Class SparepartMaxOrder
...
#Region "Private Variables"
        ...
        Private _maxRequest As Integer
...
#Region "Public Properties"
        ...
        <ColumnInfo("MaxRequest", "{0}")> _
        Public Property MaxRequest() As Integer
            Get
                Return _maxRequest
            End Get
            Set(ByVal value As Integer)
        ...
        <ColumnInfo("SparepartID", "{0}"), _
        RelationInfo("SparePartMaster", "ID", "SparepartMaxOrder", "SparepartID")> _
