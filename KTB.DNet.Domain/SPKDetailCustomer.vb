...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SPKDetailCustomer")> _
    Public Class SPKDetailCustomer
...
#Region "Private Variables"
        ...
        Private _sPKDetailCustomerProfiles As System.Collections.ArrayList = New System.Collections.ArrayList

        Private _dMSSPKDetailNo As String = String.Empty
        Private _lastUpdateCustomer As DateTime = CType(System.Data.SqlTypes.SqlDateTime.MinValue.Value, DateTime)
        'CR SPK
        Private _typePerorangan As Short
        Private _typeIdentitas As Short
...
#Region "Public Properties"
        ...
        RelationInfo("BusinessSectorDetail", "ID", "SPKDetailCustomer", "BusinessSectorDetailID")> _
        ...
        RelationInfo("City", "ID", "SPKDetailCustomer", "CityID")> _
        ...
        RelationInfo("SAPCustomer", "ID", "SPKDetailCustomer", "SAPCustomerID")> _
        ...
        <RelationInfo("SPKDetailCustomer", "ID", "SPKDetailCustomerProfile", "SPKDetailCustomerID")> _
        Public ReadOnly Property SPKDetailCustomerProfiles() As System.Collections.ArrayList
            Get
                Try
                    If (Me._sPKDetailCustomerProfiles.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(SPKDetailCustomerProfile), "SPKDetailCustomer.ID", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(SPKDetailCustomerProfile), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._sPKDetailCustomerProfiles = DoLoadArray(GetType(SPKDetailCustomerProfile).ToString, criterias)
                    End If

                    Return Me._sPKDetailCustomerProfiles
        ...
        <ColumnInfo("ID", "{0}"), _
     RelationInfo("SPKDetailCustomer", "ID", "OCRIdentity", "SPKDetailCustomerID")> _
        Public ReadOnly Property OCRIdentity As OCRIdentity
            Get
                Try
                    If IsNothing(_OCRIdentity) Then
                        If Me.ID > 0 Then
                            Dim _criteria As Criteria = New Criteria(GetType(OCRIdentity), "SPKDetailCustomerID", Me.ID)
                            Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
       ...
       RelationInfo("SPKDetail", "ID", "SPKDetailCustomer", "SPKDetailID")> _
        ...
        <ColumnInfo("DMSSPKDetailNo", "'{0}'")> _
        Public Property DMSSPKDetailNo() As String
            Get
                Return _dMSSPKDetailNo
            End Get
            Set(ByVal value As String)
                _dMSSPKDetailNo = value
            End Set
        End Property

        <ColumnInfo("LastUpdateCustomer", "'{0:yyyy/MM/dd HH:mm:ss}'")> _
        Public Property LastUpdateCustomer() As DateTime
            Get
                Return _lastUpdateCustomer
            End Get
            Set(ByVal value As DateTime)
                _lastUpdateCustomer = value
            End Set
        End Property

        'CR SPK
        <ColumnInfo("TypeIdentitas", "'{0}'")> _
        Public Property TypeIdentitas() As Short
            Get
        ...
        Public Property TypePerorangan() As Short
            Get
