...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : FlatRateMasterGR Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2005 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("FlatRateMasterGR")> _
    Public Class FlatRateMasterGR
...
#Region "Public Properties"
        ...
        RelationInfo("GRKind", "ID", "FlatRateMasterGR", "GRKindID")> _
        Public Property GRKind() As GRKind
            Get
                Try
                    If Not IsNothing(Me._gRKind) AndAlso (Not Me._gRKind.IsLoaded) Then

                        Me._gRKind = CType(DoLoad(GetType(GRKind).ToString(), _gRKind.ID), GRKind)

                        If Not IsNothing(Me._gRKind) Then
                            Me._gRKind.MarkLoaded()
                        End If
