...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SparePartPOScheduleDealer Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2016 
'// ---------------------
'// $History      : $
'// Generated on 08/03/2016 - 11:19:53
'//
'// ===========================================================================	
#end region
...
namespace KTB.DNet.Domain
	<Serializable(), TableInfo("SparePartPOScheduleDealer")> _
	public class SparePartPOScheduleDealer
       ...
       RelationInfo("Dealer", "ID", "SparePartPOScheduleDealer", "DealerID")> _
