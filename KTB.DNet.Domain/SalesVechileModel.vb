...
'// ===========================================================================
'// AUTHOR        : dnet
'// PURPOSE       : SalesVechileModel Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2022 
'// ---------------------
'// $History      : $
'// Generated on 2/4/2022 - 9:07:40 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SalesVechileModel")> _
    Public Class SalesVechileModel
...
#Region "Private Variables"
        ...
        Private _newVechileModelDesc As String = String.Empty
        Private _salesFlag As Byte
...
#Region "Public Properties"
        ...
        <ColumnInfo("NewVechileModelDesc", "'{0}'")> _
        Public Property NewVechileModelDesc As String
            Get
                Return _newVechileModelDesc
            End Get
            Set(ByVal value As String)
                _newVechileModelDesc = value
            End Set
        End Property


        <ColumnInfo("SalesFlag", "{0}")> _
        Public Property SalesFlag As Byte
            Get
                Return _salesFlag
            End Get
        ...
        RelationInfo("Category", "ID", "SalesVechileModel", "CategoryID")> _
        ...
        RelationInfo("VechileModel", "ID", "SalesVechileModel", "ModelID")> _
            ...
            Get
                Try
                    If (Me._vechileTypes.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(VechileType), "SalesVechileModel", Me.ID)
