...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : FreeServiceBB Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2005 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("FreeServiceBB")> _
    Public Class FreeServiceBB
...
#Region "Public Properties"
        ...
        RelationInfo("Reason", "ID", "FreeServiceBB", "Reason")> _
        ...
        RelationInfo("ChassisMasterBB", "ID", "FreeServiceBB", "chassismasterID")> _
        ...
        RelationInfo("FSKind", "ID", "FreeServiceBB", "FSKindID")> _
        ...
        RelationInfo("Dealer", "ID", "FreeServiceBB", "ServiceDealerID")> _
        ...
        RelationInfo("DealerBranch", "ID", "FreeServiceBB", "DealerBranchID")> _
