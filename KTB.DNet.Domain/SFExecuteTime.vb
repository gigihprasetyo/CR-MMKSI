...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SFExecuteTime Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
'// $History      : $
'// Generated on 03/05/2018 - 9:11:52 AM
'//
'// ===========================================================================	
#end region
...
namespace KTB.DNet.Domain
	<Serializable(), TableInfo("SFExecuteTime")> _
	public class SFExecuteTime
        ...
        Private _executeTimeFrom As Object
        Private _executeTimeTo As Object
        ...
        RelationInfo("SFMasterObject", "ID", "SFStagingLog", "SFMasterObjectID")> _
		...
		<ColumnInfo("ExecuteTimeFrom","{0}")> _
		public property ExecuteTimeFrom as object
			get
				return _executeTimeFrom
			end get
			set(byval value as object)
				_executeTimeFrom= value
			end set
		end property
		

		<ColumnInfo("ExecuteTimeTo","{0}")> _
		public property ExecuteTimeTo as object
			get
				return _executeTimeTo
			end get
			set(byval value as object)
				_executeTimeTo= value
			end set
		end property
