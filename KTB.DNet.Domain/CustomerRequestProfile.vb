...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : CustomerRequestProfile Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 7/23/2007 - 10:17:21 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("CustomerRequestProfile")> _
    Public Class CustomerRequestProfile
...
#Region "Private Variables"
        ...
        Private _customerRequestProfileHistorys As System.Collections.ArrayList = New System.Collections.ArrayList
...
#Region "Public Properties"
        ...
        RelationInfo("ProfileHeader", "ID", "CustomerRequestProfile", "ProfileHeaderID")> _
        ...
        RelationInfo("ProfileGroup", "ID", "CustomerRequestProfile", "GroupID")> _
        ...
        <RelationInfo("CustomerRequestProfile", "ID", "CustomerRequestProfileHistory", "CustomerRequestProfileID")> _
        Public ReadOnly Property CustomerRequestProfileHistorys() As System.Collections.ArrayList
            Get
                Try
                    If (Me._customerRequestProfileHistorys.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(CustomerRequestProfileHistory), "CustomerRequestProfile", Me.ID)
                        Dim criterias As CriteriaComposite = New CriteriaComposite(_criteria)
                        criterias.opAnd(New Criteria(GetType(CustomerRequestProfileHistory), "RowStatus", MatchType.Exact, CType(DBRowStatus.Active, Short)))

                        Me._customerRequestProfileHistorys = DoLoadArray(GetType(CustomerRequestProfileHistory).ToString, criterias)
                    End If

                    Return Me._customerRequestProfileHistorys
