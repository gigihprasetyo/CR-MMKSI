...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : TrInhouseClass Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2009 
'// ---------------------
'// $History      : $
'// Generated on 6/25/2009 - 8:52:57 AM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("TrInhouseClass")> _
    Public Class TrInhouseClass
...
#Region "Public Properties"
        ...
        <ColumnInfo("InhouseID", "{0}"), _
                        RelationInfo("TrInhouse", "ID", "TrInhouseClass", "InhouseID")> _
        ...
        <ColumnInfo("ClassID", "{0}"), _
            ...
            Get
                Try
                    If IsNothing(Me._trClass) AndAlso (Not Me._trClass.IsLoaded) Then
