...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : MDPDealerDailyStock Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
'// $History      : $
'// Generated on 27/11/2018 - 10:02:56
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("MDPDealerDailyStock")> _
    Public Class MDPDealerDailyStock
...
#Region "Public Properties"
        ...
        <ColumnInfo("AllocationQuantity", "{0}")> _
        ...
        RelationInfo("Dealer", "ID", "MDPDealerDailyStock", "DealerID")> _
        ...
        RelationInfo("VechileColor", "ID", "MDPDealerDailyStock", "VehicleColorID")> _
