...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : RevisionChassisMasterProfile Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
'// $History      : $
'// Generated on 16/08/2018 - 15:14:32
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("RevisionChassisMasterProfile")> _
    Public Class RevisionChassisMasterProfile
...
#Region "Public Properties"
        ...
        RelationInfo("EndCustomer", "ID", "RevisionChassisMasterProfile", "EndCustomerID")> _
        ...
        RelationInfo("ChassisMaster", "ID", "RevisionChassisMasterProfile", "ChassisMasterID")> _
        ...
        RelationInfo("ProfileHeader", "ID", "RevisionChassisMasterProfile", "ProfileHeaderID")> _
        ...
        RelationInfo("ProfileGroup", "ID", "RevisionChassisMasterProfile", "GroupID")> _
