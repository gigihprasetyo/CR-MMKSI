...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : MSPDC Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2018 
'// ---------------------
'// $History      : $
'// Generated on 1/11/2018 - 4:05:50 PM
'//
'// ===========================================================================	
#end region
...
namespace KTB.DNet.Domain
	<Serializable(), TableInfo("MSPDC")> _
	public class MSPDC
		...
		private _tOPNo as string = String.Empty 		
        ...
        RelationInfo("MSPRegistrationHistory", "ID", "MSPDC", "MSPRegistrationHistoryID")> _
		...
		<ColumnInfo("TOPNo","'{0}'")> _
		public property TOPNo as string
			get
				return _tOPNo
			end get
			set(byval value as string)
        ...
        <ColumnInfo("DocumentDate", "'{0:yyyy/MM/dd HH:mm:ss}'")> _
