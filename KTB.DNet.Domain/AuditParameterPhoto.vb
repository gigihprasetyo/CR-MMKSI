...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : AuditParameterPhoto Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 8/27/2007 - 2:14:59 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("AuditParameterPhoto")> _
    Public Class AuditParameterPhoto
...
#Region "Public Properties"
        ...
        <RelationInfo("AuditParameterPhoto", "AuditParameterID", "AuditScheduleDealerReport", "AuditParameterPhotoID")> _
            ...
            Get
                Try
                    If (Me._auditScheduleDealerReports.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(AuditScheduleDealerReport), "AuditParameterPhotoID", Me.ID)
