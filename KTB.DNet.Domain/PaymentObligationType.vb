...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : PaymentObligationType Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2007 
'// ---------------------
'// $History      : $
'// Generated on 10/2/2007 - 3:40:33 PM
'//
'// ===========================================================================	
#End Region
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("PaymentObligationType")> _
    Public Class PaymentObligationType
            ...
            Get
                Try
                    If (Me._paymentObligations.Count < 1) Then
                        Dim _criteria As Criteria = New Criteria(GetType(PaymentObligation), "PaymentObligationType", Me.ID)
