...
'// ===========================================================================
'// AUTHOR        : DNet Team
'// PURPOSE       : SPKDetailCustomerProfile Domain Object.
'// SPECIAL NOTES : 
'// ---------------------
'// Copyright  2011 
'// ---------------------
...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SPKDetailCustomerProfile")> _
    Public Class SPKDetailCustomerProfile
...
#Region "Public Properties"
        ...
        RelationInfo("ProfileGroup", "ID", "SPKDetailCustomerProfile", "GroupID")> _
        ...
        RelationInfo("ProfileHeader", "ID", "SPKDetailCustomerProfile", "ProfileHeaderID")> _
