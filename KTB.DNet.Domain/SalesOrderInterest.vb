...
Namespace KTB.DNet.Domain
    <Serializable(), TableInfo("SalesOrderInterest")> _
    Public Class SalesOrderInterest
...
#Region "Public Properties"
        ...
        <ColumnInfo("DealerID", "{0}"), _
       RelationInfo("Dealer", "ID", "SalesOrderInterest", "DealerID")> _
        ...
        <ColumnInfo("SalesOrderID", "{0}"), _
       RelationInfo("SalesOrder", "ID", "SalesOrderInterest", "SalesOrderID")> _
       ...
       RelationInfo("InterestPPHHeader", "ID", "SalesOrderInterest", "InterestPPHHeaderID")> _
