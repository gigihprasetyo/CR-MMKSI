...
Namespace KTB.DNet.DataMapper
    ...
    Public Class SalesOrderInterestMapper
...
#Region "Private Variables"
        ...
        Private m_RetrieveStatement As String = "up_RetrieveSalesOrderInterest"
        Private m_RetrieveListStatement As String = "up_RetrieveSalesOrderInterestList"
...
#Region "Protected Methods"
        ...
        Protected Overrides Function DoRetrieve(ByVal dr As System.Data.IDataReader) As Object
            ...
            Dim salesOrderInterest As SalesOrderInterest = Nothing
            While dr.Read
        ...
        Protected Overrides Function DoRetrieveList(ByVal dr As System.Data.IDataReader) As System.Collections.ArrayList
            ...
            While dr.Read
                Dim salesOrderInterest As SalesOrderInterest = Me.CreateObject(dr)
        ...
        Protected Overrides Function GetInsertParameter(ByVal obj As Object, ByVal User As String) As Microsoft.Practices.EnterpriseLibrary.Data.DBCommandWrapper
            ...
            DbCommandWrapper.AddInParameter("@DocNumber", DbType.AnsiString, salesOrderInterest.DocNumber)
...
#Region "Private Methods"
        ...
        Private Function CreateObject(ByVal dr As IDataReader) As SalesOrderInterest

            Dim salesOrderInterest As SalesOrderInterest = New SalesOrderInterest
        ...
        Private Sub SetTableName()
            ...
            If Not (GetType(SalesOrderInterest) Is Nothing) Then

                Dim attr As TableInfoAttribute = CType(Attribute.GetCustomAttribute(GetType(SalesOrderInterest), GetType(TableInfoAttribute)), TableInfoAttribute)

                If Not isnothing(attr) Then
                    m_TableName = attr.TableName
                Else
                    Throw New SearchException(GetType(SalesOrderInterest).ToString + " does not have TableInfoAttribute.")
                End If
            End If
        End Sub
