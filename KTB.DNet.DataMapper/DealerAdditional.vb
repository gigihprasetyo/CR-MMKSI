...
'// ---------------------
'// $History      : $
'// Generated on 7/18/2007 - 9:30:53 AM
'//
'// ===========================================================================	
#End Region
...
#Region "Protected Methods"
        ...
        Protected Overrides Function GetInsertParameter(ByVal obj As Object, ByVal User As String) As Microsoft.Practices.EnterpriseLibrary.Data.DBCommandWrapper
            ...
            DbCommandWrapper.AddInParameter("@ClaimETA", DbType.AnsiString, dealerAdditional.ClaimETA)
...
#Region "Private Methods"
        ...
        Private Function CreateObject(ByVal dr As IDataReader) As DealerAdditional
            ...
            If Not dr.IsDBNull(dr.GetOrdinal("ClaimETA")) Then dealerAdditional.ClaimETA = dr("ClaimETA").ToString
