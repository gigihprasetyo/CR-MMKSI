...
'// ---------------------
'// $History      : $
'// Generated on 7/16/2007 - 2:20:31 PM
'//
'// ===========================================================================	
#end region
...
namespace KTB.DNet.DataMapper
	...
	#region "Protected Methods"
		...
		protected overrides function GetInsertParameter(byval obj as object, byval User as string) as Microsoft.Practices.EnterpriseLibrary.Data.DBCommandWrapper
			...
			DbCommandWrapper.AddInParameter("@PartsCode",DbType.AnsiString,pQRPartsCode.PartsCode)
	...
	#region "Private Methods"
		...
		private function CreateObject(byval dr as IDataReader) as PQRPartsCode
			...
			if not dr.IsDBNull(dr.GetOrdinal("PartsCode")) then pQRPartsCode.PartsCode = dr("PartsCode").ToString 
