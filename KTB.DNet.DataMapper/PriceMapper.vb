...
#Region "Protected Methods"
        ...
        Protected Overrides Function DoRetrieveList(ByVal dr As System.Data.IDataReader) As System.Collections.ArrayList
            ...
            While dr.Read
                Dim price As Price = Me.CreateObject(dr)
                priceList.Add(price)
            End While
        ...
        Protected Overrides Function GetDeleteParameter(ByVal obj As Object) As Microsoft.Practices.EnterpriseLibrary.Data.DBCommandWrapper
            ...
            Dim price As Price = CType(obj, Price)
...
#Region "Private Methods"
        ...
        Private Function CreateObject(ByVal dr As IDataReader) As Price

            Dim price As Price = New Price
        ...
        Private Sub SetTableName()
            ...
            If Not (GetType(Price) Is Nothing) Then

                Dim attr As TableInfoAttribute = CType(Attribute.GetCustomAttribute(GetType(Price), GetType(TableInfoAttribute)), TableInfoAttribute)

                If Not isnothing(attr) Then
                    m_TableName = attr.TableName
                Else
                    Throw New SearchException(GetType(Price).ToString + " does not have TableInfoAttribute.")
                End If
            End If
        End Sub
