...
'// ---------------------
'// $History      : $
'// Generated on 24/09/2007 - 14:12:43
'//
'// ===========================================================================	
#End Region
...
#Region "Protected Methods"
        ...
        Protected Overrides Function GetInsertParameter(ByVal obj As Object, ByVal User As String) As Microsoft.Practices.EnterpriseLibrary.Data.DBCommandWrapper
            ...
            DbCommandWrapper.AddInParameter("@Category", DbType.AnsiString, alertMaster.Category)
            DbCommandWrapper.AddInParameter("@Modul", DbType.AnsiString, alertMaster.Modul)
            ...
            DbCommandWrapper.AddInParameter("@AlertSoundPath", DbType.AnsiString, alertMaster.AlertSoundPath)
...
#Region "Private Methods"
        ...
        Private Function CreateObject(ByVal dr As IDataReader) As AlertMaster
            ...
            If Not dr.IsDBNull(dr.GetOrdinal("Category")) Then alertMaster.Category = dr("Category").ToString
            If Not dr.IsDBNull(dr.GetOrdinal("Modul")) Then alertMaster.Modul = dr("Modul").ToString
            ...
            If Not dr.IsDBNull(dr.GetOrdinal("AlertSoundPath")) Then alertMaster.AlertSoundPath = dr("AlertSoundPath").ToString
