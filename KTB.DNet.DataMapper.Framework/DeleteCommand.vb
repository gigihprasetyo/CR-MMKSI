...
'// ---------------------
'// $History      : $
'// Generated on 7/26/2005 - 09:49:00 AM
'//
'// ===========================================================================		
#End Region
...
#Region "Constructors/Destructors/Finallizers"

        Public Sub New(ByVal domain As Object)
...
#Region "Public Methods"
        ...
        Public Overrides Function Execute(ByVal transaction As IDbTransaction) As Integer
            ...
            Return Me.Mapper.Delete(Me.DomainObj)
